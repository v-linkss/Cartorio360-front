  <template>
    <v-container>
      <v-row>
        ...
        <div @click="handleScannerClick" title="Criar" style="padding-right: 10px">
          <img
  ...
  // function validarArquivoSelecionado(event) {
  //   const file = event.target.files[0]; // Obtendo o arquivo corretamente
  //   if (!file) {
