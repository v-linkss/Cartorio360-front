...
import { _ as _imports_2$2, a as _imports_0$3, b as _imports_1$2, c as _sfc_main$6 } from './RegistroPessoas-hM4j8h8K.mjs';
import { _ as _imports_5, T as Toolbar, W as WordExport, S as Search, D as DocumentEditorContainerComponent, a as _imports_0$1, b as _sfc_main$1$1, c as _sfc_main$7 } from './lavrar-C4ss5HNJ.mjs';
import { r as registerLicense, _ as _sfc_main$8 } from './FichaCard-DyCJUUML.mjs';
...
import { _ as _sfc_main$9 } from './Confirmacao-FW_B2Sxg.mjs';
...
const _sfc_main$4 = {
  ...
  async setup(__props) {
    ...
    const redirectToRepresentante = (item) => {
      const pessoasFiltradas = pessoasTable.value.filter((p) => p.pessoa.id !== item.pessoa.id && !p.pessoa.excluido).map((p) => ({
        id: p.pessoa.id,
        nome: p.pessoa.nome
      }));
...
//# sourceMappingURL=Anexos-BYEAklxN.mjs.map
