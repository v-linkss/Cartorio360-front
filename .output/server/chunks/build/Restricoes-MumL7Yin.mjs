                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VRow, { class: "mt-10 justify-space-around" }, {
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div${_scopeId4}><img style="${ssrRenderStyle({ "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Excluir"${_scopeId4}></div><div${_scopeId4}><img style="${ssrRenderStyle({ "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2$1)} alt="Salvar"${_scopeId4}></div>`);
                            } else {
                              return [
...
//# sourceMappingURL=Restricoes-MumL7Yin.mjs.map
