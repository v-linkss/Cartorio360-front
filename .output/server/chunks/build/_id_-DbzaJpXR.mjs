...
import { e as useNuxtApp, as as useRoute$1, u as useRouter$1, c as useCookie, d as VTextField, at as VDataTable, b as useRuntimeConfig } from './server.mjs';
import { ref, reactive, withAsyncContext, resolveDirective, mergeProps, withCtx, unref, createVNode, toDisplayString, withDirectives, openBlock, createBlock, useSSRContext } from 'vue';
  ...
  async setup(__props) {
    ...
    async function onUpdate() {
      ...
      if (await v$.value.$validate()) {
        const { data: data2, error, status } = await useFetch(`${updateOs}/${id}`, {
          method: "PUT",
    ...
    }, "$Fci2yt5KvV")), __temp = await __temp, __restore(), __temp);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ordens-servicos/atualizar/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-DbzaJpXR.mjs.map
