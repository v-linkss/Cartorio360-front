...
import { _ as _export_sfc, u as useRouter$1, c as useNuxtApp, U as VImg, V as VTextField, an as VBtn, am as VSpacer, b as useRuntimeConfig, al as useCookie } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-e2e02109><div class="container-form" data-v-e2e02109>`);
      ...
      _push(`<div class="text" data-v-e2e02109>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-e2e02109> Esqueceu a senha?</a></div><div class="background-image" data-v-e2e02109></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e2e02109"]]);

export { index as default };
//# sourceMappingURL=index-BpYY8fhI.mjs.map
