import { _ as _sfc_main$1 } from './Dados-CoickMPO.mjs';
import { V as VTabs, a as VTab, b as VTabsWindow, c as VTabsWindowItem, _ as _sfc_main$7, d as _sfc_main$6, e as _sfc_main$1$1, f as __nuxt_component_4 } from './Restricoes-Coxve2iG.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VCard, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 style="${ssrRenderStyle({ "background-color": "#f5f2f2", "color": "#525050", "padding": "10px 0px 0px 20px" })}"${_scopeId2}> Cadastramento de pessoas </h1><div style="${ssrRenderStyle({ "background-color": "#f5f2f2", "padding": "20px 0px 20px 20px" })}"${_scopeId2}>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VTabsWindowItem, { value: "dados" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_Dados, {
                                onSaved: handleSave,
                        ...
                        if (unref(showTabs)) {
                          _push4(ssrRenderComponent(VTabsWindowItem, { value: "documento" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_Documentos, {
                                  onCloseModal: closeModal,
                                  isModal: true
                                }, null, _parent5, _scopeId4));
                              } else {
                        ...
                        if (unref(showTabs)) {
                          _push4(ssrRenderComponent(VTabsWindowItem, { value: "endereco" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_Endereco, {
                                  onCloseModal: closeModal,
                                  isModal: true
                                }, null, _parent5, _scopeId4));
                              } else {
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(VContainer, { class: "mt-5" }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_Biometria, {
                                        onCloseModal: closeModal,
                                        isModal: true
                        ...
                        if (unref(showTabs)) {
                          _push4(ssrRenderComponent(VTabsWindowItem, { value: "restricao" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_Restricoes, {
                                  onCloseModal: closeModal,
                                  isModal: true
                                }, null, _parent5, _scopeId4));
                              } else {
...
//# sourceMappingURL=RegistroPessoas-CPmSXTfP.mjs.map
