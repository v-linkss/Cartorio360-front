...
import { p as propsFactory, y as makeComponentProps, A as makeTagProps, o as genericComponent, t as useRender, F as makeBorderProps, H as makeElevationProps, M as makeRoundedProps, O as makeThemeProps, aJ as useBackgroundColor, S as useBorder, X as useElevation, a0 as useRounded, Q as provideTheme, a5 as useRtl, z as provideDefaults, a2 as VImg, x as VDefaultsProvider, aD as convertToUnit, aY as VExpandTransition, aZ as makeLayoutItemProps, q as useProxiedModel, a_ as useToggleScope, aA as useSsrBoot, a$ as useLayoutItem, G as makeDimensionProps, W as useDimension, b0 as useLayout, _ as _export_sfc, aG as clamp, u as useRouter$1, b1 as VApp, d as useCookie, as as VSpacer, ah as VMenu, V as VBtn, ai as VList, aj as VListItem, b2 as VListItemTitle } from './server.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h5 style="${ssrRenderStyle({ "color": "#429946", "margin-left": "30px" })}" data-v-06ea286a${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h5>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-06ea286a"]]);

export { _default as default };
//# sourceMappingURL=default-BcZ7Lc0K.mjs.map
