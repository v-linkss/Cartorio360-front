                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VAutocomplete, {
                          ...
                          modelValue: unref(state).papel_id,
                          "onUpdate:modelValue": ($event) => unref(state).papel_id = $event,
                          items: props.papeis,
                          "item-title": "descricao",
                          "item-value": "token"
                        }, null, _parent4, _scopeId3));
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode(_component_ModalPapel, {
                ...
                show: unref(isModalPapelOpen),
                onClose: ($event) => isModalPapelOpen.value = false
              }, null, 8, ["representante_nome", "papeis", "show", "onClose"]),
              createVNode(VDialog, {
                modelValue: unref(isModalFichaOpen),
                "onUpdate:modelValue": ($event) => isRef(isModalFichaOpen) ? isModalFichaOpen.value = $event : null,
                width: "600"
...
//# sourceMappingURL=procuracao-IaHUc_Hv.mjs.map
