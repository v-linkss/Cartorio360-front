              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(hasTiff)) {
                    ...
                    _push3(`<img${ssrRenderAttr("src", unref(fotoRender))} style="${ssrRenderStyle({ "width": "100%", "height": "100%", "object-fit": "cover" })}"${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
...
//# sourceMappingURL=FichaCard-Cl1VKS_R.mjs.map
