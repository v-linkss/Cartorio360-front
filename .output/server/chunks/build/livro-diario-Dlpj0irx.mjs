...
import { _ as _imports_0 } from './imprimir-C92Cn5tA.mjs';
  ...
  setup(__props) {
    ...
    const gerarRelatorioDiarioCaixaCSV = async () => {
      ...
      if (response.ok) {
        ...
        const url = URL.createObjectURL(blob);
        const a = (undefined).createElement("a");
        a.href = url;
        a.download = filename;
        (undefined).body.appendChild(a);
        a.click();
        setTimeout(() => {
          URL.revokeObjectURL(url);
          (undefined).body.removeChild(a);
        }, 1e3);
      }
    };
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          ...
                          createVNode("img", {
                            onClick: gerarRelatorioDiarioCaixaCSV,
...
//# sourceMappingURL=livro-diario-Dlpj0irx.mjs.map
