...
import { e as useNuxtApp, c as useCookie, d as VTextField, at as VDataTable, b as useRuntimeConfig } from './server.mjs';
import { ref, reactive, withAsyncContext, resolveDirective, mergeProps, withCtx, unref, createVNode, toDisplayString, withDirectives, openBlock, createBlock, createCommentVNode, useSSRContext } from 'vue';
...
import { _ as _imports_2 } from './recebe-SeYi-Qte.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    let showCreateAtos = ref(!!((_b = useCookie("user-service").value) == null ? void 0 : _b.numero));
    let showCreateOrdemServ = ref(useCookie("ordem-button").value);
    let isValidatingCpf = false;
    const atosItems = ref([]);
    const state = reactive({
      nacionalidade: "brasileiro",
      apresentante_nome: (_c = useCookie("user-service").value) == null ? void 0 : _c.apresentante_nome,
      apresentante_cpf: (_d = useCookie("user-service").value) == null ? void 0 : _d.apresentante_cpf,
      documento: null
    });
    const headers = [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`<h1${_scopeId2}>Ordem de Servi\xE7o n\xBA</h1><h1 style="${ssrRenderStyle({ "color": "red", "margin-left": "30px" })}"${_scopeId2}>${ssrInterpolate((_a2 = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? void 0 : _a2.numero)}</h1>`);
                } else {
                  return [
                    createVNode("h1", null, "Ordem de Servi\xE7o n\xBA"),
                    createVNode("h1", { style: { "color": "red", "margin-left": "30px" } }, toDisplayString((_b2 = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? void 0 : _b2.numero), 1)
                  ];
                }
              }),
              _: 1
              ...
              _push2(ssrRenderComponent(VRow, { style: { "display": "flex", "margin-bottom": "10px", "gap": "2rem" } }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_NuxtLink, { to: "/ordens-servicos/criar-ato" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(VRow, { style: { "display": "flex", "gap": "10px", "margin-top": "-5px" } }, {
                            default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div title="Receber"${_scopeId4}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="Receber"${_scopeId4}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Desabilitado")}${_scopeId4}><img style="${ssrRenderStyle({
                                ...
                                return [
                                  createVNode("div", {
                                    onClick: ($event) => _ctx.redirectToUpdate(item.id),
                                    title: "Receber"
                                  }, [
                                    createVNode("img", {
                    ...
                    return [
                      ...
                      createVNode(_component_NuxtLink, { to: "/ordens-servicos/criar-ato" }, {
                        default: withCtx(() => [
                          createVNode("img", {
                            style: { "width": "45px", "height": "45px", "cursor": "pointer" },
                            src: _imports_0,
            ...
            return [
              createVNode(VRow, { class: "mb-5" }, {
                default: withCtx(() => {
                  ...
                  return [
                    createVNode("h1", null, "Ordem de Servi\xE7o n\xBA"),
                    createVNode("h1", { style: { "color": "red", "margin-left": "30px" } }, toDisplayString((_a2 = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? void 0 : _a2.numero), 1)
                  ];
                }),
                _: 1
              }),
...
//# sourceMappingURL=criar-registro-BVuMiSA3.mjs.map
