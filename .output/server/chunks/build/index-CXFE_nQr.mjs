...
import { aU as VProgressCircular, f as VBtn, V as VTextField, c as useRuntimeConfig, aS as useRoute$1, b as useNuxtApp, e as useCookie } from './server.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    useNuxtApp();
    `${config.public.managemant}/updateAtosPessoa`;
    ...
    const updateAtoPessoa = async () => {
      ...
      if (status.value === "success") {
        ...
        const { data: seloData, error: error2, status: sucessoSelo } = await useFetch(forneceSelo, {
          method: "POST",
          body: {
            tipo_id: 1,
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const headers = [
      ...
      { title: "Sequ\xEAncia", value: "sequencia" },
                  ...
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(VCol, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VTextField, {
                            modelValue: unref(filters).sequencia,
                            "onUpdate:modelValue": ($event) => unref(filters).sequencia = $event,
                            label: "Sequ\xEAncia",
                            "prepend-inner-icon": "mdi-magnify",
                            variant: "outlined",
                            "hide-details": ""
                    ...
                    _push3(ssrRenderComponent(VCol, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VTextField, {
                            modelValue: unref(filters).sigla,
                            "onUpdate:modelValue": ($event) => unref(filters).sigla = $event,
                            label: "Sigla",
                            "prepend-inner-icon": "mdi-magnify",
                            variant: "outlined",
                            "hide-details": ""
...
//# sourceMappingURL=index-CXFE_nQr.mjs.map
