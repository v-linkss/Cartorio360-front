import { useSSRContext, ref, watch, mergeProps, unref, isRef, withCtx, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, reactive, withAsyncContext, toDisplayString } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate } from 'vue/server-renderer';
import { a as VDialog, V as VCard, d as VCardActions } from './VDialog-CYKPt9Vw.mjs';
import { V as VContainer } from './VContainer-CTpFP9Uv.mjs';
import { V as VTabs, a as VTab, b as VTabsWindow, c as VTabsWindowItem, d as _sfc_main$6 } from './RegistroPessoas-BGyAfxew.mjs';
...
import { aS as useRoute$1, b as useNuxtApp, e as useCookie, aU as VProgressCircular, V as VTextField, f as VBtn, c as useRuntimeConfig } from './server.mjs';
  ...
  async setup(__props, { emit: __emit }) {
    ...
    const createImovel = async () => {
      ...
      if (status.value === "success") {
        ...
        emit("saved", { id: data2.value.id, token: data2.value.token, ato_id: data2.value.ato_id });
        emit("refresh-list");
      }
    };
        ...
        _push(ssrRenderComponent(VContainer, mergeProps({
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(VRow, { class: "mt-10 justify-start align-e" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_NuxtLink, { onClick: goBack }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
              ...
              return [
                ...
                createVNode(VRow, { class: "mt-10 justify-start align-e" }, {
                  default: withCtx(() => [
                    createVNode(_component_NuxtLink, { onClick: goBack }, {
                      default: withCtx(() => [
                        createVNode(VBtn, {
                        ...
                        _push4(ssrRenderComponent(VTabsWindow, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(VTabsWindowItem, { value: "enderecos" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    if (unref(showPartes)) {
                                      _push6(ssrRenderComponent(_component_ModalImoveisElementosEnderecos, {
                                        isUpdate: true,
                                    ...
                                    return [
                                      unref(showPartes) ? (openBlock(), createBlock(_component_ModalImoveisElementosEnderecos, {
                                        key: 0,
                                        isUpdate: true,
                                        ato_id: unref(ato_id_imovel),
                                        ato_token: props.ato_token,
                                        imovel_id: unref(imovel_id_prop),
                                        onCloseModal: closeModal
                                      }, null, 8, ["ato_id", "ato_token", "imovel_id"])) : createCommentVNode("", true)
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              _push5(ssrRenderComponent(VTabsWindowItem, { value: "partes" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    if (unref(showPartes)) {
                                      _push6(ssrRenderComponent(_component_ModalImoveisElementosPartes, {
                                        imovel_id: unref(imovel_id_prop),
                                        ato_token: props.ato_token,
                                        ato_id: props.ato_id,
                                    ...
                                    return [
                                      unref(showPartes) ? (openBlock(), createBlock(_component_ModalImoveisElementosPartes, {
                                        ...
                                        ato_token_selected: props.ato_token_selected,
                                        onCloseModal: closeModal
                                      }, null, 8, ["imovel_id", "ato_token", "ato_id", "ato_token_selected"])) : createCommentVNode("", true)
                                    ];
                                  }
                                }),
                                _: 1
...
//# sourceMappingURL=Atualizar-CGWgRwbu.mjs.map
