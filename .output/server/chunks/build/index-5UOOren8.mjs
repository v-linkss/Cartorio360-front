import { _ as _sfc_main$1 } from './Ordem-QjMb9D61.mjs';
import { _ as _sfc_main$2 } from './Confirmacao-BPmf7T_8.mjs';
import { _ as __unimport_formatDate } from './formatDate-Han2ORzf.mjs';
import { ref, computed, resolveComponent, withCtx, unref, createVNode, createTextVNode, toDisplayString, isRef, useSSRContext } from 'vue';
...
import 'node:url';
import 'node:path';
import './VAutocomplete-ChQPKqBs.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1${_scopeId2}> Recebimento de Ordens de Servi\xE7o - <span style="${ssrRenderStyle({ "color": "red" })}"${_scopeId2}>Caixa ${ssrInterpolate(("formatDate" in _ctx ? _ctx.formatDate : unref(__unimport_formatDate))(unref(data)))}</span> - ${ssrInterpolate(unref(nome_usuario))}</h1>`);
                } else {
                  return [
                    createVNode("h1", null, [
                      createTextVNode(" Recebimento de Ordens de Servi\xE7o - "),
                      createVNode("span", { style: { "color": "red" } }, "Caixa " + toDisplayString(("formatDate" in _ctx ? _ctx.formatDate : unref(__unimport_formatDate))(unref(data))), 1),
...
//# sourceMappingURL=index-5UOOren8.mjs.map
