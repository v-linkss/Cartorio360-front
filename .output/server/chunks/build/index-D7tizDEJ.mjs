...
import { u as useRouter$1, f as useNuxtApp, d as useCookie, aK as VProgressCircular, V as VTextField, e as VBtn, b as useRuntimeConfig } from './server.mjs';
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(VRow, { class: "mb-3" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas/lista" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
...
//# sourceMappingURL=index-D7tizDEJ.mjs.map
