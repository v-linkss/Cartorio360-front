...
import { _ as _sfc_main$2 } from './Ordem-CAqSJCZv.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrInterpolate } from 'vue/server-renderer';
...
import { V as VCard, b as VCardText } from './VCard-B1PhK9Ih.mjs';
...
import { _ as _imports_0, a as _imports_2$1, b as _imports_3 } from './excluido-CyV-jbSn.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const headers = [
      ...
      { title: "N\xFAmero", value: "numero", width: "120px" },
      { title: "Situa\xE7\xE3o", value: "situacao", width: "120px" },
      ...
      try {
        ...
        if (servicosData.value.length > 0) {
          servicosItems.value = servicosData.value.map((item) => {
            return {
              ...item,
              data: item.data ? __unimport_formatDate(item.data, "dd/mm/yyyy") : null
            };
          });
        } else {
          servicosItems.value = [];
      ...
      try {
        ...
        const { data: servicosData, error } = await useFetch(allServicos, {
          ...
          body: {
            cartorio_token: cartorio_token.value,
            usuario_token: usuario_token.value,
            data_fim: (dadosRestaurados == null ? void 0 : dadosRestaurados.data_fim) || currentDate,
            data_inicio: (dadosRestaurados == null ? void 0 : dadosRestaurados.data_inicio) || currentDate
          }
        }, "$xKnfARCL4G");
        if (servicosData.value.length > 0) {
          servicosItems.value = servicosData.value.map((item) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VRow, { class: "mb-5" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1${_scopeId}>Ordens de Servi\xE7o</h1>`);
            _push2(ssrRenderComponent(_component_NuxtLink, { to: "/os/criar-registro" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img style="${ssrRenderStyle({ "width": "60px", "height": "60px", "cursor": "pointer", "margin-left": "70px" })}"${ssrRenderAttr("src", _imports_0)} alt="novo"${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
      ...
      _push(ssrRenderComponent(VRow, { style: { "margin-bottom": "-35px" } }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VCol, { md: "1" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VTextField, {
      ...
      _push(ssrRenderComponent(VRow, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VCol, { md: "3" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(VCol, { md: "2" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VAutocomplete, {
            ...
            _push2(ssrRenderComponent(VCol, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div${_scopeId2}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Pesquisar"${_scopeId2}></div>`);
                } else {
                  return [
      ...
      _push(ssrRenderComponent(VDataTable, {
        ...
        "item.actions": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { style: { "display": "flex", "gap": "4px", "margin-top": "-5px" } }, {
              default: withCtx((_, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="${ssrRenderClass({ disabled: !item.btn_receber })}"${ssrRenderAttr("title", item.btn_receber ? "Receber" : "Bloqueado")} title="Receber"${_scopeId2}><img style="${ssrRenderStyle({
                    cursor: item.btn_receber ? "pointer" : "default",
                    width: "30px",
                    height: "30px"
                  })}"${ssrRenderAttr("src", _imports_2)} alt="Receber"${_scopeId2}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Bloqueado")}${_scopeId2}><img style="${ssrRenderStyle({
                    cursor: item.btn_editar ? "pointer" : "default",
                    width: "30px",
                    height: "30px"
                  })}"${ssrRenderAttr("src", _imports_1$1)} alt="Editar"${_scopeId2}></div><div${ssrIncludeBooleanAttr(!item.btn_cancelar) ? " disabled" : ""} title="Cancelamento"${_scopeId2}>`);
                  if (item.excluido) {
                    _push3(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_2$1)} alt="Visualizar" title="Bloqueado"${_scopeId2}>`);
                  } else {
                    _push3(`<img${ssrRenderAttr("src", _imports_3)} alt="Cancelamento" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}" title="Cancelamento"${_scopeId2}>`);
                  }
                  _push3(`</div>`);
                } else {
                  return [
...
//# sourceMappingURL=index-DRcxNuV4.mjs.map
