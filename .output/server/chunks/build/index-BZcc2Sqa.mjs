...
import { _ as _export_sfc, u as useRouter$1, f as useNuxtApp, an as VImg, V as VTextField, e as VBtn, au as VSpacer, b as useRuntimeConfig, d as useCookie } from './server.mjs';
import { u as useFetch } from './fetch-Dsyde8UD.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle } from 'vue/server-renderer';
import { V as VDialog, a as VCard } from './VCard-DfTYaOUe.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-47ffea9d><div class="container-form" data-v-47ffea9d>`);
      ...
      _push(`<div class="text" data-v-47ffea9d>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-47ffea9d> Esqueceu a senha?</a></div><div class="background-image" data-v-47ffea9d></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-47ffea9d"]]);

export { index as default };
//# sourceMappingURL=index-BZcc2Sqa.mjs.map
