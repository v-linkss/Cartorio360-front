...
import { ref, computed, shallowRef, watch, provide, createVNode, withDirectives, resolveDirective, inject, vShow, mergeProps, Fragment, toRef, useSSRContext, nextTick, reactive, withAsyncContext, unref, withCtx, openBlock, createBlock, createTextVNode, isRef, renderList, createCommentVNode } from 'vue';
import { p as propsFactory, y as makeComponentProps, A as makeTagProps, O as makeThemeProps, o as genericComponent, Q as provideTheme, a5 as useRtl, ab as useLocale, aw as useGroup, e as VBtn, t as useRender, ax as makeGroupItemProps, ay as makeLazyProps, az as useGroupItem, aA as useSsrBoot, aB as useLazy, aC as MaybeTransition, M as makeRoundedProps, H as makeElevationProps, R as Ripple, X as useElevation, ad as useTextColor, aD as convertToUnit, aH as VScaleTransition, a0 as useRounded, aJ as useBackgroundColor, aK as makeFocusProps, aL as makeVInputProps, q as useProxiedModel, aM as useFocus, aN as VInput, aO as VLabel, a8 as omit, aP as makeVBtnProps, v as forwardRefs, aS as makeVSlideGroupProps, C as makeDensityProps, U as useDensity, s as useScopeId, z as provideDefaults, aU as VSlideGroup, aE as getDecimals, aF as createRange, aQ as animate, aR as standardEasing, aT as isObject, f as useNuxtApp, c as useRoute$1, u as useRouter$1, d as useCookie, V as VTextField, as as VDataTable, aV as VSpacer, _ as _export_sfc, av as keys, aG as clamp, b as useRuntimeConfig, aI as keyValues, aW as VSelect } from './server.mjs';
...
import { _ as _imports_0$3, a as _imports_1, b as _imports_2, c as _imports_3 } from './mudarStatus-CVlVNUDw.mjs';
...
import { a as VDialog, V as VCard, d as VCardTitle, c as VCardText, b as VCardActions } from './VCard-uMKFEuGZ.mjs';
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-02650459"]]);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "d-flex align-items-center justify-space-between" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_BiometriaDigital, null, null, _parent3, _scopeId2));
                  _push3(`<div style="${ssrRenderStyle({ maxWidth: props.isModal ? "200px" : "none" })}"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_BiometriaReconhecimentoFacial, null, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                  ...
                  return [
                    ...
                    createVNode("div", {
                      style: { maxWidth: props.isModal ? "200px" : "none" }
                    }, [
            ...
            return [
              createVNode(VRow, { class: "d-flex align-items-center justify-space-between" }, {
                default: withCtx(() => [
                  createVNode(_component_BiometriaDigital),
                  createVNode("div", {
                    style: { maxWidth: props.isModal ? "200px" : "none" }
...
export { VTabs as V, _sfc_main$7 as _, VTab as a, VTabsWindow as b, VTabsWindowItem as c, _sfc_main$6 as d, _sfc_main$1 as e, __nuxt_component_4 as f };
//# sourceMappingURL=Restricoes-BmnJ34so.mjs.map
