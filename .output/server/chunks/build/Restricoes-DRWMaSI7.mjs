...
import { ref, computed, shallowRef, watch, provide, createVNode, withDirectives, resolveDirective, inject, vShow, mergeProps, Fragment, toRef, useSSRContext, nextTick, reactive, withAsyncContext, unref, withCtx, openBlock, createBlock, isRef, createTextVNode, renderList, createCommentVNode } from 'vue';
...
import { ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrGetDirectiveProps, ssrRenderList, ssrRenderAttrs } from 'vue/server-renderer';
...
const _sfc_main$4 = {
  ...
  async setup(__props) {
    ...
    const { data: imagemBiometria } = ([__temp, __restore] = withAsyncContext(() => useFetch(redenrizarFoto, {
      method: "POST",
      body: { path: "foto", bucket: "cartorio-teste", token }
                  ...
                  _push3(ssrRenderComponent(VBtn, mergeProps(activatorProps, {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (unref(fotoRender)) {
                          _push4(`<img${ssrRenderAttr("src", unref(capturedPhoto) || unref(fotoRender))} style="${ssrRenderStyle({ "width": "100%", "height": "100%", "object-fit": "cover" })}"${_scopeId3}>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
                        return [
                          !unref(fotoRender) ? (openBlock(), createBlock("img", {
                            key: 0,
                            src: _imports_0$2
                          })) : createCommentVNode("", true),
                          unref(fotoRender) ? (openBlock(), createBlock("img", {
                            key: 1,
                            src: unref(capturedPhoto) || unref(fotoRender),
...
//# sourceMappingURL=Restricoes-DRWMaSI7.mjs.map
