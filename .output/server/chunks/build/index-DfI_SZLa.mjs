...
import { b as useNuxtApp, a$ as VProgressCircular, V as VTextField, f as VBtn, c as useRuntimeConfig, e as useCookie } from './server.mjs';
    ...
    const enviaSelo = async () => {
      ...
      if (status.value === "success") {
        ...
        if (sucessoSelo.value === "success" || sucessoSelo.value === "error") {
          const { error: error3, status: sucessoMarcar } = await useFetch(marcarSelos, {
            method: "PUT",
            body: seloData
          }, "$ZZswjXVZN8");
...
//# sourceMappingURL=index-DfI_SZLa.mjs.map
