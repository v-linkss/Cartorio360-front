...
import { _ as _sfc_main$1 } from './TiposAtos-BLvdWI3D.mjs';
import { _ as _imports_3$1, a as _sfc_main$2 } from './Selos-BNgobXSM.mjs';
import { _ as _sfc_main$3 } from './Ordem-BiylbUCs.mjs';
import { _ as __nuxt_component_1 } from './Confirmacao-B244rx-z.mjs';
import { ref, reactive, resolveDirective, withCtx, createVNode, mergeProps, unref, withDirectives, createTextVNode, toDisplayString, openBlock, createBlock, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrGetDirectiveProps, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
import { _ as _imports_2$1, a as _imports_3$2 } from './excluido-ceRs5bdR.mjs';
import { _ as _export_sfc, b as useNuxtApp, e as useCookie, V as VTextField, c as useRuntimeConfig } from './server.mjs';
...
const _imports_3 = "" + buildAssetsURL("btn_cancela_lavratura.DGZVG9h_.png");
const _sfc_main = {
  __name: "index",
...
${item.ato_servico}` : `${item.ato_servico}`,
    ...
    async function openScanner() {
      try {
        const { data } = await useFetch(acionarScanner, { method: "GET" }, "$hJse5XXJsY");
      } catch (error) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 data-v-45a2c45a${_scopeId2}>Atos</h1>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCol, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-45a2c45a${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Pesquisar" data-v-45a2c45a${_scopeId3}></div>`);
                      } else {
                        return [
      ...
      _push(`<div style="${ssrRenderStyle({ "width": "1300px", "margin": "0 auto" })}" data-v-45a2c45a><hr class="mt-5 mb-5" data-v-45a2c45a>`);
      _push(ssrRenderComponent(VDataTable, {
        ...
        "item.actions": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(item.token)} <div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "justify-content": "center" })}" data-v-45a2c45a${_scopeId}><div title="Visualizar" data-v-45a2c45a${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar" data-v-45a2c45a${_scopeId}></div><div title="Reimprimir" data-v-45a2c45a${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3$1)} alt="Reimprimir" data-v-45a2c45a${_scopeId}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Desabilitado")} data-v-45a2c45a${_scopeId}><img style="${ssrRenderStyle({
              cursor: item.btn_editar ? "pointer" : "default",
              width: "30px",
              height: "30px"
            })}"${ssrRenderAttr("src", _imports_1$1)} alt="Editar" data-v-45a2c45a${_scopeId}></div><div${ssrIncludeBooleanAttr(!item.btn_cancelar) ? " disabled" : ""} title="Excluir" data-v-45a2c45a${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3)} alt="Cancelar" title="Cancelar" data-v-45a2c45a${_scopeId}></div><div data-v-45a2c45a${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="escanear" title="escanear" data-v-45a2c45a${_scopeId}></div><div title="Excluir" data-v-45a2c45a${_scopeId}>`);
            if (item.excluido) {
              _push2(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2$1)} alt="Visualizar" title="Reativar" data-v-45a2c45a${_scopeId}>`);
            } else {
              _push2(`<img${ssrRenderAttr("src", _imports_3$2)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}" title="Excluir" data-v-45a2c45a${_scopeId}>`);
            }
            _push2(`</div></div>`);
          } else {
            return [
              createTextVNode(toDisplayString(item.token) + " ", 1),
              createVNode("div", { style: { "display": "flex", "gap": "4px", "justify-content": "center" } }, [
                ...
                createVNode("div", {
                  ...
                  onClick: ($event) => item.btn_cancelar ? cancelaAto(item.token) : null,
                  title: "Excluir"
                }, [
                  createVNode("img", {
                    style: { "width": "30px", "height": "30px", "cursor": "pointer" },
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-45a2c45a"]]);

export { index as default };
//# sourceMappingURL=index-DrK7_0uX.mjs.map
