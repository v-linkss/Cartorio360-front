...
import { f as useNuxtApp, d as useCookie, V as VTextField, at as VDataTable, b as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    let showCreateAtos = ref(!!((_c = useCookie("user-service").value) == null ? void 0 : _c.numero));
    ...
    const state = reactive({
      nacionalidade: false,
      apresentante_nome: (_d = useCookie("user-service").value) == null ? void 0 : _d.apresentante_nome,
      apresentante_cpf: (_e = useCookie("user-service").value) == null ? void 0 : _e.apresentante_cpf,
      documento: null
    });
    const headers = [
...
//# sourceMappingURL=criar-registro-Bu1WomTJ.mjs.map
