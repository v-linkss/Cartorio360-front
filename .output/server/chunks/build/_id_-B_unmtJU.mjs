...
import { _ as _imports_0, a as _imports_2, b as _sfc_main$1 } from './salvar-C4ZaNlpJ.mjs';
import { f as useNuxtApp, c as useRoute$1, u as useRouter$1, d as useCookie, V as VTextField, aI as VDataTable, e as VBtn, b as useRuntimeConfig } from './server.mjs';
  ...
  async setup(__props) {
    ...
    const redirectToUpdateAto = (item) => {
      if (item.tipo === "PROCURA\xC7\xC3O") {
        router.push({ path: `/fontes/atos/procuracoes/atualizar/${item.id}`, query: { origem: "atualizar", id, ato_id: item.id } });
      }
    };
                            ...
                            if (_push5) {
                              ...
                              return [
                                ...
                                createVNode("div", {
                                  ...
                                  onClick: ($event) => item.btn_editar ? redirectToUpdateAto({ id: item.id, tipo: item.tipo }) : null,
...
//# sourceMappingURL=_id_-B_unmtJU.mjs.map
