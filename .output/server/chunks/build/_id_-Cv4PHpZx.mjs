...
import { _ as _imports_3, a as _sfc_main$1 } from './Selos-BNgobXSM.mjs';
...
import { b as useNuxtApp, f as useRoute$1, u as useRouter$1, e as useCookie, V as VTextField, g as VBtn, c as useRuntimeConfig } from './server.mjs';
                          ...
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div title="Visualizar"${_scopeId4}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar"${_scopeId4}></div><div title="Reimprimir"${_scopeId4}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3)} alt="Reimprimir"${_scopeId4}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Desabilitado")}${_scopeId4}><img style="${ssrRenderStyle({
                                ...
                                width: "30px",
                                height: "30px"
                              })}"${ssrRenderAttr("src", _imports_1$1)} alt="Editar"${_scopeId4}></div><div title="Excluir"${_scopeId4}>`);
                              if (item.btn_cancelar) {
                                _push5(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="Cancelar" title="Cancelado"${_scopeId4}>`);
                              } else {
                                _push5(`<img${ssrRenderAttr("src", _imports_3$1)} alt="Cancelado" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "not-allowed", "opacity": "0.5" })}" title="N\xE3o permitido cancelar"${_scopeId4}>`);
                              }
                              _push5(`</div>`);
                            } else {
                              return [
                                ...
                                createVNode("div", {
                                  ...
                                  item.btn_cancelar ? (openBlock(), createBlock("img", {
                                    key: 0,
                                    style: { "width": "30px", "height": "30px", "cursor": "pointer" },
                                    src: _imports_2,
                                    alt: "Cancelar",
                                    ...
                                    alt: "Cancelado",
                                    class: "trash-icon",
                                    style: { "width": "30px", "height": "30px", "cursor": "not-allowed", "opacity": "0.5" },
                                    title: "N\xE3o permitido cancelar"
                                  }))
                                ], 8, ["onClick"])
                              ];
                            }
...
//# sourceMappingURL=_id_-Cv4PHpZx.mjs.map
