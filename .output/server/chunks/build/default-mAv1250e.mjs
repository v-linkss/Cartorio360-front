          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="d-flex align-center" data-v-7188ddf4${_scopeId2}><img class="ml-5 mt-2" width="300" height="50"${ssrRenderAttr("src", _imports_0)} data-v-7188ddf4${_scopeId2}><h3 class="cartorio ml-6" data-v-7188ddf4${_scopeId2}>${ssrInterpolate(cartorioNome.value)}</h3></div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7188ddf4"]]);

export { _default as default };
//# sourceMappingURL=default-mAv1250e.mjs.map
