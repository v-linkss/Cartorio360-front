  ...
  setup(__props) {
    ...
    const alterarSenha = async () => {
      ...
      try {
        ...
        $toast.error(
          ((_b = (_a = error == null ? undefined : error.data) == null ? undefined : _a.menssage) == null ? undefined : _b.details) || ((_c = error == null ? undefined : error.data) == null ? undefined : _c.status_mensagem)
        );
      }
    };
                  ...
                  _push3(ssrRenderComponent(VContainer, { style: { "max-width": "650px" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div data-v-4332a1af${_scopeId3}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4332a1af"]]);

export { index as default };
//# sourceMappingURL=index-ChsCPjwa.mjs.map
