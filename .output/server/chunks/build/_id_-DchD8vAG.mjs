...
import { c as _sfc_main$c, d as _sfc_main$b, e as _sfc_main$a, f as _sfc_main$9, g as _sfc_main$2, h as __nuxt_component_6 } from './RegistroPessoas-C2tiPh3C.mjs';
import { ref, reactive, resolveDirective, mergeProps, withCtx, unref, createVNode, toDisplayString, isRef, createTextVNode, openBlock, createBlock, createCommentVNode, withDirectives, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrGetDirectiveProps } from 'vue/server-renderer';
import { _ as _export_sfc, u as useRouter$1, b as useNuxtApp, a$ as useRoute$1, e as useCookie, b1 as VProgressCircular, V as VTextField, f as VBtn, c as useRuntimeConfig } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VCard, mergeProps({ width: "1300" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { style: { "background-color": "#f5f2f2" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 style="${ssrRenderStyle({ "color": "#525050", "padding": "10px 0px 0px 30px" })}" data-v-b6e32455${_scopeId3}>${ssrInterpolate(unref(id) ? "Atualiza\xE7\xE3o de Pessoas" : "Cadastramento de Pessoas")}</h1>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(VCol, { class: "d-flex justify-end" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h3 style="${ssrRenderStyle({ "color": "#525050", "padding": "20px 10px 10px 10px" })}" data-v-b6e32455${_scopeId3}> Cadastrado em ${ssrInterpolate(unref(criacaoData))}</h3>`);
                      } else {
                        return [
                          createVNode("h3", { style: { "color": "#525050", "padding": "20px 10px 10px 10px" } }, " Cadastrado em " + toDisplayString(unref(criacaoData)), 1)
                        ];
                      }
                    }),
                    _: 1
            ...
            _push2(`<div style="${ssrRenderStyle({ "background-color": "#f5f2f2", "padding": "20px 0px 20px 20px" })}" data-v-b6e32455${_scopeId}>`);
            ...
            _push2(`</div>`);
            if (unref(loading)) {
              _push2(`<div class="d-flex justify-center" data-v-b6e32455${_scopeId}>`);
              ...
              _push2(`<div data-v-b6e32455${_scopeId}>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b6e32455"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DchD8vAG.mjs.map
