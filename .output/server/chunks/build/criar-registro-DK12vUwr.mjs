  ...
  async setup(__props) {
    ...
    async function onSubmit() {
      ...
      if (await v$.value.$validate()) {
        const { data: data2, error, status } = await fetchWithToken(createOs, {
          method: "POST",
    ...
    async function validarCpf(cpf) {
      ...
      if (cpfFormated.length === 11 && !isValidatingCpf) {
        ...
        try {
          const { data: data2, error, status } = await fetchWithToken(routeValidaCpf, {
            method: "POST",
            body: payloadFormated
          }, "$e6ybTA3ect");
          if (status.value === "error" && error.value.statusCode === 500) {
...
//# sourceMappingURL=criar-registro-DK12vUwr.mjs.map
