        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VContainer, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "width": "600px", "margin-top": "10px" })}" data-v-118f8b41${_scopeId2}>`);
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "width": "180px", "margin-top": "20px" })}" data-v-118f8b41${_scopeId2}>`);
                  ...
                  _push3(ssrRenderComponent(VRow, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-118f8b41${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_NuxtLink, { onClick: goBack }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<img class="btn-pointer mt-10 mb-5"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-118f8b41${_scopeId4}>`);
                            } else {
                              return [
                                createVNode("img", {
                        ...
                        _push4(`</div><img class="btn-pointer mt-10"${ssrRenderAttr("src", _imports_1)} data-v-118f8b41${_scopeId3}>`);
                      } else {
                        return [
...
const autenticacao = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-118f8b41"]]);

export { autenticacao as default };
//# sourceMappingURL=autenticacao-2s7Rlb6j.mjs.map
