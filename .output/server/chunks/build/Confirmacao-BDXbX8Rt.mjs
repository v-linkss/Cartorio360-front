...
import { _ as _export_sfc, g as VBtn } from './server.mjs';
import { V as VDialog } from './VDialog-BVe31KMa.mjs';
import { V as VCard, b as VCardText, c as VCardActions } from './VCard-GijVrXxT.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCardText, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-2609ad6e${_scopeId3}>${ssrInterpolate(__props.condMessage)} `);
                        if (__props.description) {
                          _push4(`<div class="description-scroll mt-2" data-v-2609ad6e${_scopeId3}>${ssrInterpolate(__props.description)}</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (__props.valor) {
                          _push4(`<div class="mt-5" data-v-2609ad6e${_scopeId3}><span style="${ssrRenderStyle({ "font-size": "larger" })}" data-v-2609ad6e${_scopeId3}>Valor Emolumento</span> : R$${ssrInterpolate(__props.valor.valor_emolumento)} \xA0 <span style="${ssrRenderStyle({ "font-size": "large" })}" data-v-2609ad6e${_scopeId3}>Valor Ato</span>: R$${ssrInterpolate(__props.valor.valor_ato)} <br data-v-2609ad6e${_scopeId3}><span style="${ssrRenderStyle({ "font-size": "large" })}" data-v-2609ad6e${_scopeId3}>Valor Selo</span> : R$${ssrInterpolate(__props.valor.valor_selo)} \xA0<span style="${ssrRenderStyle({ "font-size": "large" })}" data-v-2609ad6e${_scopeId3}>Valor TSNR</span> : R$${ssrInterpolate(__props.valor.valor_tsnr)}</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2609ad6e"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=Confirmacao-BDXbX8Rt.mjs.map
