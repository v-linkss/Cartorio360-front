...
import { _ as _imports_5, a as _imports_0$1, b as _imports_2$1, c as _imports_0$2, d as _imports_1$2, e as _sfc_main$1$1, f as _sfc_main$8 } from './abre-arquivo-verde-Df3w2CT0.mjs';
import { _ as _imports_1 } from './visualizar-BoZ30DMV.mjs';
import { _ as _imports_0, a as _imports_2, b as _imports_3$1 } from './excluido-CyV-jbSn.mjs';
  ...
  async setup(__props) {
    ...
    async function visualisarAnexo(item) {
      try {
        ...
        (void 0).open(data2.data.value, "_blank");
      } catch (error) {
        console.error("Erro ao excluir pessoa:", error);
      }
    }
...
//# sourceMappingURL=TiposAtos-BfExKDkx.mjs.map
