...
import { ref, computed, shallowRef, watch, provide, createVNode, withDirectives, resolveDirective, inject, vShow, mergeProps, Fragment, toRef, useSSRContext, nextTick, reactive, withAsyncContext, unref, withCtx, openBlock, createBlock, isRef, createTextVNode, renderList, toDisplayString, createCommentVNode } from 'vue';
import { p as propsFactory, W as makeComponentProps, Y as makeTagProps, a9 as makeThemeProps, t as genericComponent, ac as provideTheme, aq as useRtl, v as useLocale, aI as useGroup, e as VBtn, C as useRender, aJ as makeGroupItemProps, aK as makeLazyProps, aL as useGroupItem, aM as useSsrBoot, aN as useLazy, aO as MaybeTransition, a7 as makeRoundedProps, a3 as makeElevationProps, ab as Ripple, ah as useElevation, y as useTextColor, aF as convertToUnit, aR as VScaleTransition, al as useRounded, aT as useBackgroundColor, aU as makeFocusProps, av as makeVInputProps, w as useProxiedModel, ay as useFocus, aA as VInput, aV as VLabel, o as omit, aW as makeVBtnProps, D as forwardRefs, aZ as makeVSlideGroupProps, a0 as makeDensityProps, af as useDensity, T as useScopeId, X as provideDefaults, a$ as VSlideGroup, aP as getDecimals, aQ as createRange, aX as animate, aY as standardEasing, a_ as isObject, f as useNuxtApp, c as useRoute$1, d as useCookie, V as VTextField, as as VDataTable, au as VSpacer, _ as _export_sfc, aH as keys, aG as clamp, b as useRuntimeConfig, aS as keyValues, b0 as VSelect } from './server.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-link-DyZc7qn_.mjs';
...
import { ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrGetDirectiveProps, ssrRenderList, ssrRenderAttrs, ssrInterpolate } from 'vue/server-renderer';
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(VRow, { style: { "display": "flex", "margin-top": "-8px", "gap": "10px" } }, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div title="editar"${_scopeId3}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="editar"${_scopeId3}></div><div title="deletar"${_scopeId3}>`);
                          if (item.excluido) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3)} alt="deletar" title="Reativar"${_scopeId3}>`);
                          } else {
                            _push4(`<img${ssrRenderAttr("src", _imports_4)} alt="reativar" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}" title="reativar"${_scopeId3}>`);
                          }
                          _push4(`</div>`);
                        } else {
                          return [
                ...
                "item.actions": withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(VRow, { style: { "display": "flex", "margin-top": "-8px", "gap": "10px" } }, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div title="Visualizar"${_scopeId3}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="Visualizar"${_scopeId3}></div><div title="Visualizar"${_scopeId3}>`);
                          if (item.excluido) {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VCol, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="finger-container" data-v-0eecfcf8${_scopeId}><!--[-->`);
            ssrRenderList(unref(leftFingers), (finger, index) => {
              _push2(`<div class="finger" style="${ssrRenderStyle(getFingerStyle(finger, "left"))}" data-v-0eecfcf8${_scopeId}></div>`);
            });
            _push2(`<!--]--><!--[-->`);
            ssrRenderList(unref(rightFingers), (finger, index) => {
              _push2(`<div class="finger" style="${ssrRenderStyle(getFingerStyle(finger, "right"))}" data-v-0eecfcf8${_scopeId}></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-0eecfcf8"]]);
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    async function openDirectory() {
      try {
        const directoryHandle = await (void 0).showDirectoryPicker();
        files.value = [];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-a97bff64><img${ssrRenderAttr("src", _imports_0$1)} style="${ssrRenderStyle({ "width": "280px", "height": "120px", "cursor": "pointer", "margin-top": "30px" })}" data-v-a97bff64>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Arquivos da Pasta`);
                      } else {
                        return [
                          createTextVNode("Arquivos da Pasta")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(VContainer, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "justify-content": "center", "align-items": "center" })}" data-v-a97bff64${_scopeId3}>`);
                        _push4(ssrRenderComponent(VBtn, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Abrir Pasta de Arquivos`);
                            } else {
                              return [
                                createTextVNode("Abrir Pasta de Arquivos")
                              ];
                            }
                          }),
                          _: 1
                        ...
                        if (unref(files).length) {
                          _push4(ssrRenderComponent(VRow, { class: "mt-5" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<!--[-->`);
                                ssrRenderList(unref(files), (file) => {
                                  _push5(ssrRenderComponent(VCol, {
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "justify-content": "space-between" })}" data-v-a97bff64${_scopeId5}>${ssrInterpolate(file.name)} `);
                                        _push6(ssrRenderComponent(VBtn, {
                                          color: "green",
                                          onClick: ($event) => uploadFile(file)
                                        }, {
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              _push7(`Enviar`);
                        ...
                        return [
                          createVNode("div", { style: { "display": "flex", "justify-content": "center", "align-items": "center" } }, [
                            createVNode(VBtn, {
                              color: "green",
                              onClick: openDirectory
                            }, {
                          ...
                          unref(files).length ? (openBlock(), createBlock(VRow, {
                            key: 0,
                            class: "mt-5"
                          }, {
                            default: withCtx(() => [
                  ...
                  _push3(`<div data-v-a97bff64${_scopeId2}>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a97bff64"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BiometriaScanner = __nuxt_component_0;
      _push(ssrRenderComponent(VCol, mergeProps({ cols: "auto" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_BiometriaDigital = __nuxt_component_0$1;
...
//# sourceMappingURL=Restricoes-BOswjIs_.mjs.map
