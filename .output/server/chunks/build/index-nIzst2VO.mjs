...
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "chat-sidebar" }, _attrs))} data-v-2cb5d4ee><h2 class="sidebar-header" data-v-2cb5d4ee>Cart\xF3rio 360</h2><!--[-->`);
      ssrRenderList(__props.chats, (chat) => {
        _push(`<button class="${ssrRenderClass([{ active: chat.id === __props.activeChatId }, "chat-item"])}" data-v-2cb5d4ee><span class="chat-name" data-v-2cb5d4ee>${ssrInterpolate(chat.name.split("_").slice(1).join("_"))}</span><span class="chat-preview" data-v-2cb5d4ee>${ssrInterpolate(chat.preview)}</span></button>`);
      });
      _push(`<!--]--></aside>`);
    };
  }
...
const ChatSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-2cb5d4ee"]]);
const _sfc_main$3 = {
  __name: "ChatHistory",
  __ssrInlineRender: true,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "chat-history" }, _attrs))} data-v-ed9306e5><!--[-->`);
      ssrRenderList(__props.messages, (msg, i) => {
        var _a;
        _push(`<div class="${ssrRenderClass(["chat-bubble", msg.from === unref(userNameCookie) ? "from-user" : "from-server"])}" data-v-ed9306e5>${(_a = formatText(msg.text)) != null ? _a : ""}</div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const ChatHistory = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ed9306e5"]]);
const _sfc_main$2 = {
  __name: "ChatInput",
  __ssrInlineRender: true,
  emits: ["send"],
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "chat-window" }, _attrs))} data-v-cd49accb><header class="chat-header" data-v-cd49accb><h3 class="chat-title" data-v-cd49accb>${ssrInterpolate(__props.chat.name.split("_").slice(1).join("_"))}</h3><div data-v-cd49accb><button class="chat-button end" data-v-cd49accb>Encerrar</button><button class="chat-close" data-v-cd49accb>\u2716</button></div></header>`);
...
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-cd49accb"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "chat-app" }, _attrs))} data-v-d5c7efe2>`);
      ...
      if (activeChat.value) {
        ...
        _push(`<div class="placeholder" data-v-d5c7efe2> Selecione um chat \xE0 esquerda </div>`);
      }
      _push(`</div>`);
    };
  }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d5c7efe2"]]);

export { index as default };
//# sourceMappingURL=index-nIzst2VO.mjs.map
