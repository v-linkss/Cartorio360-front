...
import { useSSRContext, ref, reactive, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, createCommentVNode, computed, withAsyncContext, provide, watch, toDisplayString, mergeProps, isRef } from 'vue';
import { ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrInterpolate } from 'vue/server-renderer';
import { b as useNuxtApp, u as useRouter$1, a$ as useRoute$1, V as VTextField, f as VBtn, e as useCookie, b1 as VProgressCircular, b2 as VSheet, c as useRuntimeConfig } from './server.mjs';
...
import { _ as _sfc_main$7 } from './RegistroPessoas-EdcsESCC.mjs';
import { _ as _imports_7, T as Toolbar, W as WordExport, S as Search, r as registerLicense, D as DocumentEditorContainerComponent, a as _imports_0$1, b as _imports_2$2, c as _imports_0$2, d as _imports_1$2, e as _sfc_main$1$1, f as _sfc_main$8 } from './abre-arquivo-verde-wqhCIn-y.mjs';
import { _ as __nuxt_component_1 } from './FichaCard-LDNNOLnf.mjs';
...
import { _ as _imports_2$1, a as _imports_3$1 } from './excluido-ceRs5bdR.mjs';
import { V as VDataTable } from './VDataTable-C86S73KO.mjs';
import { _ as _sfc_main$9 } from './Confirmacao-BnNgq5i3.mjs';
...
const _sfc_main$5 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ModalPapel = _sfc_main$8;
      const _component_ModalFichaCard = __nuxt_component_1;
      const _component_NuxtLink = __nuxt_component_0;
      _push(ssrRenderComponent(VContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              _push2(ssrRenderComponent(VRow, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (!unref(isVisualizar)) {
                      _push3(`<div${_scopeId2}><img class="mt-1"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "width": "40px", "cursor": "pointer" })}" title="Criar Representante"${_scopeId2}>`);
                      if (unref(possuiFicha)) {
                        _push3(`<img class="mt-0 ml-2"${ssrRenderAttr("src", _imports_1)} style="${ssrRenderStyle({ "width": "40px", "cursor": "pointer" })}" title="Visualizar Ficha"${_scopeId2}>`);
                      } else {
                        _push3(`<img style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}"${ssrRenderAttr("src", _imports_2)} alt="Visualizar" title="N\xE3o Ficha"${_scopeId2}>`);
                      }
                      _push3(`</div>`);
                    } else {
                      _push3(`<!---->`);
                    ...
                    return [
                      ...
                      !unref(isVisualizar) ? (openBlock(), createBlock("div", { key: 0 }, [
                        ...
                        unref(possuiFicha) ? (openBlock(), createBlock("img", {
                          key: 0,
                          class: "mt-0 ml-2",
                          src: _imports_1,
                          style: { "width": "40px", "cursor": "pointer" },
                          title: "Visualizar Ficha",
                          onClick: ($event) => isModalFichaOpen.value = true
                              ...
                              if (!unref(isVisualizar)) {
                                _push5(ssrRenderComponent(VRow, null, {
                                  default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div style="${ssrRenderStyle({ "display": "flex", "cursor": "pointer", "justify-content": "flex-end" })}" class="mr-1" title="Visualizar Ficha"${_scopeId5}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar"${_scopeId5}></div><div style="${ssrRenderStyle({ "display": "flex", "cursor": "pointer", "justify-content": "flex-end" })}" class="mr-1" title="Alterar Papel"${_scopeId5}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_1$1)} alt="Visualizar"${_scopeId5}></div><div class="mr-1" style="${ssrRenderStyle({ "display": "flex", "cursor": "pointer", "justify-content": "flex-end" })}" title="Deletar Pessoa"${_scopeId5}>`);
                                      if (item.excluido) {
                                        ...
                                        _push6(`<img${ssrRenderAttr("src", _imports_3$1)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}" title="Excluir"${_scopeId5}>`);
                                      }
                                      _push6(`</div><div style="${ssrRenderStyle({ "display": "flex", "cursor": "pointer", "justify-content": "flex-end" })}" class="mr-1" title="Selecionar Representante"${_scopeId5}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_7)} alt="Visualizar"${_scopeId5}></div>`);
                                    } else {
                                      return [
                                        createVNode("div", {
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(allEscreventes, {
      method: "POST",
      body: { cartorio_token }
    }, "$sMqfUUQcBM")), __temp = await __temp, __restore(), __temp);
      ...
      _push(ssrRenderComponent(VContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                        ...
                        _push4(ssrRenderComponent(VDataTable, {
                          ...
                          "item.actions": withCtx(({ item }, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              if (item.excluido) {
                                _push5(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_2$1)} alt="Visualizar" title="Reativar"${_scopeId4}>`);
                              } else {
                                _push5(`<img${ssrRenderAttr("src", _imports_3$1)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}" title="Excluir"${_scopeId4}>`);
                              }
                              _push5(`</div>`);
                            } else {
                              return [
            ...
            return [
              !isVisualizar.value ? (openBlock(), createBlock(VRow, {
                key: 0,
                class: "mt-5"
              }, {
                default: withCtx(() => [
                ...
                if (_push3) {
                  ...
                  if (!unref(isVisualizar)) {
                    ...
                    if (unref(status_arquivo) === false) {
                      ...
                      _push3(`<img class="mt-3 ml-2" style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3)} alt="Criar"${_scopeId2}>`);
                    }
                    _push3(`</div>`);
                  } else {
                    _push3(`<!---->`);
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (item.excluido) {
                          ...
                          _push4(`<img${ssrRenderAttr("src", _imports_3$1)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}" title="Excluir"${_scopeId3}>`);
                        }
                        _push4(`</div>`);
                      } else {
                        return [
...
export { _sfc_main$6 as _, _sfc_main$5 as a, _sfc_main$4 as b, _sfc_main$3 as c, _sfc_main$2 as d, _sfc_main$1 as e, _sfc_main as f };
//# sourceMappingURL=TiposAtos-C_Bj0D4o.mjs.map
