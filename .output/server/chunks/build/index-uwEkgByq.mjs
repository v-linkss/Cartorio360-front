...
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "chat-sidebar" }, _attrs))} data-v-3f4741c1><h2 class="sidebar-header" data-v-3f4741c1>Cart\xF3rio 360</h2><!--[-->`);
      ssrRenderList(__props.chats, (chat) => {
        _push(`<button class="${ssrRenderClass([{ active: chat.id === __props.activeChatId }, "chat-item"])}" data-v-3f4741c1><span class="chat-name" data-v-3f4741c1>${ssrInterpolate(chat.name)}</span><span class="chat-preview" data-v-3f4741c1>${ssrInterpolate(chat.preview)}</span></button>`);
      });
      _push(`<!--]--></aside>`);
    };
  }
...
const ChatSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-3f4741c1"]]);
const _sfc_main$3 = {
  __name: "ChatHistory",
  __ssrInlineRender: true,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "chat-history" }, _attrs))} data-v-bfedfc79><!--[-->`);
      ssrRenderList(__props.messages, (msg, i) => {
        var _a;
        _push(`<div class="${ssrRenderClass(["chat-bubble", msg.from === "user" ? "from-user" : "from-server"])}" data-v-bfedfc79>${(_a = formatText(msg.text)) != null ? _a : ""}</div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const ChatHistory = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-bfedfc79"]]);
const _sfc_main$2 = {
  __name: "ChatInput",
  __ssrInlineRender: true,
  emits: ["send"],
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "chat-window" }, _attrs))} data-v-1802e13a><header class="chat-header" data-v-1802e13a><h3 class="chat-title" data-v-1802e13a>${ssrInterpolate(__props.chat.name)}</h3><div data-v-1802e13a><button class="chat-button end" data-v-1802e13a>Encerrar</button><button class="chat-close" data-v-1802e13a>\u2716</button></div></header>`);
...
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1802e13a"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "chat-app" }, _attrs))} data-v-eb374982>`);
      ...
      if (activeChat.value) {
        ...
        _push(`<div class="placeholder" data-v-eb374982> Selecione um chat \xE0 esquerda </div>`);
      }
      _push(`</div>`);
    };
  }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eb374982"]]);

export { index as default };
//# sourceMappingURL=index-uwEkgByq.mjs.map
