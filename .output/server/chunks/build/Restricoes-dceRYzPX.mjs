...
const _sfc_main$7 = {
  ...
  async setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (!unref(pending)) {
        _push(ssrRenderComponent(VContainer, mergeProps({ style: { "height": "525px" } }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(VRow, { class: "mt-15" }, {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ style: { "height": "525px" } }, _attrs))}><h1>Restri\xE7\xF5es</h1></div>`);
}
...
//# sourceMappingURL=Restricoes-dceRYzPX.mjs.map
