...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "chat-window" }, _attrs))} data-v-4b3b5bf4><header class="chat-header" data-v-4b3b5bf4><h3 class="chat-title" data-v-4b3b5bf4>${ssrInterpolate(__props.chat.name.split("_").slice(1).join("_"))}</h3><div data-v-4b3b5bf4><button class="chat-button end" data-v-4b3b5bf4>Encerrar</button><button class="chat-close" data-v-4b3b5bf4>\u2716</button></div></header>`);
...
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4b3b5bf4"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-B1-SCQy8.mjs.map
