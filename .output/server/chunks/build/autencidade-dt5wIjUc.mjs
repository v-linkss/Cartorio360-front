import { _ as _sfc_main$1 } from './RegistroPessoas-EdcsESCC.mjs';
import { _ as __nuxt_component_1 } from './FichaCard-LDNNOLnf.mjs';
import { _ as _sfc_main$2 } from './ErrorModalCard-fyxI1wKb.mjs';
...
import { u as useRouter$1, a$ as useRoute$1, b as useNuxtApp, e as useCookie, V as VTextField, f as VBtn, c as useRuntimeConfig } from './server.mjs';
                  ...
                  _push3(ssrRenderComponent(VDataTable, {
                    ...
                    "item.actions": withCtx(({ item }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (item.link_ficha) {
                          _push4(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3)} alt="Possui Ficha"${_scopeId3}>`);
                        } else {
...
//# sourceMappingURL=autencidade-dt5wIjUc.mjs.map
