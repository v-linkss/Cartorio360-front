...
import { useSSRContext, ref, reactive, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, createCommentVNode, withAsyncContext, provide, watch, toDisplayString, mergeProps, isRef } from 'vue';
...
import { _ as _sfc_main$7, a as __nuxt_component_1 } from './RegistroPessoas-AeLREaTI.mjs';
import { _ as _imports_5, a as _imports_0$1, b as _imports_2$1, c as _imports_0$2, d as _imports_1$2, e as _sfc_main$1$1, f as _sfc_main$8 } from './abre-arquivo-verde-DAt2GvNd.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              _push2(ssrRenderComponent(VRow, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (!unref(isVisualizar)) {
                      _push3(`<div${_scopeId2}><img class="mt-1"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "width": "40px", "cursor": "pointer" })}" title="Criar Representante"${_scopeId2}><img class="mt-3 ml-2"${ssrRenderAttr("src", _imports_1)} style="${ssrRenderStyle({ "width": "40px", "cursor": "pointer" })}" title="Visualisar Fixa"${_scopeId2}></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  } else {
            ...
            _push2(ssrRenderComponent(_component_ModalFichaCard, {
              ...
              onConfirmar: ($event) => _ctx.confirmItem(unref(state).pessoa),
                                            ...
                                            if (_push7) {
                                              _push7(ssrRenderComponent(VCol, null, {
                                                default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                  if (_push8) {
                                                    _push8(` Livro: ${ssrInterpolate(unref(lavraData)[0].livro_numero)} Protocolo: ${ssrInterpolate(unref(lavraData)[0].protocolo ? unref(lavraData)[0].protocolo : null)}`);
                                                  } else {
                                                    return [
                                                      createTextVNode(" Livro: " + toDisplayString(unref(lavraData)[0].livro_numero) + " Protocolo: " + toDisplayString(unref(lavraData)[0].protocolo ? unref(lavraData)[0].protocolo : null), 1)
                                                    ];
                                                  }
                                                }),
                                                _: 1
            ...
            _push2(ssrRenderComponent(VRow, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!unref(isVisualizar)) {
                    _push3(`<div title="Escanear"${_scopeId2}><img class="mt-3" style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2$1)} alt="Escanear"${_scopeId2}></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (!unref(isVisualizar)) {
...
//# sourceMappingURL=TiposAtos-DceIZmOq.mjs.map
