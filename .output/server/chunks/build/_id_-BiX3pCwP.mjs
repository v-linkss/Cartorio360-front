...
import { b as _sfc_main$b, c as _sfc_main$a, d as _sfc_main$9, e as _sfc_main$8, f as _sfc_main$2, g as __nuxt_component_6 } from './RegistroPessoas-DkyXsHI-.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VCard, mergeProps({ width: "1300" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 style="${ssrRenderStyle({ "background-color": "#f5f2f2", "color": "#525050", "padding": "10px 0px 0px 20px" })}" data-v-abc39eb0${_scopeId}>${ssrInterpolate(unref(id) ? "Atualiza\xE7\xE3o de Pessoas" : "Cadastramento de Pessoas")}</h1><div style="${ssrRenderStyle({ "background-color": "#f5f2f2", "padding": "20px 0px 20px 20px" })}" data-v-abc39eb0${_scopeId}>`);
            ...
            _push2(`</div>`);
            if (unref(loading)) {
              _push2(`<div class="d-flex justify-center" data-v-abc39eb0${_scopeId}>`);
              ...
              _push2(`<div data-v-abc39eb0${_scopeId}>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-abc39eb0"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-BiX3pCwP.mjs.map
