...
import { _ as _export_sfc, u as useRouter$1, b as useNuxtApp, V as VTextField, f as VBtn, a_ as VSpacer, c as useRuntimeConfig, e as useCookie } from './server.mjs';
                  ...
                  _push3(ssrRenderComponent(VContainer, { style: { "max-width": "650px" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="text" data-v-b9ee361d${_scopeId3}>Login</div>`);
                        ...
                        _push4(`<div data-v-b9ee361d${_scopeId3}><a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "white", "margin-left": "10px" })}" data-v-b9ee361d${_scopeId3}> Esqueceu a senha?</a></div>`);
                      } else {
                        return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b9ee361d"]]);

export { index as default };
//# sourceMappingURL=index-wJERN8ob.mjs.map
