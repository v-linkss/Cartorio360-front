...
import { c as useRoute$1, d as useCookie, b as useRuntimeConfig, f as useNuxtApp, u as useRouter$1, V as VTextField, e as VBtn, as as VDataTable, a2 as VImg } from './server.mjs';
import { ref, withAsyncContext, withCtx, unref, isRef, createTextVNode, createVNode, useSSRContext, reactive, openBlock, createBlock } from 'vue';
...
import { _ as _sfc_main$6 } from './RegistroPessoas-B4KqFkQ-.mjs';
import { _ as _sfc_main$2$1, a as _sfc_main$5, b as _imports_5, c as _imports_0$1, d as _sfc_main$4$1, e as _sfc_main$3$1 } from './escanear--Cx8mmIm.mjs';
  ...
  async setup(__props) {
    ...
    const createRepresentante = async () => {
      ...
      for (const element of pessoasTable.value) {
        if (element.pessoa_id === state.pessoa.id && element.tipo_parte_id === state.papeis) {
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ProcuracaoAtualizarDados = _sfc_main$4;
      const _component_ProcuracaoAtualizarPartes = _sfc_main$3;
...
//# sourceMappingURL=_id_-B2kPebI0.mjs.map
