...
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "chat-sidebar" }, _attrs))} data-v-a080787e><h2 class="sidebar-header" data-v-a080787e>Cart\xF3rio 360</h2><!--[-->`);
      ssrRenderList(__props.chats, (chat) => {
        _push(`<button class="${ssrRenderClass([{ active: chat.id === __props.activeChatId }, "chat-item"])}" data-v-a080787e><span class="chat-name" data-v-a080787e>${ssrInterpolate(chat.name)}</span><span class="chat-preview" data-v-a080787e>${ssrInterpolate(chat.preview)}</span></button>`);
      });
      _push(`<!--]--></aside>`);
    };
  }
...
const ChatSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-a080787e"]]);
const _sfc_main$3 = {
  __name: "ChatHistory",
  __ssrInlineRender: true,
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "chat-window" }, _attrs))} data-v-06f45017><header class="chat-header" data-v-06f45017><h3 class="chat-title" data-v-06f45017>${ssrInterpolate(__props.chat.name)}</h3><div data-v-06f45017><button class="chat-button end" data-v-06f45017>Encerrar</button><button class="chat-close" data-v-06f45017>\u2716</button></div></header>`);
...
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-06f45017"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "chat-app" }, _attrs))} data-v-564d6b67>`);
      ...
      if (activeChat.value) {
        ...
        _push(`<div class="placeholder" data-v-564d6b67> Selecione um chat \xE0 esquerda </div>`);
      }
      _push(`</div>`);
    };
  }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-564d6b67"]]);

export { index as default };
//# sourceMappingURL=index-n13U1twB.mjs.map
