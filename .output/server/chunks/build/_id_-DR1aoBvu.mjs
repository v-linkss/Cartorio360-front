...
import { V as VTabs, a as VTab, b as VTabsWindow, c as VTabsWindowItem, _ as _sfc_main$3, d as _sfc_main$2, e as _sfc_main$1, f as __nuxt_component_4 } from './Restricoes-mwTcltsV.mjs';
...
import { V as VCard } from './VCard-Bi_-FQxd.mjs';
...
const _sfc_main = {
  ...
  async setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Documentos = _sfc_main$3;
      const _component_Endereco = _sfc_main$2;
      const _component_Biometria = _sfc_main$1;
      ...
      _push(ssrRenderComponent(VCard, mergeProps({ width: "1300" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 style="${ssrRenderStyle({ "background-color": "#c8fcca", "color": "#429946", "padding": "10px 0px 0px 20px" })}" data-v-7bb6b2fd${_scopeId}>${ssrInterpolate(unref(id) ? "Atualiza\xE7\xE3o de Pessoas" : "Cadastramento de Pessoas")}</h1><div style="${ssrRenderStyle({ "background-color": "#c8fcca", "padding": "20px 0px 20px 20px" })}" data-v-7bb6b2fd${_scopeId}>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(pending)) {
                          ...
                          _push4(`<div data-v-7bb6b2fd${_scopeId3}>${ssrInterpolate(unref(error).message)}</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (!unref(pending)) {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas/registros" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-7bb6b2fd${_scopeId6}>`);
                                          } else {
                                            return [
                                              createVNode("img", {
                                                class: "btn-pointer",
                                      ...
                                      _push6(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_1)} data-v-7bb6b2fd${_scopeId5}>`);
                                    } else {
                                      return [
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7bb6b2fd"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-DR1aoBvu.mjs.map
