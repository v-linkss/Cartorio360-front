...
import { _ as _imports_3, a as _sfc_main$2 } from './Selos-CRmwLM9d.mjs';
import { _ as _sfc_main$3 } from './Ordem-xAzEw_j2.mjs';
import { _ as __nuxt_component_1 } from './Confirmacao-BxeiKfAq.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    `${config.public.managemant}/cancela_lavratura`;
    ...
    const ato_token_para_cancelar = ref(null);
...
${item.ato_servico}` : `${item.ato_servico}`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 data-v-aa63338c${_scopeId2}>Atos</h1>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCol, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-aa63338c${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Pesquisar" data-v-aa63338c${_scopeId3}></div>`);
                      } else {
                        return [
      ...
      _push(`<div style="${ssrRenderStyle({ "width": "1300px", "margin": "0 auto" })}" data-v-aa63338c><hr class="mt-5 mb-5" data-v-aa63338c>`);
      _push(ssrRenderComponent(VDataTable, {
        ...
        "item.actions": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "justify-content": "center" })}" data-v-aa63338c${_scopeId}><div title="Visualizar" data-v-aa63338c${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar" data-v-aa63338c${_scopeId}></div><div title="Reimprimir" data-v-aa63338c${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3)} alt="Reimprimir" data-v-aa63338c${_scopeId}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Desabilitado")} data-v-aa63338c${_scopeId}><img style="${ssrRenderStyle({
              cursor: item.btn_editar ? "pointer" : "default",
              width: "30px",
              height: "30px"
            })}"${ssrRenderAttr("src", _imports_1$1)} alt="Editar" data-v-aa63338c${_scopeId}></div><div title="Excluir" data-v-aa63338c${_scopeId}>`);
            if (item.excluido) {
              _push2(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="Visualizar" title="Reativar" data-v-aa63338c${_scopeId}>`);
            } else {
              _push2(`<img${ssrRenderAttr("src", _imports_3$1)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}" title="Excluir" data-v-aa63338c${_scopeId}>`);
            }
            _push2(`</div></div>`);
          } else {
            return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aa63338c"]]);

export { index as default };
//# sourceMappingURL=index-Dcz1o8Vh.mjs.map
