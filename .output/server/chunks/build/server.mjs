...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CTzzna6B.mjs').then((m) => m.default || m)
  },
  {
    name: "fontes-atos-ReconhecimentoFirma",
    path: "/fontes/atos/ReconhecimentoFirma",
    component: () => import('./ReconhecimentoFirma-xq8njznI.mjs').then((m) => m.default || m)
  },
  {
    name: "fontes-atos-Testamento",
    path: "/fontes/atos/Testamento",
    component: () => import('./Testamento-zeJGkPIK.mjs').then((m) => m.default || m)
  },
  {
    name: "home",
    path: "/home",
    component: () => import('./index-CyKK3eJt.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cvk0JuMJ.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-DwQHQtSz.mjs').then((m) => m.default || m)
  },
  {
    name: "pessoas-atualizar-id",
    path: "/pessoas/atualizar/:id()",
    component: () => import('./_id_-C44xc2xS.mjs').then((m) => m.default || m)
  },
  {
    name: "pessoas",
    path: "/pessoas",
    component: () => import('./index-ltK834xA.mjs').then((m) => m.default || m)
  },
  {
    name: "pessoas-registros",
    path: "/pessoas/registros",
    component: () => import('./index-BSlP1Zlp.mjs').then((m) => m.default || m)
  },
  {
    name: "pessoas-vizualizar-id",
    path: "/pessoas/vizualizar/:id()",
    component: () => import('./_id_-Bi8lrjlh.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-Mw2kUoCY.mjs').then((m) => m.default || m)
};
...
export { VAvatar as $, useRender as A, convertToUnit as B, VScaleTransition as C, keyValues as D, useRounded as E, useBackgroundColor as F, makeFocusProps as G, makeVInputProps as H, useProxiedModel as I, useFocus as J, VInput as K, VLabel as L, makeTagProps as M, breakpoints as N, makeVOverlayProps as O, VDialogTransition as P, useScopeId as Q, Ripple as R, VOverlay as S, VDefaultsProvider as T, forwardRefs as U, VImg as V, provideDefaults as W, createSimpleFunctional as X, IconValue as Y, makeDensityProps as Z, _export_sfc as _, navigateTo as a, makeLayoutItemProps as a$, VIcon as a0, makeBorderProps as a1, makeDimensionProps as a2, makeLoaderProps as a3, makeLocationProps as a4, makePositionProps as a5, makeRouterProps as a6, makeThemeProps as a7, makeVariantProps as a8, provideTheme as a9, ensureValidVNode as aA, VChip as aB, noop as aC, wrapInArray as aD, matchesSelector as aE, VProgressLinear as aF, makeVImgProps as aG, VSheet as aH, keys as aI, useGroup as aJ, makeGroupItemProps as aK, makeLazyProps as aL, useGroupItem as aM, useSsrBoot as aN, useLazy as aO, MaybeTransition as aP, useRoute$1 as aQ, VProgressCircular as aR, makeVBtnProps as aS, animate as aT, standardEasing as aU, makeVSlideGroupProps as aV, VSlideGroup as aW, isObject as aX, VDataTable as aY, VResponsive as aZ, VExpandTransition as a_, useBorder as aa, useVariant as ab, useDensity as ac, useDimension as ad, useLoader as ae, useLocation as af, usePosition as ag, useLink as ah, LoaderSlot as ai, genOverlays as aj, VTextField as ak, makeFilterProps as al, makeSelectProps as am, omit as an, makeVTextFieldProps as ao, makeTransitionProps$1 as ap, useLocale as aq, useItems as ar, useForm as as, useFilter as at, useScrolling as au, VMenu as av, VList as aw, VListItem as ax, VVirtualScroll as ay, VCheckboxBtn as az, useRuntimeConfig as b, useToggleScope as b0, useLayoutItem as b1, useLayout as b2, VApp as b3, VListItemTitle as b4, useCookie as c, useNuxtApp as d, entry$1 as default, VSpacer as e, VBtn as f, VSelect as g, asyncDataDefaults as h, injectHead as i, createError as j, fetchDefaults as k, useRequestFetch as l, makeRoundedProps as m, nuxtLinkDefaults as n, makeElevationProps as o, propsFactory as p, getDecimals as q, resolveUnrefHeadInput as r, useRtl as s, createRange as t, useRouter$1 as u, clamp as v, makeComponentProps as w, genericComponent as x, useElevation as y, useTextColor as z };
