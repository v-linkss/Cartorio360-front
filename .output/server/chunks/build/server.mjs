...
const _routes = [
  ...
  },
  {
    name: "cancela_ato",
    path: "/cancela_ato",
    component: () => import('./index-DDZOvckS.mjs')
  },
  {
  ...
  },
  {
    name: "os-criar-ato",
    path: "/os/criar-ato",
    component: () => import('./criar-ato-DurBDN8p.mjs')
  },
  {
    name: "os-criar-registro",
    path: "/os/criar-registro",
    component: () => import('./criar-registro-FaCvZiVs.mjs')
  },
  {
    name: "os-lista",
    path: "/os/lista",
