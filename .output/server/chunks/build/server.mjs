...
const _routes = [
  ...
  },
  {
    name: "os-lista",
    path: "/os/lista",
    component: () => import('./index-6kcdYWQW.mjs')
  },
  {
    name: "pessoas-atualizar-id",
    path: "/pessoas/atualizar/:id()",
    component: () => import('./_id_-DchD8vAG.mjs')
  },
  {
    name: "pessoas-cadastro",
    path: "/pessoas/cadastro",
    component: () => import('./index-oHPVF3hJ.mjs')
  },
  {
    name: "pessoas-lista",
    path: "/pessoas/lista",
  ...
  },
  {
    ...
    component: () => import('./_id_-DF8LXbe5.mjs')
  },
  {
    name: "relatorios-lista",
    path: "/relatorios/lista",
    component: () => import('./lista-D6k1-3m7.mjs')
  },
  {
    name: "selos-enviar",
    path: "/selos/enviar",
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-gkocgLVJ.mjs').then((m) => m.default || m))
};
...
export { useDisplay as $, makeTransitionProps$1 as A, useLocale as B, useProxiedModel as C, useTextColor as D, useForm as E, VMenu as F, VIcon as G, ensureValidVNode as H, VDefaultsProvider as I, noop as J, wrapInArray as K, matchesSelector as L, IconValue as M, deepEqual as N, makeDensityProps as O, makeThemeProps as P, getUid as Q, provideDefaults as R, Ripple as S, filterInputAttrs as T, VLabel as U, VTextField as V, useDensity as W, useBackgroundColor as X, makeDisplayProps as Y, makeGroupProps as Z, _export_sfc as _, navigateTo as a, useRoute$1 as a$, useGroup as a0, useResizeObserver as a1, useGoTo as a2, VFadeTransition as a3, focusableChildren as a4, makeVariantProps as a5, provideTheme as a6, EventProp as a7, makeBorderProps as a8, makeElevationProps as a9, deprecate as aA, focusChild as aB, Intersect as aC, makeVBtnProps as aD, animate as aE, standardEasing as aF, keys as aG, makeLazyProps as aH, useLazy as aI, useScopeId as aJ, isObject as aK, isOn as aL, createRange as aM, keyValues as aN, defineFunctionalComponent as aO, consoleError as aP, isEmpty as aQ, makeLoaderProps as aR, useLoader as aS, LoaderSlot as aT, getObjectValueByPath as aU, makeVOverlayProps as aV, VOverlay as aW, makeLocationProps as aX, makePositionProps as aY, useLocation as aZ, usePosition as a_, makeGroupItemProps as aa, makeRoundedProps as ab, makeRouterProps as ac, makeSizeProps as ad, useBorder as ae, useVariant as af, useElevation as ag, useRounded as ah, useSize as ai, useGroupItem as aj, useLink as ak, genOverlays as al, VExpandXTransition as am, clamp as an, debounce as ao, makeDimensionProps as ap, getCurrentInstance as aq, useDimension as ar, useToggleScope as as, convertToUnit as at, VDialogTransition as au, getPropertyFromItem as av, defineComponent as aw, MaybeTransition as ax, VExpandTransition as ay, createSimpleFunctional as az, useNuxtApp as b, VSpacer as b0, VProgressCircular as b1, VSheet as b2, getDecimals as b3, VScaleTransition as b4, makeFocusProps as b5, makeVInputProps as b6, useFocus as b7, VInput as b8, makeVFieldProps as b9, filterFieldProps as ba, VField as bb, VCounter as bc, callEvent as bd, makeLayoutItemProps as be, useLayoutItem as bf, useLayout as bg, VApp as bh, useRuntimeConfig as c, resolveUnrefHeadInput as d, entry$1 as default, useCookie as e, VBtn as f, fetchDefaults as g, useRequestFetch as h, injectHead as i, makeTagProps as j, genericComponent as k, useRtl as l, makeComponentProps as m, nuxtLinkDefaults as n, useRender as o, propsFactory as p, makeFormProps as q, resolveRouteObject as r, createForm as s, forwardRefs as t, useRouter$1 as u, breakpoints as v, asyncDataDefaults as w, createError as x, omit as y, makeVTextFieldProps as z };
