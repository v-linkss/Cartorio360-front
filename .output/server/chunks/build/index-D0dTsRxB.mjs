...
import { _ as _export_sfc, u as useRouter$1, b as useNuxtApp, V as VTextField, f as VBtn, aT as VSpacer, c as useRuntimeConfig, e as useCookie } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-3e3ffabd><div class="container-form" data-v-3e3ffabd>`);
      ...
      _push(`<div class="text" data-v-3e3ffabd>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-3e3ffabd> Esqueceu a senha?</a></div><div class="background-image" data-v-3e3ffabd></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3e3ffabd"]]);

export { index as default };
//# sourceMappingURL=index-D0dTsRxB.mjs.map
