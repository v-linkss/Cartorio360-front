...
import { _ as _export_sfc, ak as VTextField, b as useRuntimeConfig } from './server.mjs';
import { ref, withAsyncContext, unref, mergeProps, withCtx, isRef, createVNode, useSSRContext } from 'vue';
import { a as useLazyFetch } from './fetch-CXRKblKa.mjs';
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(VRow, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div style="${ssrRenderStyle({ "width": "600px", "margin": "20px 0px 20px 10px" })}" data-v-d627db6f${_scopeId3}>`);
                          ...
                          _push4(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<img class="btn-pointer" style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}"${ssrRenderAttr("src", _imports_1)} data-v-d627db6f${_scopeId4}>`);
                              } else {
                                return [
                                  createVNode("img", {
                                    class: "btn-pointer",
                    ...
                    _push3(`<div style="${ssrRenderStyle({ "width": "600px", "margin-top": "10px" })}" data-v-d627db6f${_scopeId2}>`);
                    _push3(ssrRenderComponent(VAutocomplete, { label: "Tabeli\xE3o/escriv\xE3o" }, null, _parent3, _scopeId2));
                    _push3(`</div><div style="${ssrRenderStyle({ "width": "600px", "margin-top": "20px" })}" data-v-d627db6f${_scopeId2}>`);
                    _push3(ssrRenderComponent(VTextField, { label: "Quantidade" }, null, _parent3, _scopeId2));
                    _push3(`</div>`);
                    _push3(ssrRenderComponent(VRow, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-d627db6f${_scopeId3}><img class="btn-pointer"${ssrRenderAttr("src", _imports_3)} data-v-d627db6f${_scopeId3}>`);
                        } else {
                          return [
                            createVNode("img", {
                              class: "btn-pointer",
...
const ReconhecimentoFirma = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d627db6f"]]);

export { ReconhecimentoFirma as default };
//# sourceMappingURL=ReconhecimentoFirma-xq8njznI.mjs.map
