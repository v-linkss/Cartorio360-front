<<<<<<<< HEAD:.output/server/chunks/build/autencidade-BA6_FHPc.mjs
import { b as _sfc_main$2 } from './RegistroPessoas-zPwhxeoq.mjs';
========
import { _ as _sfc_main$2 } from './RegistroPessoas-Dm_bitTh.mjs';
>>>>>>>> lavratura-cancela-um-selo:.output/server/chunks/build/autencidade-CvO39UUA.mjs
import { _ as _sfc_main$3 } from './FichaCard-BDq7cEeS.mjs';
import { _ as _sfc_main$4 } from './ErrorModalCard-BjuJgtQ6.mjs';
...
import { _ as _sfc_main$5 } from './SaveButton-CahdIl3Y.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCardText, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-ca5b7e48${_scopeId3}><p data-v-ca5b7e48${_scopeId3}> Digite o c\xF3digo de valida\xE7\xE3o para confirmar o ato de reconhecimento por autenticidade: </p><div class="random-numbers" data-v-ca5b7e48${_scopeId3}><span data-v-ca5b7e48${_scopeId3}>${ssrInterpolate(unref(randomNumbers).join(" "))}</span></div>`);
                        ...
                        if (unref(errorMessage)) {
                          _push4(`<div class="error-message" data-v-ca5b7e48${_scopeId3}>${ssrInterpolate(unref(errorMessage))}</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div>`);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ca5b7e48"]]);
const _sfc_main = {
  __name: "autencidade",
  __ssrInlineRender: true,
  props: {
  ...
  async setup(__props, { emit: __emit }) {
    ...
    escreventesItems.value = Array.isArray(data.value) && ((_a = data.value[0]) == null ? undefined : _a.func_json_escreventes) || [];
    ...
    async function reconhecerAtoAutencidade() {
      ...
      if (!state.escrevente) {
        ...
        throw new Error("Escrevente n\xE3o selecionado");
      }
      ...
      if (status.value === "success" && data2.value[0].status === "OK") {
        ...
        errorMessage.value = Array.isArray(data2.value) && ((_a2 = data2.value[0]) == null ? undefined : _a2.status_mensagem) || ((_c = (_b = error == null ? undefined : error.value) == null ? undefined : _b.data) == null ? undefined : _c.details) || "N\xE3o foi poss\xEDvel concluir o reconhecimento";
      }
    }
    async function reconhecerEtiquetaAutencidade(token) {
      ...
      if (status.value === "success") {
        const etiquetaResp = Array.isArray(data2.value) ? data2.value[0] : null;
        ...
        if (etiquetaResp.tipo_etiqueta === "html") {
          ...
          const { status: zplStatus, error: error2 } = await useFetch(`${imprimeZplSelo}`, {
            method: "POST",
            body: {
          ...
          if (zplStatus.value !== "success") {
            errorModalVisible.value = true;
            const apiErrorMessage = (_b = (_a2 = error2.value) == null ? undefined : _a2.data) == null ? undefined : _b.message;
            if (apiErrorMessage) {
              errorMessage.value = apiErrorMessage;
            } else {
              errorMessage.value = "O sistema demorou demais para responder e a impress\xE3o n\xE3o foi feita.";
            }
            return;
          }
        }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SaveButton = _sfc_main$5;
      _push(`<!--[-->`);
...
<<<<<<<< HEAD:.output/server/chunks/build/autencidade-BA6_FHPc.mjs
//# sourceMappingURL=autencidade-BA6_FHPc.mjs.map
========
//# sourceMappingURL=autencidade-CvO39UUA.mjs.map
>>>>>>>> lavratura-cancela-um-selo:.output/server/chunks/build/autencidade-CvO39UUA.mjs
