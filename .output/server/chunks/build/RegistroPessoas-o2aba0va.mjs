...
import { _ as _sfc_main$d } from './FichaCard-BDq7cEeS.mjs';
  ...
  async setup(__props, { emit: __emit }) {
    ...
    async function validarCpf(cpf2) {
      ...
      if (cpfFormated.length === 11 && !isValidatingCpf) {
        ...
        try {
          const { data, error: error2, status: status2 } = await useFetch(routeValidaCpf, {
            method: "POST",
            body: payloadFormated
          }, "$fcbWHpl5XR");
          if (status2.value === "error" && error2.value.statusCode === 500) {
...
export { _sfc_main as _, _sfc_main$6 as a, _sfc_main$b as b, _sfc_main$a as c, _sfc_main$9 as d, _sfc_main$8 as e, _sfc_main$2 as f, __nuxt_component_7 as g, _sfc_main$c as h };
//# sourceMappingURL=RegistroPessoas-o2aba0va.mjs.map
