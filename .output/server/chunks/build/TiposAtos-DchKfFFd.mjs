...
import { useSSRContext, ref, reactive, withCtx, unref, createVNode, createTextVNode, withAsyncContext, openBlock, createBlock, isRef, provide, watch, toDisplayString, createCommentVNode, mergeProps } from 'vue';
...
import { _ as _sfc_main$7, a as _sfc_main$6$1 } from './RegistroPessoas-OYaUKPCb.mjs';
import { _ as _imports_5, a as _imports_0$1, b as _imports_0$2, c as _sfc_main$1$1, d as _sfc_main$8 } from './escanear-D1wbsvZ-.mjs';
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    const lavraAto = async () => {
      if (!state.escrevente) {
        $toast.error("Selecione um escrevente para realizar a a\xE7\xE3o");
        return;
      }
      try {
                  ...
                  _push3(ssrRenderComponent(VContainer, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(` ${ssrInterpolate(unref(selectedServico).descricao)} - ${ssrInterpolate(unref(selectedAto).descricao)}`);
                      } else {
                        return [
                          createVNode(VRow, {
                            class: "mt-1 mb-3",
                          ...
                          createTextVNode(" " + toDisplayString(unref(selectedServico).descricao) + " - " + toDisplayString(unref(selectedAto).descricao), 1)
                        ];
                      }
                    }),
                    _: 1
...
//# sourceMappingURL=TiposAtos-DchKfFFd.mjs.map
