...
import { V as VTabs, a as VTab, b as VTabsWindow, c as VTabsWindowItem, _ as _sfc_main$1$1, d as _sfc_main$b } from './VTabs-ls7KM1Tt.mjs';
import { useSSRContext, inject, computed, createVNode, withDirectives, resolveDirective, vShow, ref, mergeProps, Fragment, reactive, withCtx, unref, createTextVNode, withAsyncContext, openBlock, createBlock, isRef, toRef, shallowRef, provide, watch, createCommentVNode, renderList } from 'vue';
import { ssrRenderComponent, ssrGetDirectiveProps, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrRenderAttrs } from 'vue/server-renderer';
import { useVuelidate } from '@vuelidate/core';
import { helpers, required } from '@vuelidate/validators';
import { p as propsFactory, z as makeRoundedProps, y as makeElevationProps, m as makeComponentProps, h as genericComponent, aa as Ripple, j as useRtl, ae as useElevation, as as useTextColor, k as useRender, P as convertToUnit, b2 as VScaleTransition, ah as useRounded, Y as useBackgroundColor, b3 as makeFocusProps, b4 as makeVInputProps, D as useProxiedModel, b5 as useFocus, b6 as VInput, aA as VLabel, u as useRouter$1, aS as useRoute$1, b as useNuxtApp, e as useCookie, V as VTextField, f as VBtn, aT as VSpacer, b1 as getDecimals, K as createRange, _ as _export_sfc, c as useRuntimeConfig, N as clamp, aU as VProgressCircular, L as keyValues } from './server.mjs';
import { f as fetchWithToken, $ as $fetchWithToken } from './fetchWithToken-KwnGRuiU.mjs';
import { V as VContainer } from './VContainer-CTpFP9Uv.mjs';
import { V as VRow, a as useLazyAsyncData, u as useFetch } from './VRow-CFCOc45b.mjs';
import { V as VCol } from './VCol-SA9_fG05.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-TpvcaGEw.mjs';
import { _ as _imports_0$3, a as _imports_2, b as _imports_3 } from './excluido-CyV-jbSn.mjs';
...
import { V as VSelect } from './filter-D8lmgvWc.mjs';
  ...
  async setup(__props, { emit: __emit }) {
    ...
    const {
      ...
      const formattedPessoasDocsItems = pessoasDocsItems.map((doc) => {
        return {
          ...doc,
          data_emissao: doc.data_emissao ? __unimport_formatDate(doc.data_emissao) : null,
          data_vencimento: doc.data_vencimento ? __unimport_formatDate(doc.data_vencimento) : null
        };
      });
      return {
        tipoDocumentoItems,
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Dados = _sfc_main$1$1;
      ...
      const _component_Endereco = _sfc_main$b;
...
export { VSlider as V, _sfc_main as _, _sfc_main$6 as a, _sfc_main$a as b, _sfc_main$9 as c, _sfc_main$8 as d, _sfc_main$2 as e, __nuxt_component_6 as f };
//# sourceMappingURL=RegistroPessoas-ChUc9tfR.mjs.map
