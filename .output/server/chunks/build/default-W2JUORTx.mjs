...
import { p as propsFactory, m as makeComponentProps, l as makeTagProps, o as genericComponent, s as useRender, R as makeBorderProps, U as makeElevationProps, W as makeRoundedProps, Y as makeThemeProps, ad as useBackgroundColor, a2 as useBorder, a6 as useElevation, a7 as useRounded, a1 as provideTheme, q as useRtl, ae as provideDefaults, F as VDefaultsProvider, aa as convertToUnit, O as VExpandTransition, be as makeLayoutItemProps, z as useProxiedModel, aR as useToggleScope, bf as useLayoutItem, T as makeDimensionProps, a5 as useDimension, bg as useLayout, _ as _export_sfc, am as clamp, u as useRouter$1, e as useCookie, bh as VApp, b0 as VSpacer, D as VMenu, g as VBtn } from './server.mjs';
...
import { V as VImg } from './VAvatar-CnoOhuaA.mjs';
import { c as useSsrBoot, a as VList, V as VListItem, d as VListItemTitle } from './VList-D6fdCBQk.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div data-v-f716a971${_scopeId2}><img class="ml-5 mt-2"${ssrRenderAttr("width", 300)}${ssrRenderAttr("height", 50)}${ssrRenderAttr("src", _imports_0)} data-v-f716a971${_scopeId2}><h3 style="${ssrRenderStyle({ "color": "white", "margin-left": "30px" })}" data-v-f716a971${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h3></div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f716a971"]]);

export { _default as default };
//# sourceMappingURL=default-W2JUORTx.mjs.map
