...
import { u as useRouter$1, g as useRoute$1, b as useNuxtApp, e as useCookie, b8 as VProgressCircular, f as VTextField, V as VBtn, c as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props, { emit: __emit }) {
    ...
    async function onUpdate() {
      ...
      const { data: data2, error: error2, status: status2 } = await fetchWithToken(
    ...
    async function validarDocument(cpf) {
      if (!isValidatingDocument) {
        ...
        try {
          ...
          if (status2.value === "error" && error2.value.statusCode === 500) {
            $toast.error(" o DOCUMENTO j\xE1 est\xE1 cadastrado.");
            return;
          }
          if (data.value.cpfValidation) {
            $toast.error(
              "J\xE1 existe uma pessoa cadastrada com o DOCUMENTO digitado."
            );
          }
        } catch (error2) {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VTextField, {
                            ...
                            label: "Documento",
                            onBlur: ($event) => validarDocument(unref(state).doc_identificacao)
...
//# sourceMappingURL=DadosEstrangeira-DAjM0QzL.mjs.map
