...
import { _ as _imports_5 } from './escanear-CtEqiezf.mjs';
                      ...
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          if (_ctx.status_arquivo === false) {
                            ...
                            _push4(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_5)} alt="Criar"${_scopeId3}>`);
                          }
                          _push4(`</div>`);
                        } else {
                          return [
...
//# sourceMappingURL=RegistroPessoas-DSS4469H.mjs.map
