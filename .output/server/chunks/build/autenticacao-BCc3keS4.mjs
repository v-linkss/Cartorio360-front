...
import { _ as _sfc_main$1 } from './ErrorModalCard-BIMdv72c.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VContainer, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "width": "600px", "margin-top": "10px" })}" data-v-0737e57c${_scopeId2}>`);
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "width": "180px", "margin-top": "20px" })}" data-v-0737e57c${_scopeId2}>`);
...
const autenticacao = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0737e57c"]]);

export { autenticacao as default };
//# sourceMappingURL=autenticacao-BCc3keS4.mjs.map
