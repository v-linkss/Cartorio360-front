...
import _sfc_main$1 from './semelhanca-DeuhxfwH.mjs';
import _sfc_main$2 from './autencidade-DT22MCV1.mjs';
import autenticacao from './autenticacao-DSQZ0OII.mjs';
import _sfc_main$3 from './geral-1eCej4CU.mjs';
import { u as useFetch } from './fetch-BmQEhRKR.mjs';
...
import 'vue-the-mask';
import './RegistroPessoas--0WwMv_i.mjs';
import '@vuelidate/core';
import '@vuelidate/validators';
import './fetchWithToken-CjrBCHhv.mjs';
import './filter-xIFdPtwJ.mjs';
...
import './VDialog-1xvltc7T.mjs';
import 'utif';
import './visualizar-BoZ30DMV.mjs';
import './FichaCard-tGHGSffw.mjs';
import './ErrorModalCard-3oCA2ht6.mjs';
import './Anexos-YoH-zlHg.mjs';
import './escanear-3JsBBM6K.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const components = {
      ...
      "/fontes/atos/ato-com-bem/geral": _sfc_main$3
    };
    const servicos = ref([]);
    const atos = ref([]);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<h1 data-v-49c0441e${_scopeId2}>Ordem de Servi\xE7o n\xBA</h1><h1 style="${ssrRenderStyle({ "color": "red", "margin-left": "30px" })}" data-v-49c0441e${_scopeId2}>${ssrInterpolate(unref(numeroOs) || ((_a = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? undefined : _a.numero) || null)}</h1>`);
                } else {
                  return [
...
const criarAto = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-49c0441e"]]);

export { criarAto as default };
//# sourceMappingURL=criar-ato-BTMO5fAT.mjs.map
