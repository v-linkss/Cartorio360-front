          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="d-flex align-center" data-v-aef0caa3${_scopeId2}><img class="ml-5 mt-2" width="300" height="50"${ssrRenderAttr("src", _imports_0)} data-v-aef0caa3${_scopeId2}><h3 class="cartorio ml-6" data-v-aef0caa3${_scopeId2}>${ssrInterpolate(unref(cartorioNome))}</h3></div>`);
                  ...
                  _push3(`<div class="flex flex-col justify-center align-center mt-6" data-v-aef0caa3${_scopeId2}>`);
                  _push3(ssrRenderComponent(VMenu, null, {
                    activator: withCtx(({ props }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  _push3(`<h4 class="mt-1" data-v-aef0caa3${_scopeId2}> CPF: <span data-v-aef0caa3${_scopeId2}>${ssrInterpolate(unref(cpf))}</span></h4></div>`);
                } else {
                  return [
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aef0caa3"]]);

export { _default as default };
//# sourceMappingURL=default-CEoZWFIn.mjs.map
