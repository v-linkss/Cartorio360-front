import { _ as _sfc_main$6, a as _sfc_main$5, b as _sfc_main$4, c as _sfc_main$3$1, d as _sfc_main$2$1, e as _sfc_main$1$1, f as _sfc_main$7 } from './TiposAtos-u2JnrWIe.mjs';
import { _ as __nuxt_component_0 } from './MoneyInput-ot-UsY0X.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-TpvcaGEw.mjs';
import { ref, withAsyncContext, withCtx, unref, createVNode, toDisplayString, isRef, createTextVNode, openBlock, createBlock, createCommentVNode, useSSRContext, reactive, computed, mergeProps, resolveDirective, withDirectives } from 'vue';
...
import { _ as _sfc_main$1$2, a as _sfc_main$8 } from './Atualizar-CqA-Mox6.mjs';
...
import './RegistroPessoas-BJJdUf3u.mjs';
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(allOutrosTj, {
      method: "POST",
      body: { cartorio_token }
    }, "$2e0uNuFQSO")), __temp = await __temp, __restore(), __temp);
    outrosItems.value = data.value;
    const { data: payloadOutros } = ([__temp, __restore] = withAsyncContext(() => useFetch(getOutros, {
      method: "POST",
      body: { cartorio_token }
...
//# sourceMappingURL=_id_-CglXx-HU.mjs.map
