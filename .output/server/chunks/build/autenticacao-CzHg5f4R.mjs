...
import { _ as _sfc_main$2 } from './ErrorModalCard-BjuJgtQ6.mjs';
...
import { _ as _export_sfc, u as useRouter$1, g as useRoute$1, b as useNuxtApp, e as useCookie, f as VTextField, V as VBtn, c as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const etiquetaAutentica = async (ato_token) => {
      const { data: data2, status, error } = await fetchWithToken(autenticaEtiquetas, {
        method: "POST",
        body: {
      ...
      if (status.value === "success") {
        ...
        if (data2.value.tipo_etiqueta === "html") {
          ...
          if (zplStatus.value !== "success") {
            errorModalVisible.value = true;
            errorMessage.value = error2.value.data.message;
            return;
          }
        }
        goBack();
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VContainer, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "width": "600px", "margin-top": "10px" })}" data-v-29f931c8${_scopeId2}>`);
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "width": "180px", "margin-top": "20px" })}" data-v-29f931c8${_scopeId2}>`);
...
const autenticacao = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-29f931c8"]]);

export { autenticacao as default };
//# sourceMappingURL=autenticacao-CzHg5f4R.mjs.map
