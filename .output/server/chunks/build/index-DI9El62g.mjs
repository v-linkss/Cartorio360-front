...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "chat-window" }, _attrs))} data-v-8dfe4863><header class="chat-header" data-v-8dfe4863><h3 class="chat-title" data-v-8dfe4863>${ssrInterpolate(__props.chat.name)}</h3><button class="chat-close" data-v-8dfe4863>\u2716</button></header>`);
...
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8dfe4863"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "chat-app" }, _attrs))} data-v-acac16cc>`);
      ...
      if (activeChat.value) {
        ...
        _push(`<div class="placeholder" data-v-acac16cc> Selecione um chat \xE0 esquerda </div>`);
      }
      _push(`</div>`);
    };
  }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-acac16cc"]]);

export { index as default };
//# sourceMappingURL=index-DI9El62g.mjs.map
