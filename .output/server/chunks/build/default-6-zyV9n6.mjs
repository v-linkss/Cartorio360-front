...
import { p as propsFactory, y as makeComponentProps, A as makeTagProps, o as genericComponent, t as useRender, F as makeBorderProps, H as makeElevationProps, M as makeRoundedProps, O as makeThemeProps, aG as useBackgroundColor, S as useBorder, X as useElevation, a0 as useRounded, Q as provideTheme, a5 as useRtl, z as provideDefaults, a2 as VImg, x as VDefaultsProvider, aB as convertToUnit, b3 as VExpandTransition, b4 as makeLayoutItemProps, q as useProxiedModel, b5 as useToggleScope, ay as useSsrBoot, b6 as useLayoutItem, G as makeDimensionProps, W as useDimension, b7 as useLayout, _ as _export_sfc, aV as clamp, u as useRouter$1, b8 as VApp, d as useCookie, aK as VSpacer, ah as VMenu, e as VBtn, ai as VList, aj as VListItem, b9 as VListItemTitle } from './server.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h5 style="${ssrRenderStyle({ "color": "#525050", "margin-left": "30px" })}" data-v-17728d2b${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h5>`);
                  _push3(ssrRenderComponent(VSpacer, null, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(VMenu, null, {
                    activator: withCtx(({ props }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VBtn, mergeProps({ style: { "color": "#525050" } }, props), {
                        ...
                        return [
                          createVNode(VBtn, mergeProps({ style: { "color": "#525050" } }, props), {
                            default: withCtx(() => [
                              createTextVNode(" Cadastros ")
                            ]),
                            _: 2
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-17728d2b"]]);

export { _default as default };
//# sourceMappingURL=default-6-zyV9n6.mjs.map
