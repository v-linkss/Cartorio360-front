...
import { _ as _sfc_main$1 } from './FichaCard-C0MTdS0w.mjs';
import { ref, resolveComponent, mergeProps, withCtx, createVNode, unref, isRef, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext } from 'vue';
...
import { f as VTextField, b8 as VProgressCircular, c as useRuntimeConfig, e as useCookie } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ModalFichaEspecial = resolveComponent("ModalFichaEspecial");
      _push(ssrRenderComponent(VContainer, mergeProps({ class: "mt-5" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(isModalFichaOpen) && !unref(isModalEspecialOpen)) {
            ...
            if (unref(isModalEspecialOpen)) {
              _push2(ssrRenderComponent(_component_ModalFichaEspecial, {
                show: unref(isModalEspecialOpen),
                "link-view": unref(linkFichaPessoa),
                "is-view": true,
                "pessoa-obj": unref(pessoaObj),
                onClose: ($event) => isModalEspecialOpen.value = false
              }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              ...
              _ctx.pending ? (openBlock(), createBlock(VProgressCircular, {
                key: 0,
                class: "loading-spinner",
                indeterminate: "",
                size: "80"
              ...
              unref(isModalFichaOpen) && !unref(isModalEspecialOpen) ? (openBlock(), createBlock(_component_ModalFichaCard, {
                key: 2,
                show: unref(isModalFichaOpen),
                "link-view": unref(linkFichaPessoa),
                "is-view": true,
              ...
              unref(isModalEspecialOpen) ? (openBlock(), createBlock(_component_ModalFichaEspecial, {
                key: 3,
                show: unref(isModalEspecialOpen),
                "link-view": unref(linkFichaPessoa),
                "is-view": true,
...
//# sourceMappingURL=index-qr2U5_Cq.mjs.map
