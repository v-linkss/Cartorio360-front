    ...
    const alterarSenha = async () => {
      ...
      try {
        ...
        if (status.value === "success") {
          $toast.success(
            data.value.status_mensagem || "Senha alterada com sucesso!"
          );
        } else {
          $toast.error(
                  ...
                  _push3(ssrRenderComponent(VContainer, { style: { "max-width": "650px" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div data-v-74f010dd${_scopeId3}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-74f010dd"]]);

export { index as default };
//# sourceMappingURL=index-o7XNfbUR.mjs.map
