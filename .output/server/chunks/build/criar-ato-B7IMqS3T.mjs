...
import _sfc_main$1 from './semelhanca-BUZfW9LX.mjs';
import _sfc_main$2 from './autencidade-lpDJiOHW.mjs';
import autenticacao from './autenticacao-DzyFAwqO.mjs';
import _sfc_main$3 from './geral-aCvzjaOY.mjs';
import _sfc_main$4 from './geral-CU1vPxkp.mjs';
import _sfc_main$5 from './geral-MIloGBQK.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`<h1 data-v-a8fb323d${_scopeId2}>Ordem de Servi\xE7o n\xBA</h1><h1 style="${ssrRenderStyle({ "color": "red", "margin-left": "30px" })}" data-v-a8fb323d${_scopeId2}>${ssrInterpolate(unref(numeroOs) || ((_a2 = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? undefined : _a2.numero) || null)}</h1>`);
                } else {
                  return [
...
const criarAto = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a8fb323d"]]);

export { criarAto as default };
//# sourceMappingURL=criar-ato-B7IMqS3T.mjs.map
