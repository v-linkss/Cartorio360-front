                  ...
                  _push3(ssrRenderComponent(VContainer, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="text" data-v-18436d56${_scopeId3}>Login</div>`);
                        ...
                        _push4(`<div data-v-18436d56${_scopeId3}><a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "white", "margin-left": "90px" })}" data-v-18436d56${_scopeId3}> Esqueceu a senha?</a></div>`);
                      } else {
                        return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-18436d56"]]);

export { index as default };
//# sourceMappingURL=index-CAyiStcy.mjs.map
