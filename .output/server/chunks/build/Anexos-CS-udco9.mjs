...
import { useSSRContext, watch, ref, reactive, withAsyncContext, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, provide, toDisplayString, createCommentVNode } from 'vue';
...
import { _ as _sfc_main$6, a as __nuxt_component_1 } from './RegistroPessoas-AeLREaTI.mjs';
import { _ as _imports_5, a as _imports_0$1, c as _imports_0$2, d as _imports_1$2, b as _imports_2$1, e as _sfc_main$1$1, f as _sfc_main$7 } from './abre-arquivo-verde-DAt2GvNd.mjs';
            ...
            _push2(ssrRenderComponent(VRow, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div${_scopeId2}><img class="mt-3"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "width": "40px", "cursor": "pointer" })}" title="Criar Representante"${_scopeId2}><img class="mt-3 ml-2"${ssrRenderAttr("src", _imports_1)} style="${ssrRenderStyle({ "width": "40px", "cursor": "pointer" })}" title="Visualisar Fixa"${_scopeId2}></div>`);
                } else {
                  return [
                    createVNode(VCol, { cols: "4" }, {
                      default: withCtx(() => [
...
//# sourceMappingURL=Anexos-CS-udco9.mjs.map
