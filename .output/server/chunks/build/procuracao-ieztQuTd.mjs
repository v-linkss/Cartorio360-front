...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    const getAtoId = `${config.public.auth}/service/gerencia/getAtosTiposByToken`;
    const createAtoObservacao = `${config.public.auth}/service/gerencia/createAtosObservacao`;
    const observacaoUpdate = `${config.public.auth}/service/gerencia/updateAtosObservacao`;
    const cartorio_token = ref(useCookie("user-data").value.cartorio_token);
...
//# sourceMappingURL=procuracao-ieztQuTd.mjs.map
