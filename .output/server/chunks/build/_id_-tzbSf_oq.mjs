    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VCard, mergeProps({ width: "1300" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 style="${ssrRenderStyle({ "background-color": "#c8fcca", "color": "#429946", "padding": "10px 0px 0px 20px" })}" data-v-6d12aedd${_scopeId}>${ssrInterpolate(unref(id) ? "Atualiza\xE7\xE3o de Pessoas" : "Cadastramento de Pessoas")}</h1><div style="${ssrRenderStyle({ "background-color": "#c8fcca", "padding": "20px 0px 20px 20px" })}" data-v-6d12aedd${_scopeId}>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(pending)) {
                          ...
                          _push4(`<div data-v-6d12aedd${_scopeId3}>${ssrInterpolate(unref(error).message)}</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (!unref(pending)) {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas/registros" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-6d12aedd${_scopeId6}>`);
                                          } else {
                                            return [
                                              createVNode("img", {
                                                class: "btn-pointer",
                                      ...
                                      _push6(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_1)} data-v-6d12aedd${_scopeId5}>`);
                                    } else {
                                      return [
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6d12aedd"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-tzbSf_oq.mjs.map
