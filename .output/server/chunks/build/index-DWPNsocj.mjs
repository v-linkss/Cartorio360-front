...
import { _ as _sfc_main$3 } from './Ordem-Bi-SbRCz.mjs';
import { ref, reactive, resolveDirective, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString, withDirectives, openBlock, createBlock, useSSRContext, watch, isRef, createCommentVNode } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderAttr, ssrGetDirectiveProps, ssrRenderClass, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
import { _ as _imports_0$1 } from './imprimir-C92Cn5tA.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    async function openScanner() {
      try {
        const { data } = await useFetch(acionarScanner, { method: "GET" }, "$IO02J210Z9");
      } catch (error) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1${_scopeId2}>Ordens de Servi\xE7o</h1> ${ssrInterpolate(unref(ordemserv_token))} `);
                  ...
                  return [
                    ...
                    createTextVNode(" " + toDisplayString(unref(ordemserv_token)) + " ", 1),
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          ...
                          createTextVNode(" >>>>>>> refact/combolist ")
                        ];
                      }
                    }),
                    _: 1
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="${ssrRenderClass({ disabled: !item.btn_receber })}"${ssrRenderAttr("title", item.btn_receber ? "Receber" : "Bloqueado")} title="Receber"${_scopeId3}><img style="${ssrRenderStyle({
                          ...
                          width: "30px",
                          height: "30px"
                        })}"${ssrRenderAttr("src", _imports_0$1)} alt="Emitir Recibo"${_scopeId3}></div><div${_scopeId3}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_5)} alt="escanear" title="escanear"${_scopeId3}></div><div${ssrIncludeBooleanAttr(!item.btn_cancelar) ? " disabled" : ""} title="Cancelamento" style="${ssrRenderStyle({
            ...
            return [
              ...
              createVNode(_component_ModalImprecaoRecibo, {
                ...
                token: unref(ordemserv_token),
                onClose: ($event) => isModalImprecaoRecibo.value = false
              }, null, 8, ["show", "apresentante_nome", "apresentante_cpf", "token", "onClose"])
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-DWPNsocj.mjs.map
