...
import { _ as _imports_0, b as _imports_3, a as _imports_2 } from './excluido-CyV-jbSn.mjs';
                          ...
                          "item.actions": withCtx(({ item }, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              if (item.btn_cancelar === false) {
                                _push5(`<img${ssrRenderAttr("src", _imports_2)} style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}" alt="Remover"${_scopeId4}>`);
                              } else {
                                _push5(`<!---->`);
                              }
                              _push5(`</div>`);
...
//# sourceMappingURL=Ordem-IeOesCrJ.mjs.map
