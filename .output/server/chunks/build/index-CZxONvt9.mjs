import { ref, mergeProps, withCtx, unref, isRef, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext, withAsyncContext, reactive } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrInterpolate } from 'vue/server-renderer';
import { useVuelidate } from '@vuelidate/core';
import { helpers, required } from '@vuelidate/validators';
import { u as useRouter$1, b as useNuxtApp, e as useCookie, aU as VProgressCircular, V as VTextField, f as VBtn, c as useRuntimeConfig } from './server.mjs';
...
const _sfc_main$2 = {
  ...
  async setup(__props, { emit: __emit }) {
    ...
    const {
      ...
      try {
        const [situacaoItens, naturezaImoveisItens, tipoLogradouroItens, cidadesItens, livroItens] = await Promise.all([
          $fetch(`${situacao}`, {
            method: "POST",
            body: {
...
//# sourceMappingURL=index-CZxONvt9.mjs.map
