...
import { _ as _imports_0$1, a as _imports_2, b as _imports_3$1 } from './excluido-BJN1kjTO.mjs';
                    ...
                    _push3(ssrRenderComponent(VRow, null, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          if (item.excluido) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3$1)} alt="deletar" title="Reativar"${_scopeId3}>`);
                          } else {
                          ...
                          return [
                            ...
                            createVNode("div", {
                              onClick: ($event) => _ctx.deleteDocumento(item),
                              title: "deletar"
                            }, [
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    async function onUpdate(id) {
      ...
      const { status: status2 } = await useFetch(`${updateEndereco}/${id}`, {
        method: "PUT",
        body: payloadFormated
      }, "$DfOGkJVB8l");
                    ...
                    _push3(ssrRenderComponent(VRow, null, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          if (item.excluido) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3$1)} alt="Visualizar" title="Reativar"${_scopeId3}>`);
                          } else {
                          ...
                          return [
                            ...
                            createVNode("div", {
                              onClick: ($event) => _ctx.deleteEndereco(item),
                              title: "Visualizar"
                            }, [
                              item.excluido ? (openBlock(), createBlock("img", {
                                key: 0,
...
//# sourceMappingURL=index-fWv3Zyc-.mjs.map
