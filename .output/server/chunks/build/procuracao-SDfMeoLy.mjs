              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, { cols: "5" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VTextField, { label: "Descri\xE7\xE3o" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(VTextField, { label: "Descri\xE7\xE3o" })
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    ...
                    createVNode("div", {
                      onClick: ($event) => _ctx.redirectToUpdate(_ctx.item.id),
                      title: "Criar"
                    }, [
                      createVNode("img", {
                        class: "mt-3 ml-2",
                ...
                if (_push3) {
                  ...
                  if (unref(showTabs)) {
                    _push3(ssrRenderComponent(VTabsWindowItem, { value: "texto" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_ProcuracaoTexto, { style: { "height": "1000px" } }, null, _parent4, _scopeId3));
                        } else {
                          return [
                            createVNode(_component_ProcuracaoTexto, { style: { "height": "1000px" } })
                          ];
                        }
                      }),
                      _: 1
...
//# sourceMappingURL=procuracao-SDfMeoLy.mjs.map
