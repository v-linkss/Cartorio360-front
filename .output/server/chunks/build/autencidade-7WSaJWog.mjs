import { c as _sfc_main$2 } from './RegistroPessoas-B943kicL.mjs';
import { _ as _sfc_main$3 } from './FichaCard-tYrCUti5.mjs';
import { _ as _sfc_main$4 } from './ErrorModalCard-BtbpxKGp.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "text-h6" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Validador de Autenticidade`);
                      } else {
                        return [
                          createTextVNode("Validador de Autenticidade")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(VCardText, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-d309f484${_scopeId3}><p data-v-d309f484${_scopeId3}>Digite os n\xFAmeros abaixo para validar a autenticidade:</p><div class="random-numbers" data-v-d309f484${_scopeId3}><span data-v-d309f484${_scopeId3}>${ssrInterpolate(unref(randomNumbers).join(" "))}</span></div>`);
                        ...
                        if (unref(errorMessage)) {
                          _push4(`<div class="error-message" data-v-d309f484${_scopeId3}>${ssrInterpolate(unref(errorMessage))}</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div>`);
                        ...
                        return [
                          createVNode("div", null, [
                            createVNode("p", null, "Digite os n\xFAmeros abaixo para validar a autenticidade:"),
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d309f484"]]);
const _sfc_main = {
  __name: "autencidade",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=autencidade-7WSaJWog.mjs.map
