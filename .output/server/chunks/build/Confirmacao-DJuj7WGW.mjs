                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCardText, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div${_scopeId3}>${ssrInterpolate(__props.condMessage)} <p class="mt-2"${_scopeId3}>${ssrInterpolate(__props.description ? __props.description : "")}</p>`);
                        if (__props.valor) {
                        ...
                        return [
                          createVNode("div", null, [
                            ...
                            createVNode("p", { class: "mt-2" }, toDisplayString(__props.description ? __props.description : ""), 1),
...
//# sourceMappingURL=Confirmacao-DJuj7WGW.mjs.map
