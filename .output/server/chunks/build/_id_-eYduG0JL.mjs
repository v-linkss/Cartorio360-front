...
import { c as useRoute$1, d as useCookie, b as useRuntimeConfig, f as useNuxtApp, u as useRouter$1, V as VTextField, e as VBtn, as as VDataTable, a2 as VImg, at as VProgressCircular, au as VSheet } from './server.mjs';
import { ref, withAsyncContext, withCtx, unref, isRef, createTextVNode, createVNode, useSSRContext, reactive, openBlock, createBlock, provide, toDisplayString, createCommentVNode } from 'vue';
...
import { _ as _sfc_main$7 } from './RegistroPessoas-l0UPkSpO.mjs';
import { _ as _imports_5, a as _imports_0$1, b as _imports_0$2, c as _sfc_main$2$1, d as _sfc_main$1$1, e as _sfc_main$8 } from './escanear-BRV56wlI.mjs';
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onDocumentChange = async () => {
      ...
      await document.saveAsBlob("Docx");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="mt-4 mb-4 justify-end fixed-buttons" style="${ssrRenderStyle({ "bottom": "0", "left": "0", "width": "100%", "background-color": "#fff", "padding": "16px", "z-index": "1000" })}">`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { class: "ml-4" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    }, "$FnEbAJEARP")), __temp = await __temp, __restore();
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    observacoesItems.value = dadosObservacao.value.map((item) => ({
      ...item,
      created: __unimport_formatDate(item.created, "dd/mm/yyyy")
      // Aplica a formatação na data
    }));
      ...
      if (await v$.value.$validate()) {
        ...
        if (status.value === "success") {
          observacoesItems.value.push({
            created: __unimport_formatDate(data2.value.created, "dd/mm/yyyy"),
...
//# sourceMappingURL=_id_-eYduG0JL.mjs.map
