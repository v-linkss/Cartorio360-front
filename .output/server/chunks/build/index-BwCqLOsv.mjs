...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    }, "$7ux5A7Bg14")), __temp = await __temp, __restore(), __temp);
    ...
    const filteredSituacaoMatricula = computed(() => {
      ...
      return situacaoMatricula.value.filter((item) => {
        var _a2, _b2;
        var _a, _b;
        const situacaomatriculaDescricao = (_a2 = (_a = item.situacao_descricao) == null ? undefined : _a.toLowerCase()) != null ? _a2 : "";
        const situacao = (_b2 = (_b = item.situacao) == null ? undefined : _b.toLowerCase()) != null ? _b2 : "";
        return situacaomatriculaDescricao.includes(searchDoc.value.toLowerCase()) && situacao.includes(search.value.toLowerCase());
      });
    });
    ...
    function redirectToView(id) {
      router.push({ path: `/tipos-matriculas/vizualizar/${id}` });
    }
    function redirectToUpdate(id) {
      router.push({ path: `/tipos-matriculas/atualizar/${id}` });
    }
      ...
      if (unref(status) === "success") {
        _push(ssrRenderComponent(VContainer, mergeProps({ class: "mt-5" }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/tipos-matriculas/cadastro" }, {
              ...
              return [
                createVNode(_component_NuxtLink, { to: "/tipos-matriculas/cadastro" }, {
                  default: withCtx(() => [
                    createVNode("img", {
                      style: { "cursor": "pointer" },
                      src: _imports_0,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/tipos-matriculas/lista/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined;
};

export { _sfc_main as default };
//# sourceMappingURL=index-BwCqLOsv.mjs.map
