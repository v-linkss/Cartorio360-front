...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-5921e7e8><div class="container-form" data-v-5921e7e8>`);
      ...
      _push(`<div class="text" data-v-5921e7e8>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-5921e7e8> Esqueceu a senha?</a></div><div class="background-image" data-v-5921e7e8></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5921e7e8"]]);

export { index as default };
//# sourceMappingURL=index-DPs3z6pR.mjs.map
