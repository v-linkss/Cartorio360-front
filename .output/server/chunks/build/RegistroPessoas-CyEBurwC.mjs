...
import { useSSRContext, inject, computed, createVNode, withDirectives, resolveDirective, vShow, ref, mergeProps, Fragment, shallowRef, watch, provide, toRef, reactive, withAsyncContext, unref, withCtx, createTextVNode, openBlock, createBlock, isRef, nextTick, createCommentVNode, renderList } from 'vue';
...
const useSteps = (props2) => {
  ...
  const max = computed(() => parseFloat(props2.max));
...
const useSlider = (_ref) => {
  ...
  const thumbColor = computed(() => {
    var _a;
    return props2.error || props2.disabled ? void 0 : (_a = props2.thumbColor) != null ? _a : props2.color;
  });
  const trackColor = computed(() => {
    var _a;
    return props2.error || props2.disabled ? void 0 : (_a = props2.trackColor) != null ? _a : props2.color;
  });
  const trackFillColor = computed(() => {
    var _a;
    return props2.error || props2.disabled ? void 0 : (_a = props2.trackFillColor) != null ? _a : props2.color;
  });
  ...
  const parsedTicks = computed(() => {
    ...
    return Object.keys(props2.ticks).map((key) => ({
      value: parseFloat(key),
      position: position(parseFloat(key)),
      label: props2.ticks[key]
    }));
  });
    ...
    useRender(() => {
      ...
      return createVNode("div", {
        ...
        default: () => {
          ...
          })) != null ? _a2 : props2.modelValue.toFixed(step.value ? decimals.value : 1)])])]), [[vShow, thumbLabel.value && props2.focused || thumbLabel.value === "always"]])];
        }
      })]);
    });
    return {};
    ...
    useRender(() => {
      ...
      return createVNode(VInput, mergeProps({
        ...
        prepend: hasPrepend ? (slotProps) => {
          var _a2;
          var _a, _b;
          return createVNode(Fragment, null, [(_a2 = (_a = slots.label) == null ? void 0 : _a.call(slots, slotProps)) != null ? _a2 : props2.label ? createVNode(VLabel, {
    ...
    useRender(() => {
      ...
      return createVNode(VBtn, mergeProps({
        ...
        default: () => {
          var _a2;
          var _a;
          return createVNode(Fragment, null, [(_a2 = (_a = slots.default) == null ? void 0 : _a.call(slots)) != null ? _a2 : props2.text, !props2.hideSlider && createVNode("div", {
            "ref": sliderEl,
...
const VWindowItem = genericComponent()({
  ...
  setup(props2, _ref) {
    ...
    const hasTransition = computed(() => isBooted.value && (window.isReversed.value ? props2.reverseTransition !== false : props2.transition !== false));
    ...
    const transition = computed(() => {
      const name = window.isReversed.value ? props2.reverseTransition : props2.transition;
...
//# sourceMappingURL=RegistroPessoas-CyEBurwC.mjs.map
