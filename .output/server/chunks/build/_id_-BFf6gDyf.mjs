...
import { V as VResponsive } from './VResponsive-dUk8X3PH.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: situacaoMatricula, pending } = ([__temp, __restore] = withAsyncContext(() => fetchWithToken(
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(VSheet, { class: "pa-2 ma-2" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(` Documento: ${ssrInterpolate(unref(situacaoMatricula).descricao)}`);
                              } else {
                                return [
                                  createTextVNode(" Documento: " + toDisplayString(unref(situacaoMatricula).descricao), 1)
                                ];
                              }
                            }),
                            _: 1
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VSheet, { class: "pa-2 ma-2" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(` Nome/Raz\xE3o Social : ${ssrInterpolate(unref(situacaoMatricula).situacao)}`);
                              } else {
                                return [
                                  createTextVNode(" Nome/Raz\xE3o Social : " + toDisplayString(unref(situacaoMatricula).situacao), 1)
                                ];
                              }
                            }),
                            _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/situacaoMatricula/vizualizar/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined;
};
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-187f9985"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-BFf6gDyf.mjs.map
