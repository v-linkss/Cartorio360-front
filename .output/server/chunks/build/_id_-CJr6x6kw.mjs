import { _ as _sfc_main$5, a as _sfc_main$4$1, b as _sfc_main$3$1, c as _sfc_main$2$1, d as _sfc_main$1$1, e as _sfc_main$6 } from './Anexos-mI1gZfyg.mjs';
...
import { _ as _sfc_main$1$2, a as _sfc_main$8 } from './Atualizar-BK2R5JJS.mjs';
...
import './RegistroPessoas-DHXvWehB.mjs';
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    let __temp, __restore;
    const config = useRuntimeConfig();
    const imoveisLista2 = `${config.public.auth}/service/gerencia/atos_imoveis`;
    ...
    const { data: imoveisItems, status } = ([__temp, __restore] = withAsyncContext(() => fetchWithToken(imoveisLista2, {
      method: "POST",
      body: { ato_token: route.query.ato_token_edit }
    ...
    const atualizarListaImoveis = async () => {
      await fetchWithToken(imoveisLista2, {
        method: "POST",
        body: { ato_token: route.query.ato_token_edit }
      });
    };
                  ...
                  _push3(ssrRenderComponent(VTabs, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (unref(usaImoveis)) {
                          _push4(ssrRenderComponent(VTab, { value: "separa\xE7\xE3o_div\xF3rcio" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                        ...
                        return [
                          ...
                          unref(usaImoveis) ? (openBlock(), createBlock(VTab, {
                            key: 2,
                            value: "separa\xE7\xE3o_div\xF3rcio"
                          }, {
                            default: withCtx(() => [
                              createTextVNode("Separa\xE7\xE3o e Div\xF3rcio")
                            ]),
                  ...
                  _push3(ssrRenderComponent(VTabsWindow, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (unref(usaImoveis)) {
                          _push4(ssrRenderComponent(VTabsWindowItem, { value: "separa\xE7\xE3o_div\xF3rcio" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
...
//# sourceMappingURL=_id_-CJr6x6kw.mjs.map
