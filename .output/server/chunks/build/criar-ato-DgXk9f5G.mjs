...
import _sfc_main$1 from './semelhanca-sguf6MGI.mjs';
import _sfc_main$2 from './autencidade-00GoWgBh.mjs';
import autenticacao from './autenticacao-DER_QbUj.mjs';
import _sfc_main$3 from './geral-CrDHQaRy.mjs';
import _sfc_main$4 from './geral-f4ozD4Ji.mjs';
...
import 'vue-the-mask';
import './RegistroPessoas-DkyXsHI-.mjs';
import '@vuelidate/core';
import '@vuelidate/validators';
import './fetchWithToken-Cv5nC8pK.mjs';
import './formatDate-Han2ORzf.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`<h1 data-v-a142e2b6${_scopeId2}>Ordem de Servi\xE7o n\xBA</h1><h1 style="${ssrRenderStyle({ "color": "red", "margin-left": "30px" })}" data-v-a142e2b6${_scopeId2}>${ssrInterpolate(unref(numeroOs) || ((_a2 = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? undefined : _a2.numero) || null)}</h1>`);
                } else {
                  return [
...
const criarAto = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a142e2b6"]]);

export { criarAto as default };
//# sourceMappingURL=criar-ato-DgXk9f5G.mjs.map
