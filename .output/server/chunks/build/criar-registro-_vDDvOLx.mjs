  ...
  async setup(__props) {
    ...
    const redirectToUpdateAto = (item) => {
      if (item.tipo === "PROCURA\xC7\xC3O") {
        router.push({ path: `/fontes/atos/procuracoes/atualizar/${item.id}`, query: { origem: "atualizar", id, ato_id: item.id, ato_token_edit: item.token } });
      }
    };
...
//# sourceMappingURL=criar-registro-_vDDvOLx.mjs.map
