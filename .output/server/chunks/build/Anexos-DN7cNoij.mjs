...
import { u as useRouter$1, g as useRoute$1, b as useNuxtApp, e as useCookie, f as VTextField, V as VBtn, b8 as VProgressCircular, b9 as VSheet, c as useRuntimeConfig } from './server.mjs';
...
<<<<<<<< HEAD:.output/server/chunks/build/Anexos-Zp0h3V0K.mjs
import { _ as _imports_0$3, a as _imports_1$2, b as _sfc_main$6 } from './RegistroPessoas-zPwhxeoq.mjs';
import { _ as _imports_5, T as Toolbar, W as WordExport, D as DocumentEditorContainerComponent, a as _imports_0$1, b as _sfc_main$2$1, c as _sfc_main$1$1, d as _sfc_main$8 } from './Observacao-eVoNjoG5.mjs';
========
import { _ as _sfc_main$6 } from './RegistroPessoas-Dm_bitTh.mjs';
import { _ as _imports_5, T as Toolbar, W as WordExport, D as DocumentEditorContainerComponent, a as _imports_0$1, b as _imports_0$2, c as _imports_1$2, d as _sfc_main$2$1, e as _sfc_main$1$1, f as _sfc_main$8 } from './abre-arquivo-verde-BsCn2YqF.mjs';
>>>>>>>> lavratura-cancela-um-selo:.output/server/chunks/build/Anexos-DN7cNoij.mjs
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    const lavraAto = async (force = false) => {
      if (!force) {
        const { data: data3, error, status: status2 } = await useFetch(validaAto, {
          method: "POST",
          body: { ato_token: props.ato_token }
        }, "$ZKnVBNYxp9");
        let statusResp, statusMsg;
        if (status2.value === "success" && data3.value) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(allEscreventes, {
      method: "POST",
      body: { cartorio_token }
    }, "$JCPnpnnRzP")), __temp = await __temp, __restore(), __temp);
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    async function fetchObservacoes() {
      const { data: data2 } = await useFetch(`${getAtosObservacao}/${props.ato_id}`, {
        method: "GET"
      }, "$dMg99jeUNP");
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(allEscreventes, {
      method: "POST",
      body: { cartorio_token }
    }, "$B6PdRx8Gp4")), __temp = await __temp, __restore(), __temp);
    escreventesItems.value = data.value[0].func_json_escreventes;
    const goBack = () => {
      const origem = route.query.origem || "criar";
      const id = route.query.id;
                          ...
                          "item.actions": withCtx(({ item }, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VRow, null, {
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div${_scopeId5}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar"${_scopeId5}></div><div style="${ssrRenderStyle({ "display": "flex", "cursor": "pointer", "justify-content": "flex-end" })}" title="Deletar Observa\xE7\xE3o"${_scopeId5}>`);
                                    if (item.excluido) {
                                      _push6(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_2)} alt="Visualizar" title="Reativar"${_scopeId5}>`);
                                    } else {
                                      _push6(`<img${ssrRenderAttr("src", _imports_3)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}" title="Excluir"${_scopeId5}>`);
...
<<<<<<<< HEAD:.output/server/chunks/build/Anexos-Zp0h3V0K.mjs
//# sourceMappingURL=Anexos-Zp0h3V0K.mjs.map
========
//# sourceMappingURL=Anexos-DN7cNoij.mjs.map
>>>>>>>> lavratura-cancela-um-selo:.output/server/chunks/build/Anexos-DN7cNoij.mjs
