...
import { useSSRContext, inject, computed, createVNode, withDirectives, resolveDirective, vShow, ref, mergeProps, Fragment, reactive, withAsyncContext, unref, withCtx, createTextVNode, openBlock, createBlock, isRef, toDisplayString, toRef, shallowRef, provide, watch, createCommentVNode, renderList } from 'vue';
...
import { p as propsFactory, x as makeRoundedProps, w as makeElevationProps, m as makeComponentProps, h as genericComponent, af as Ripple, j as useRtl, aj as useElevation, as as useTextColor, k as useRender, N as convertToUnit, b2 as VScaleTransition, am as useRounded, W as useBackgroundColor, b3 as makeFocusProps, b4 as makeVInputProps, B as useProxiedModel, b5 as useFocus, b6 as VInput, aA as VLabel, u as useRouter$1, b as useNuxtApp, e as useCookie, aU as VProgressCircular, V as VTextField, f as VBtn, aS as useRoute$1, aT as VSpacer, b1 as getDecimals, H as createRange, _ as _export_sfc, c as useRuntimeConfig, L as clamp, J as keyValues } from './server.mjs';
import { u as useLazyAsyncData, V as VRow } from './VRow-BVT9G9vF.mjs';
import { $ as $fetchWithToken, f as fetchWithToken } from './fetchWithToken-Cv5nC8pK.mjs';
import { _ as __unimport_formatDate, f as formatToISO } from './formatDate-Han2ORzf.mjs';
import { V as VContainer } from './VContainer-CTpFP9Uv.mjs';
import { V as VCol } from './VCol-BfQDPyTL.mjs';
import { V as VSelect } from './filter-1TH8I8rV.mjs';
  ...
  async setup(__props, { emit: __emit }) {
    ...
    const {
      ...
      const formattedPessoasDocsItems = pessoasDocsItems.map((doc) => {
        ...
        return {
          ...doc,
          data_emissao: doc.data_emissao ? __unimport_formatDate(doc.data_emissao, "dd/mm/yyyy") : null,
          data_vencimento: doc.data_vencimento ? __unimport_formatDate(doc.data_vencimento, "dd/mm/yyyy") : null
        };
      });
      return {
        tipoDocumentoItems,
    ...
    function redirectToUpdate(item) {
      if (item) {
        selectedDoc.value = {
          ...item,
          data_emissao: item.data_emissao ? __unimport_formatDate(item.data_emissao, "dd/mm/yyyy") : null,
          data_vencimento: item.data_vencimento ? __unimport_formatDate(item.data_vencimento, "dd/mm/yyyy") : null
        };
...
export { VSlider as V, _sfc_main as _, _sfc_main$6 as a, _sfc_main$b as b, _sfc_main$a as c, _sfc_main$9 as d, _sfc_main$8 as e, _sfc_main$2 as f, __nuxt_component_6 as g, _sfc_main$c as h };
//# sourceMappingURL=RegistroPessoas-BJJdUf3u.mjs.map
