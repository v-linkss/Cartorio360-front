...
import { _ as _imports_5, T as Toolbar, W as WordExport, S as Search, D as DocumentEditorContainerComponent, a as _imports_0$1, b as _sfc_main$2$1, c as _sfc_main$1$1, d as _sfc_main$8 } from './Observacao-BEBuWwOM.mjs';
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode(_component_ModalRepresentante, {
                ...
                onClose: ($event) => isModalRepresentanteOpen.value = false,
                onUpdateRepresentante: atualizarRepresentante
              }, null, 8, ["representante_nome", "representantes", "ato_pessoa_token", "ato_id", "show", "onClose"]),
            ...
            _push2(ssrRenderComponent(VRow, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!unref(isVisualizar)) {
                    _push3(`<div title="Escanear"${_scopeId2}><img class="mt-3" style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_5$1)} alt="Escanear"${_scopeId2}></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (!unref(isVisualizar)) {
...
//# sourceMappingURL=Anexos-CMC10efi.mjs.map
