...
import { useSSRContext, ref, reactive, withAsyncContext, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, isRef, createTextVNode, mergeProps } from 'vue';
import { ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
...
import { u as useRouter$1, aL as useRoute$1, b as useNuxtApp, e as useCookie, aM as VSpacer, F as VBtn, aN as VProgressCircular, V as VTextField, c as useRuntimeConfig } from './server.mjs';
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    const updateAtosBens2 = `${config.public.managemant}/atos_bens`;
    ...
    const updateAtosBensModal = async (id) => {
      const { status } = await useFetch(`${updateAtosBens2}/${id}`, {
        method: "PUT",
        body: {
    ...
    async function deletePessoa(item) {
      ...
      try {
        await useFetch(`${updateAtosBens2}/${item.id}`, {
          method: "PUT",
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(VCol, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VAutocomplete, {
                            label: "Selecione a Situa\xE7\xE3o",
...
//# sourceMappingURL=Imoveis-BtesMYk1.mjs.map
