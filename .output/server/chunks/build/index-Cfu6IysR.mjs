...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-578b0a84><div class="container-form" data-v-578b0a84>`);
      ...
      _push(`<div class="text" data-v-578b0a84>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-578b0a84> Esqueceu a senha?</a></div><div class="background-image" data-v-578b0a84></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-578b0a84"]]);

export { index as default };
//# sourceMappingURL=index-Cfu6IysR.mjs.map
