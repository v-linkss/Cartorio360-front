...
import { c as _sfc_main$c, d as _sfc_main$b, e as _sfc_main$a, f as _sfc_main$9, g as _sfc_main$2, h as __nuxt_component_6 } from './RegistroPessoas-bLULNXQh.mjs';
      ...
      _push(ssrRenderComponent(VCard, mergeProps({ width: "1300" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h1 style="${ssrRenderStyle({ "color": "#525050", "padding": "10px 0px 0px 30px" })}" data-v-38ed91dd${_scopeId3}>${ssrInterpolate(unref(id) ? "Atualiza\xE7\xE3o de Pessoas" : "Cadastramento de Pessoas")}</h1>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(VCol, { class: "d-flex justify-end" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<h3 style="${ssrRenderStyle({ "color": "#525050", "padding": "20px 10px 10px 10px" })}" data-v-38ed91dd${_scopeId3}> Cadastrado em ${ssrInterpolate(unref(criacaoData))}</h3>`);
                      } else {
                        return [
            ...
            _push2(`<div style="${ssrRenderStyle({ "background-color": "#f5f2f2", "padding": "20px 0px 20px 20px" })}" data-v-38ed91dd${_scopeId}>`);
            ...
            _push2(`</div>`);
            if (unref(loading)) {
              _push2(`<div class="d-flex justify-center" data-v-38ed91dd${_scopeId}>`);
              ...
              _push2(`<div data-v-38ed91dd${_scopeId}>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-38ed91dd"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-kL46kCWe.mjs.map
