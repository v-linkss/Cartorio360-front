...
import { _ as _export_sfc, u as useRouter$1, f as useNuxtApp, X as VImg, V as VTextField, e as VBtn, aK as VSpacer, b as useRuntimeConfig, d as useCookie } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-8129e019><div class="container-form" data-v-8129e019>`);
      ...
      _push(`<div class="text" data-v-8129e019>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-8129e019> Esqueceu a senha?</a></div><div class="background-image" data-v-8129e019></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8129e019"]]);

export { index as default };
//# sourceMappingURL=index-MBcd2g4V.mjs.map
