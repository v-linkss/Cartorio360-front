...
import { ref, withCtx, unref, isRef, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext, reactive, withAsyncContext, toDisplayString, provide, watch, mergeProps } from 'vue';
...
import { _ as _sfc_main$a } from './RegistroPessoas-BUvuy0j1.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(props.ato_token)} `);
            _push2(ssrRenderComponent(VRow, { class: "mt-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, { cols: "3" }, {
            ...
            return [
              createTextVNode(toDisplayString(props.ato_token) + " ", 1),
              createVNode(VRow, { class: "mt-5" }, {
                default: withCtx(() => [
                  createVNode(VCol, { cols: "3" }, {
                    default: withCtx(() => [
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<!--[-->${ssrInterpolate(props.ato_token)} `);
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    const router = useRouter$1();
    const route = useRoute$1();
    const condMessage = ref("Ao lavrar esse ato, a opera\xE7\xE3o n\xE3o poder\xE1 ser desfeita. Confirma ?");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="d-flex align-center justify-center"><div>`);
      ...
      _push(`</div><img class="ml-15" style="${ssrRenderStyle({ "height": "40px", "width": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_0$1)}></div>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    async function openScanner() {
      console.log({ tipo: "ato_minuta", token, cartorio_token: useCookie("user-data").value.cartorio_token });
      try {
    ...
    async function enviarArquivo() {
      try {
        const { data, status } = await useFetch(viewDoc, {
          method: "POST",
          body: { tipo: "ato_minuta", token, cartorio_token: useCookie("user-data").value.cartorio_token }
        }, "$03Wxiia3aI");
                ...
                if (_push3) {
                  ...
                  if (unref(showTabs)) {
                    _push3(ssrRenderComponent(VTabsWindowItem, { value: "minuta" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_ProcuracaoMinuta, { ato_token: unref(ato_token_prop) }, null, _parent4, _scopeId3));
                        } else {
                          return [
                            createVNode(_component_ProcuracaoMinuta, { ato_token: unref(ato_token_prop) }, null, 8, ["ato_token"])
                          ];
                        }
                      }),
                      _: 1
                  ...
                  if (unref(showTabs)) {
                    _push3(ssrRenderComponent(VTabsWindowItem, { value: "livro" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_ProcuracaoLivro, null, null, _parent4, _scopeId3));
                        } else {
                          return [
...
//# sourceMappingURL=procuracao-DubwLcaf.mjs.map
