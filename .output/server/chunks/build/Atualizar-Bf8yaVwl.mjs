  ...
  async setup(__props, { emit: __emit }) {
    ...
    const createImovel = async () => {
      ...
      if (status.value === "success") {
        ...
        emit("saved", { id: data2.value.id, token: data2.value.token });
      }
    };
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ModalImoveisElementosDados = _sfc_main$4;
...
//# sourceMappingURL=Atualizar-Bf8yaVwl.mjs.map
