import { _ as _sfc_main$1 } from './RegistroPessoas-C7csFBo6.mjs';
import { _ as _sfc_main$2 } from './FichaCard-X1AOFdOA.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    async function reconhecerEtiquetaSemelhanca(token) {
      try {
        const { data: data2, error, status } = await fetchWithToken(etiquetaSemelhanca, {
          method: "POST",
          body: {
            ato_token: token,
            cartorio_token: cartorio_token.value,
...
//# sourceMappingURL=semelhanca-DZKlN5T0.mjs.map
