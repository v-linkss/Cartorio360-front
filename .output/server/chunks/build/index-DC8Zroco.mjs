...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-d2328c63><div class="container-form" data-v-d2328c63>`);
      ...
      _push(`<div class="text" data-v-d2328c63>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-d2328c63> Esqueceu a senha?</a></div><div class="background-image" data-v-d2328c63></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d2328c63"]]);

export { index as default };
//# sourceMappingURL=index-DC8Zroco.mjs.map
