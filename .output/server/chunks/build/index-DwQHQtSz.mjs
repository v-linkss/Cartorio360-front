...
import { _ as _export_sfc, u as useRouter$1, d as useNuxtApp, V as VImg, ak as VTextField, f as VBtn, e as VSpacer, b as useRuntimeConfig, c as useCookie } from './server.mjs';
import { u as useFetch } from './fetch-CXRKblKa.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-26f5bcd8><div class="container-form" data-v-26f5bcd8>`);
      ...
      _push(`<div class="text" data-v-26f5bcd8>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-26f5bcd8> Esqueceu a senha?</a></div><div class="background-image" data-v-26f5bcd8></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-26f5bcd8"]]);

export { index as default };
//# sourceMappingURL=index-DwQHQtSz.mjs.map
