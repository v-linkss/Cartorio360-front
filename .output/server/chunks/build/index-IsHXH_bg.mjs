...
import { _ as _export_sfc, u as useRouter$1, b as useNuxtApp, V as VTextField, g as VBtn, c as useRuntimeConfig } from './server.mjs';
  ...
  setup(__props) {
    ...
    const alterarSenha = async () => {
      ...
      try {
        ...
        $toast.error(((_b = (_a = error == null ? undefined : error.data) == null ? undefined : _a.menssage) == null ? undefined : _b.details) || ((_c = error == null ? undefined : error.data) == null ? undefined : _c.status_mensagem));
      }
    };
                  ...
                  _push3(ssrRenderComponent(VContainer, { style: { "max-width": "650px" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div data-v-1af1ede1${_scopeId3}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1af1ede1"]]);

export { index as default };
//# sourceMappingURL=index-IsHXH_bg.mjs.map
