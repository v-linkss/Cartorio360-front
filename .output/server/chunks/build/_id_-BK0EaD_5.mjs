...
import { _ as _export_sfc, as as useRoute$1, aW as VSheet, aX as VResponsive, b as useRuntimeConfig } from './server.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-9c9bba6e${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                class: "btn-pointer",
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9c9bba6e"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-BK0EaD_5.mjs.map
