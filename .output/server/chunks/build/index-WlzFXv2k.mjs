...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    function redirectToView(id) {
      console.log("id:", id), router.push({ path: `/matriculas/vizualizar/${id}` });
    }
            ...
            _push2(ssrRenderComponent(VRow, { style: { "gap": "3rem" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VTextField, {
                    class: "mt-7 mb-4",
                    modelValue: unref(searchCnm),
                    "onUpdate:modelValue": ($event) => isRef(searchCnm) ? searchCnm.value = $event : null,
                    label: "CNM",
                    "prepend-inner-icon": "mdi-magnify",
                    variant: "outlined",
                    "hide-details": ""
...
//# sourceMappingURL=index-WlzFXv2k.mjs.map
