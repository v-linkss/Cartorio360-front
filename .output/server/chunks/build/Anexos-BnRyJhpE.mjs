...
import { _ as _imports_5, T as Toolbar, W as WordExport, S as Search, D as DocumentEditorContainerComponent, a as _imports_0$1, b as _sfc_main$1$1, c as _sfc_main$7 } from './lavrar-CC2INa1Z.mjs';
  ...
  async setup(__props) {
    ...
    const lavraAto = async (force = false) => {
      ...
      try {
        ...
        const { data: data2, status, error } = await useFetch(lavraAtoLivro, {
          method: "POST",
          body: {
...
//# sourceMappingURL=Anexos-BnRyJhpE.mjs.map
