...
import { u as useRouter$1, f as useNuxtApp, d as useCookie, aJ as VProgressCircular, V as VTextField, e as VBtn, _ as _export_sfc, b as useRuntimeConfig } from './server.mjs';
  ...
  async setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`<div data-v-4d4acc0a>${ssrInterpolate(unref(error).message)}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(pending)) {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4d4acc0a"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-Ca38cq2A.mjs.map
