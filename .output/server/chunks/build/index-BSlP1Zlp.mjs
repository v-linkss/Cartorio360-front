...
import { _ as _export_sfc, u as useRouter$1, aY as VDataTable, b as useRuntimeConfig } from './server.mjs';
import { a as useLazyFetch, u as useFetch } from './fetch-CXRKblKa.mjs';
...
import { V as VRow, _ as _imports_0$1 } from './sair-B-uLsLLb.mjs';
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-dbc94059${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "btn-pointer",
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(VRow, null, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="btn-pointer" title="Visualizar" data-v-dbc94059${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar" data-v-dbc94059${_scopeId3}></div><div class="btn-pointer" title="Visualizar" data-v-dbc94059${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}"${ssrRenderAttr("src", _imports_2)} alt="Visualizar" data-v-dbc94059${_scopeId3}></div><div class="btn-pointer" title="Visualizar" data-v-dbc94059${_scopeId3}>`);
                          if (item.excluido) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}"${ssrRenderAttr("src", _imports_3)} alt="Visualizar" title="Reativar" data-v-dbc94059${_scopeId3}>`);
                          } else {
                            _push4(`<img${ssrRenderAttr("src", _imports_4)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}" title="Excluir" data-v-dbc94059${_scopeId3}>`);
                          }
                          _push4(`</div>`);
                        } else {
                          return [
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas/registro" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", _imports_0$1)} alt="Sair" data-v-dbc94059${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: _imports_0$1,
              ...
              return [
                ...
                createVNode(_component_NuxtLink, { to: "/pessoas/registro" }, {
                  default: withCtx(() => [
                    createVNode("img", {
                      src: _imports_0$1,
                      alt: "Sair"
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dbc94059"]]);

export { index as default };
//# sourceMappingURL=index-BSlP1Zlp.mjs.map
