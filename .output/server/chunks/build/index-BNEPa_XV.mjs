                  ...
                  _push3(ssrRenderComponent(VContainer, { style: { "max-width": "650px" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="text" data-v-eb35ce6a${_scopeId3}>Login</div>`);
                        ...
                        _push4(`<div data-v-eb35ce6a${_scopeId3}><a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "white", "margin-left": "10px", "cursor": "pointer" })}" data-v-eb35ce6a${_scopeId3}> Esqueceu a senha? </a></div>`);
                      } else {
                        return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eb35ce6a"]]);

export { index as default };
<<<<<<<< HEAD:.output/server/chunks/build/index-BHqRWloz.mjs
//# sourceMappingURL=index-BHqRWloz.mjs.map
========
//# sourceMappingURL=index-BNEPa_XV.mjs.map
>>>>>>>> lavratura-cancela-um-selo:.output/server/chunks/build/index-BNEPa_XV.mjs
