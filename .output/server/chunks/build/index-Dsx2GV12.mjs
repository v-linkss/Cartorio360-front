...
import { _ as _sfc_main$2 } from './Ordem-Bi-SbRCz.mjs';
  ...
  setup(__props) {
    ...
    async function emitirRecibo(token) {
      ...
      if (data.value) {
        ...
        $toast.error(((_b = (_a = error == null ? undefined : error.value) == null ? undefined : _a.data) == null ? undefined : _b.details) || "Erro ao emitir recibo");
      }
    }
                      ...
                      if (_push4) {
                        ...
                        return [
                          ...
                          createVNode("div", {
                            ...
                            onClick: ($event) => item.btn_recibo ? emitirRecibo(item.token) : null,
...
//# sourceMappingURL=index-Dsx2GV12.mjs.map
