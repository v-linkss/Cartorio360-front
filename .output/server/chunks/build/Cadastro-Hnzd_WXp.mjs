...
import { V as VTabs, a as VTab, b as VTabsWindow, c as VTabsWindowItem, _ as _sfc_main$3, d as _sfc_main$6 } from './RegistroPessoas-BwFZvz5e.mjs';
...
const _sfc_main$2 = {
  ...
  async setup(__props, { emit: __emit }) {
    ...
    const rules = {
      descricao: { required: helpers.withMessage("O campo \xE9 obrigat\xF3rio", required, minLength(3)) }
    };
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCol, { cols: "1" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VTextField, { label: "%" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(VTextField, { label: "%" })
                        ];
                      }
                    }),
                    _: 1
                  }, _parent3, _scopeId2));
                  _push3(`<div${_scopeId2}><img class="mt-1"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "width": "40px", "cursor": "pointer" })}" title="Criar Imovel"${_scopeId2}></div>`);
                } else {
                  return [
                    createVNode(VCol, { cols: "4" }, {
                      default: withCtx(() => [
...
//# sourceMappingURL=Cadastro-Hnzd_WXp.mjs.map
