...
import { p as propsFactory, W as makeComponentProps, Y as makeTagProps, t as genericComponent, C as useRender, a1 as makeBorderProps, a3 as makeElevationProps, a7 as makeRoundedProps, a9 as makeThemeProps, aG as useBackgroundColor, ad as useBorder, ah as useElevation, al as useRounded, ac as provideTheme, aq as useRtl, X as provideDefaults, an as VImg, N as VDefaultsProvider, aB as convertToUnit, b3 as VExpandTransition, b4 as makeLayoutItemProps, w as useProxiedModel, b5 as useToggleScope, ay as useSsrBoot, b6 as useLayoutItem, a2 as makeDimensionProps, ag as useDimension, b7 as useLayout, _ as _export_sfc, aV as clamp, u as useRouter$1, b8 as VApp, d as useCookie, aK as VSpacer, E as VMenu, e as VBtn, F as VList, G as VListItem, b9 as VListItemTitle } from './server.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h5 style="${ssrRenderStyle({ "color": "#429946", "margin-left": "30px" })}" data-v-6c9c17b2${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h5>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6c9c17b2"]]);

export { _default as default };
//# sourceMappingURL=default-B8Zf_5nZ.mjs.map
