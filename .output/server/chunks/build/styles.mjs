...
const styles = {
  ...
  "pages/login/index.vue": () => import('./index-styles.BMmx-diM.mjs').then(interopDefault),
  "pages/os/criar-ato.vue": () => import('./criar-ato-styles.QFMVBHsa.mjs').then(interopDefault),
  "pages/pessoas/atualizar/[id].vue": () => import('./_id_-styles.C9ARIA_x.mjs').then(interopDefault),
