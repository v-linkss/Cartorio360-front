import { e as VSlider, d as _sfc_main$6 } from './RegistroPessoas-Dm7FyVXr.mjs';
            ...
            _push2(ssrRenderComponent(VCard, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div style="${ssrRenderStyle({ "overflow": "hidden" })}" class="d-flex justify-center align-center" data-v-0a099a84${_scopeId2}>`);
                  if (unref(hasTiff)) {
                    _push3(`<div class="ml-5" data-v-0a099a84${_scopeId2}>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0a099a84"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=FichaCard-CDgRuNUD.mjs.map
