...
import { provide, ref, unref, withCtx, createTextVNode, createVNode, useSSRContext, withAsyncContext, toDisplayString, openBlock, createBlock, createCommentVNode, reactive, watch, mergeProps, isRef } from 'vue';
import { f as useNuxtApp, u as useRouter$1, c as useRoute$1, at as VProgressCircular, e as VBtn, au as VSheet, b as useRuntimeConfig, d as useCookie } from './server.mjs';
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onDocumentChange = async () => {
      ...
      reader.onload = () => {
        console.log("reader.result/ onDocumentChange");
...
//# sourceMappingURL=escanear-c1K9A_eb.mjs.map
