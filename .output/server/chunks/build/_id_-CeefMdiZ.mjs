...
<<<<<<<< HEAD:.output/server/chunks/build/_id_-zqMOClWw.mjs
...
========
import { V as VTabs, a as VTab, b as VTabsWindow, c as VTabsWindowItem, _ as _sfc_main$7, d as _sfc_main$6, e as __nuxt_component_3, f as __nuxt_component_4 } from './Restricoes-BOzMEx3Q.mjs';
import { ref, reactive, withAsyncContext, resolveDirective, mergeProps, withCtx, unref, isRef, createTextVNode, createVNode, withDirectives, openBlock, createBlock, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
import { _ as _export_sfc, u as useRouter$1, f as useNuxtApp, c as useRoute$1, d as useCookie, at as VProgressCircular, V as VTextField, b as useRuntimeConfig } from './server.mjs';
import { a as useLazyAsyncData, u as useFetch } from './fetch-Dsyde8UD.mjs';
>>>>>>>> e9e7417a53a08065e629915a74b83cd96045aa16:.output/server/chunks/build/_id_-CeefMdiZ.mjs
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VCard, mergeProps({ width: "1300" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
<<<<<<<< HEAD:.output/server/chunks/build/_id_-zqMOClWw.mjs
            _push2(`<h1 style="${ssrRenderStyle({ "background-color": "#c8fcca", "color": "#429946", "padding": "10px 0px 0px 20px" })}" data-v-4f2a7a86${_scopeId}>${ssrInterpolate(unref(id) ? "Atualiza\xE7\xE3o de Pessoas" : "Cadastramento de Pessoas")}</h1><div style="${ssrRenderStyle({ "background-color": "#c8fcca", "padding": "20px 0px 20px 20px" })}" data-v-4f2a7a86${_scopeId}>`);
========
            _push2(`<h1 style="${ssrRenderStyle({ "background-color": "#c8fcca", "color": "#429946", "padding": "10px 0px 0px 20px" })}" data-v-d0dac443${_scopeId}>${ssrInterpolate(unref(id) ? "Atualiza\xE7\xE3o de Pessoas" : "Cadastramento de Pessoas")}</h1><div style="${ssrRenderStyle({ "background-color": "#c8fcca", "padding": "20px 0px 20px 20px" })}" data-v-d0dac443${_scopeId}>`);
>>>>>>>> e9e7417a53a08065e629915a74b83cd96045aa16:.output/server/chunks/build/_id_-CeefMdiZ.mjs
...
========
                        if (unref(pending)) {
                          ...
                          _push4(`<div data-v-d0dac443${_scopeId3}>${ssrInterpolate(unref(error).message)}</div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (!unref(pending)) {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas/registros" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-d0dac443${_scopeId6}>`);
                                          } else {
                                            return [
                                              createVNode("img", {
                                                class: "btn-pointer",
                                      ...
                                      _push6(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_1)} data-v-d0dac443${_scopeId5}>`);
                                    } else {
                                      return [
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas/registros" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-4f2a7a86${_scopeId6}>`);
                                        } else {
                                          return [
                                            createVNode("img", {
                                              class: "btn-pointer",
                                    ...
                                    _push6(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_1)} data-v-4f2a7a86${_scopeId5}>`);
                                  } else {
                                    return [
                                      createVNode(_component_NuxtLink, { to: "/pessoas/registros" }, {
                                        default: withCtx(() => [
...
<<<<<<<< HEAD:.output/server/chunks/build/_id_-zqMOClWw.mjs
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4f2a7a86"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-zqMOClWw.mjs.map
========
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d0dac443"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-CeefMdiZ.mjs.map
>>>>>>>> e9e7417a53a08065e629915a74b83cd96045aa16:.output/server/chunks/build/_id_-CeefMdiZ.mjs
