    ...
    async function reconhecerAtoAutencidade() {
      ...
      try {
        ...
        if (status.value === "success" && data2.value[0].status === "OK") {
          ...
          errorMessage.value = Array.isArray(data2.value) && ((_a2 = data2.value[0]) == null ? void 0 : _a2.status_mensagem) || ((_c = (_b = error == null ? void 0 : error.value) == null ? void 0 : _b.data) == null ? void 0 : _c.details) || "N\xE3o foi poss\xEDvel concluir o reconhecimento";
        }
      } catch (error) {
        errorModalVisible.value = true;
...
//# sourceMappingURL=autencidade-4UDCVDRE.mjs.map
