...
import { ref, withCtx, unref, isRef, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext, reactive, withAsyncContext, resolveComponent, watch, mergeProps, toDisplayString } from 'vue';
...
import { RichTextEditorComponent, Toolbar, Image, Link, HtmlEditor, QuickToolbar, Table, PasteCleanup, ImportExport } from '@syncfusion/ej2-vue-richtexteditor';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_ejs_richtexteditor = resolveComponent("ejs-richtexteditor");
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="control-section"><div class="sample-container"><div class="default-section">`);
  _push(ssrRenderComponent(_component_ejs_richtexteditor, {
    value: _ctx.value,
...
//# sourceMappingURL=procuracao-CIi7S9FC.mjs.map
