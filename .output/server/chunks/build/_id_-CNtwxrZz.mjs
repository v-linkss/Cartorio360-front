...
import { g as useRoute$1, f as VTextField, V as VBtn, c as useRuntimeConfig, a as navigateTo } from './server.mjs';
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCol, { cols: "3" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<label${_scopeId4}>Valor</label>`);
...
//# sourceMappingURL=_id_-CNtwxrZz.mjs.map
