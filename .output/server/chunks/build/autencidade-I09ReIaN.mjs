import { c as _sfc_main$2 } from './RegistroPessoas-CyJDGoUP.mjs';
import { _ as _sfc_main$3 } from './FichaCard-B3_k0ZI7.mjs';
import { _ as _sfc_main$4 } from './ErrorModalCard-BIMdv72c.mjs';
...
import { u as useRouter$1, f as useRoute$1, b as useNuxtApp, e as useCookie, V as VTextField, g as VBtn, c as useRuntimeConfig, _ as _export_sfc } from './server.mjs';
import { V as VDialog } from './VDialog-BVe31KMa.mjs';
import { V as VCard, b as VCardText, c as VCardActions } from './VCard-CUYv16rw.mjs';
  ...
  async setup(__props, { emit: __emit }) {
    ...
    async function reconhecerAtoAutencidade() {
      ...
      try {
        ...
        if (status.value === "success" && Array.isArray(data2.value) && ((_a2 = data2.value[0]) == null ? void 0 : _a2.status) === "OK") {
          reconhecerEtiquetaAutencidade(data2.value[0].token);
          goBack();
        } else {
          errorModalVisible.value = true;
          errorMessage.value = Array.isArray(data2.value) && ((_b = data2.value[0]) == null ? void 0 : _b.status_mensagem) || ((_d = (_c = error == null ? void 0 : error.value) == null ? void 0 : _c.data) == null ? void 0 : _d.details) || "N\xE3o foi poss\xEDvel concluir o reconhecimento";
        }
      } catch (error) {
        errorModalVisible.value = true;
...
//# sourceMappingURL=autencidade-I09ReIaN.mjs.map
