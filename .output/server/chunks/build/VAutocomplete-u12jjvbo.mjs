...
import { b as makeFilterProps, c as makeSelectProps, u as useFilter, d as useScrolling, e as VVirtualScroll, f as VCheckboxBtn, g as VChip } from './filter-ClbLKnC8.mjs';
import { p as propsFactory, ap as omit, aq as makeVTextFieldProps, ar as makeTransitionProps$1, h as genericComponent, A as useLocale, z as useProxiedModel, as as useTextColor, O as wrapInArray, at as useForm, k as useRender, V as VTextField, au as VMenu, W as VIcon, av as ensureValidVNode, a5 as VDefaultsProvider, aw as noop, an as forwardRefs, ax as matchesSelector } from './server.mjs';
import { a as useItems, V as VList, b as VListItem } from './VList-BV9T5xsx.mjs';
...
const VAutocomplete = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const color = computed(() => {
      var _a;
      return (_a = vTextFieldRef.value) == null ? undefined : _a.color;
    });
    ...
    const highlightFirst = computed(() => {
      var _a;
      const selectFirst = props.autoSelectFirst === true || props.autoSelectFirst === "exact" && search.value === ((_a = displayItems.value[0]) == null ? undefined : _a.title);
    ...
    function onKeydown(e) {
      var _a, _b, _c;
      if (props.readonly || (form == null ? undefined : form.isReadonly.value)) return;
      ...
      if (e.key === "ArrowDown" && highlightFirst.value) {
        (_a = listRef.value) == null ? undefined : _a.focus("next");
      }
    ...
    watch(isFocused, (val, oldVal) => {
      ...
      if (val) {
        ...
        search.value = props.multiple || hasSelectionSlot.value ? "" : String((_a2 = (_a = model.value.at(-1)) == null ? undefined : _a.props.title) != null ? _a2 : "");
        isPristine.value = true;
                  ...
                  default: (_ref4) => {
                    ...
                    return (_a4 = (_a22 = slots.item) == null ? undefined : _a22.call(slots, {
                      ...
                      title: () => {
                        var _a5;
                        var _a32, _b2;
                        return isPristine.value ? item.title : highlightResult(item.title, (_a32 = getMatches(item)) == null ? undefined : _a32.title, (_a5 = (_b2 = search.value) == null ? undefined : _b2.length) != null ? _a5 : 0);
                      }
                    });
                  }
...
//# sourceMappingURL=VAutocomplete-u12jjvbo.mjs.map
