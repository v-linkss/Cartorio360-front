...
import { ref, computed, watch, withCtx, unref, createVNode, toDisplayString, isRef, createTextVNode, resolveDynamicComponent, openBlock, createBlock, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrRenderVNode } from 'vue/server-renderer';
import _sfc_main$1 from './semelhanca-DZmWn_PJ.mjs';
import _sfc_main$2 from './autencidade-BsGECSjE.mjs';
import autenticacao from './autenticacao-DKkzIUDt.mjs';
import _sfc_main$3 from './geral-C1v9dP38.mjs';
import _sfc_main$4 from './geral-Y0-fEAdO.mjs';
import _sfc_main$5 from './geral-eZtlS_wy.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`<h1 data-v-a700dc81${_scopeId2}>Ordem de Servi\xE7o n\xBA</h1><h1 style="${ssrRenderStyle({ "color": "red", "margin-left": "30px" })}" data-v-a700dc81${_scopeId2}>${ssrInterpolate(unref(numeroOs) || ((_a2 = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? undefined : _a2.numero) || null)}</h1>`);
                } else {
                  return [
                  ...
                  _push3(ssrRenderComponent(VCol, { md: "6" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(` ${ssrInterpolate(unref(selectedAto))}`);
                      } else {
                        return [
                          createVNode(VAutocomplete, {
                            label: "Selecione o tipo de ato",
                          ...
                          createTextVNode(" " + toDisplayString(unref(selectedAto)), 1)
                        ];
                      }
                    }),
                    _: 1
...
const criarAto = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a700dc81"]]);

export { criarAto as default };
//# sourceMappingURL=criar-ato-idKlQT_m.mjs.map
