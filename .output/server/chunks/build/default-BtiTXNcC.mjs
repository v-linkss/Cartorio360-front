...
import { p as propsFactory, m as makeComponentProps, g as makeTagProps, h as genericComponent, k as useRender, a5 as makeBorderProps, a6 as makeElevationProps, a7 as makeRoundedProps, x as makeThemeProps, J as useBackgroundColor, aA as useBorder, aC as useElevation, aD as useRounded, y as provideTheme, j as useRtl, L as provideDefaults, $ as VDefaultsProvider, G as convertToUnit, aO as VExpandTransition, be as makeLayoutItemProps, B as useProxiedModel, aL as useToggleScope, bf as useLayoutItem, aJ as makeDimensionProps, aK as useDimension, bg as useLayout, _ as _export_sfc, af as clamp, u as useRouter$1, e as useCookie, bh as VApp, a_ as VSpacer, X as VMenu, f as VBtn } from './server.mjs';
...
import { V as VImg } from './VAvatar-D7LEgnBn.mjs';
import { u as useSsrBoot, V as VList, b as VListItem, d as VListItemTitle } from './VList-Bep3Frr6.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div data-v-1ce2237c${_scopeId2}><img class="ml-5 mt-2"${ssrRenderAttr("width", 300)}${ssrRenderAttr("height", 50)}${ssrRenderAttr("src", _imports_0)} data-v-1ce2237c${_scopeId2}><h3 style="${ssrRenderStyle({ "color": "white", "margin-left": "30px" })}" data-v-1ce2237c${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h3></div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1ce2237c"]]);

export { _default as default };
//# sourceMappingURL=default-BtiTXNcC.mjs.map
