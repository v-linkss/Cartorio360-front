...
import { _ as _export_sfc, u as useRouter$1, f as useNuxtApp, V as VTextField, e as VBtn, aL as VSpacer, b as useRuntimeConfig, d as useCookie } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-4f175972><div class="container-form" data-v-4f175972>`);
      ...
      _push(`<div class="text" data-v-4f175972>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-4f175972> Esqueceu a senha?</a></div><div class="background-image" data-v-4f175972></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4f175972"]]);

export { index as default };
//# sourceMappingURL=index-DU18AsAx.mjs.map
