...
${item.ato_servico}` : `${item.ato_servico}`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 data-v-dbb70160${_scopeId2}>Atos</h1>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCol, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-dbb70160${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Pesquisar" data-v-dbb70160${_scopeId3}></div>`);
                      } else {
                        return [
      ...
      _push(`<div style="${ssrRenderStyle({ "width": "1300px", "margin": "0 auto" })}" data-v-dbb70160><hr class="mt-5 mb-5" data-v-dbb70160>`);
      _push(ssrRenderComponent(VDataTable, {
        ...
        "item.actions": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "justify-content": "center" })}" data-v-dbb70160${_scopeId}><div title="Visualizar" data-v-dbb70160${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar" data-v-dbb70160${_scopeId}></div><div title="Reimprimir" data-v-dbb70160${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3)} alt="Reimprimir" data-v-dbb70160${_scopeId}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Desabilitado")} data-v-dbb70160${_scopeId}><img style="${ssrRenderStyle({
              cursor: item.btn_editar ? "pointer" : "default",
              width: "30px",
              height: "30px"
            })}"${ssrRenderAttr("src", _imports_1$1)} alt="Editar" data-v-dbb70160${_scopeId}></div><div title="Excluir" style="${ssrRenderStyle({ cursor: item.btn_cancelar ? "pointer" : "not-allowed" })}" data-v-dbb70160${_scopeId}><img style="${ssrRenderStyle({
              width: "30px",
              height: "30px",
              cursor: item.btn_cancelar ? "pointer" : "not-allowed",
              opacity: item.btn_cancelar ? "1" : "0.5"
            })}"${ssrRenderAttr("src", _imports_5)} alt="Cancelar"${ssrRenderAttr("title", item.btn_cancelar ? "Cancelar" : "N\xE3o permitido")} data-v-dbb70160${_scopeId}></div><div data-v-dbb70160${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_5$1)} alt="escanear" title="escanear" data-v-dbb70160${_scopeId}></div></div>`);
          } else {
            return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dbb70160"]]);

export { index as default };
//# sourceMappingURL=index-BK9j0vLh.mjs.map
