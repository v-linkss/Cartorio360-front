...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "chat-history" }, _attrs))} data-v-b4c672b6><!--[-->`);
      ssrRenderList(__props.messages, (msg, i) => {
        var _a;
        _push(`<div class="${ssrRenderClass(["chat-bubble", msg.from === "user" ? "from-user" : "from-server"])}" data-v-b4c672b6>${(_a = formatText(msg.text)) != null ? _a : ""}</div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const ChatHistory = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b4c672b6"]]);
const _sfc_main$2 = {
  __name: "ChatInput",
  __ssrInlineRender: true,
  emits: ["send"],
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "chat-window" }, _attrs))} data-v-49f40d4c><header class="chat-header" data-v-49f40d4c><h3 class="chat-title" data-v-49f40d4c>${ssrInterpolate(__props.chat.name.split("_").slice(1).join("_"))}</h3><div data-v-49f40d4c><button class="chat-button end" data-v-49f40d4c>Encerrar</button><button class="chat-close" data-v-49f40d4c>\u2716</button></div></header>`);
...
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-49f40d4c"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-D5KYT5BU.mjs.map
