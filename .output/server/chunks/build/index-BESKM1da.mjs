        ...
        "item.actions": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (item.excluido) {
              ...
              _push2(`<img${ssrRenderAttr("src", _imports_3$1)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}" title="Excluir" data-v-c03855f7${_scopeId}>`);
            }
            _push2(`</div></div>`);
          } else {
            return [
...
//# sourceMappingURL=index-BESKM1da.mjs.map
