...
import { _ as _imports_2$1, a as _sfc_main$1 } from './Selos-mNtQRAHS.mjs';
...
import { _ as _imports_2$2 } from './editar-D76uoVXa.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const state = reactive({
      nacionalidade: ((_e = useCookie("user-service").value) == null ? void 0 : _e.estrangeiro) || false,
                ...
                if (_push3) {
                  ...
                  if (unref(showCreateOrdemServ)) {
                    _push3(ssrRenderComponent(VCol, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="Salvar"${_scopeId3}></div>`);
                        } else {
                          return [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(VDataTable, {
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(VRow, { style: { "display": "flex", "gap": "10px", "margin-top": "-5px" } }, {
                            default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div title="Reimprimir"${_scopeId4}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2$1)} alt="Reimprimir"${_scopeId4}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Desabilitado")}${_scopeId4}><img style="${ssrRenderStyle({
                                  cursor: item.btn_editar ? "pointer" : "default",
                                  width: "30px",
                                  height: "30px"
                                })}"${ssrRenderAttr("src", _imports_2$2)} alt="Editar"${_scopeId4}></div><div${ssrIncludeBooleanAttr(!item.btn_cancelar) ? " disabled" : ""} title="Excluir"${_scopeId4}>`);
                                if (item.excluido) {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`${ssrInterpolate(unref(atosItems))} `);
                        } else {
                          return [
                            createTextVNode(toDisplayString(unref(atosItems)) + " ", 1)
                          ];
                        }
                      }),
                      _: 1
...
//# sourceMappingURL=criar-registro-D-HPUbEI.mjs.map
