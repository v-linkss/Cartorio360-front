          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div data-v-37b6c65d${_scopeId2}><img class="ml-5 mt-2"${ssrRenderAttr("width", 300)}${ssrRenderAttr("height", 50)}${ssrRenderAttr("src", _imports_0)} data-v-37b6c65d${_scopeId2}><h3 style="${ssrRenderStyle({ "color": "white", "margin-left": "30px" })}" data-v-37b6c65d${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h3></div>`);
                  ...
                  _push3(`<!--]--><div class="flex flex-col justify-center align-center mt-6" data-v-37b6c65d${_scopeId2}>`);
                  ...
                  _push3(`<h4 class="mt-1" data-v-37b6c65d${_scopeId2}> CPF: <span data-v-37b6c65d${_scopeId2}>${ssrInterpolate(unref(cpf))}</span></h4></div>`);
                } else {
                  return [
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-37b6c65d"]]);

export { _default as default };
//# sourceMappingURL=default-22bzjMAt.mjs.map
