import { _ as _sfc_main$1 } from './TiposAtos-Dc8aTwtO.mjs';
import { _ as _imports_3, a as _sfc_main$2 } from './Selos-6-f6YNEx.mjs';
import { _ as _sfc_main$3 } from './Ordem-DWRfzr4J.mjs';
import { _ as _sfc_main$4 } from './Ordem-BUAm0FNK.mjs';
...
import { V as VListItem } from './VList-BPhVGERd.mjs';
...
${item.ato_servico}` : `${item.ato_servico}`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 data-v-a35f46c4${_scopeId2}>Atos</h1>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VListItem, props, {
                                title: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  var _a;
                                  if (_push6) {
                                    _push6(`<span data-v-a35f46c4${_scopeId5}>${(_a = item.raw.descricao) != null ? _a : ""}</span>`);
                                  } else {
                                    return [
                                      createVNode("span", {
                  ...
                  _push3(ssrRenderComponent(VCol, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-a35f46c4${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Pesquisar" data-v-a35f46c4${_scopeId3}></div>`);
                      } else {
                        return [
      ...
      _push(`<div style="${ssrRenderStyle({ "width": "1300px", "margin": "0 auto" })}" data-v-a35f46c4><hr class="mt-5 mb-5" data-v-a35f46c4>`);
      _push(ssrRenderComponent(VDataTable, {
        ...
        "item.actions": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "justify-content": "center" })}" data-v-a35f46c4${_scopeId}><div title="Visualizar" data-v-a35f46c4${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar" data-v-a35f46c4${_scopeId}></div><div title="Reimprimir" data-v-a35f46c4${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_3)} alt="Reimprimir" data-v-a35f46c4${_scopeId}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Desabilitado")} data-v-a35f46c4${_scopeId}><img style="${ssrRenderStyle({
              cursor: item.btn_editar ? "pointer" : "default",
              width: "30px",
              height: "30px"
            })}"${ssrRenderAttr("src", _imports_1$1)} alt="Editar" data-v-a35f46c4${_scopeId}></div><div${ssrIncludeBooleanAttr(!item.btn_cancelar) ? " disabled" : ""} title="Excluir" data-v-a35f46c4${_scopeId}>`);
            if (item.excluido) {
              _push2(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="Visualizar" title="Reativar" data-v-a35f46c4${_scopeId}>`);
            } else {
              _push2(`<img${ssrRenderAttr("src", _imports_3$1)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}" title="Excluir" data-v-a35f46c4${_scopeId}>`);
            }
            _push2(`</div></div>`);
          } else {
            return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a35f46c4"]]);

export { index as default };
//# sourceMappingURL=index-Cy0Wgozx.mjs.map
