...
import { _ as _export_sfc, u as useRouter$1, V as VTextField, aV as VDataTable, b as useRuntimeConfig } from './server.mjs';
import { ref, withAsyncContext, unref, mergeProps, withCtx, createVNode, isRef, openBlock, createBlock, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const headers = [
      ...
      { title: "Nome/Raz\xE3o Social", value: "nome", search: "" },
      { value: "actions" }
    ];
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Cadastro" data-v-cebe555f${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "btn-pointer",
              ...
              _push2(ssrRenderComponent(VRow, { style: { "gap": "2rem" } }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(VRow, { style: { "display": "flex", "gap": "10px" } }, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="btn-pointer" title="Visualizar" data-v-cebe555f${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar" data-v-cebe555f${_scopeId3}></div><div class="btn-pointer" title="Atualizar" data-v-cebe555f${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}"${ssrRenderAttr("src", _imports_2)} alt="Atualizar" data-v-cebe555f${_scopeId3}></div><div class="btn-pointer" title="Deletar" data-v-cebe555f${_scopeId3}>`);
                          if (item.excluido) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}"${ssrRenderAttr("src", _imports_3)} alt="Visualizar" title="Reativar" data-v-cebe555f${_scopeId3}>`);
                          } else {
                            _push4(`<img${ssrRenderAttr("src", _imports_4)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "40px", "height": "40px" })}" title="Excluir" data-v-cebe555f${_scopeId3}>`);
                          }
                          _push4(`</div>`);
                        } else {
                          return [
              ...
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/home" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", _imports_0$1)} alt="Sair" data-v-cebe555f${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: _imports_0$1,
              ...
              return [
                ...
                createVNode(VRow, { style: { "gap": "2rem" } }, {
                  default: withCtx(() => [
                    createVNode(VTextField, {
                      class: "mt-7 mb-4",
                      modelValue: unref(search),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cebe555f"]]);

export { index as default };
//# sourceMappingURL=index-BbyAKF13.mjs.map
