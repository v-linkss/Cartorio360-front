...
import { p as propsFactory, W as makeRoundedProps, U as makeElevationProps, m as makeComponentProps, o as genericComponent, $ as Ripple, q as useRtl, a6 as useElevation, A as useTextColor, s as useRender, aa as convertToUnit, bc as VScaleTransition, a7 as useRounded, ad as useBackgroundColor, bd as makeFocusProps, aD as makeVInputProps, z as useProxiedModel, aG as useFocus, aI as VInput, aP as VLabel, u as useRouter$1, b as useNuxtApp, e as useCookie, b9 as VProgressCircular, V as VTextField, g as VBtn, f as useRoute$1, b8 as VSpacer, bb as getDecimals, ak as createRange, _ as _export_sfc, c as useRuntimeConfig, am as clamp, al as keyValues } from './server.mjs';
import { u as useLazyAsyncData } from './asyncData-5-ZiIFU2.mjs';
import { $ as $fetchWithToken, f as fetchWithToken } from './fetchWithToken-BOdMs1av.mjs';
...
import { e as VSelect } from './filter-CJ_8gFu0.mjs';
...
import { V as VDialog } from './VDialog-DUonz2jA.mjs';
import { V as VCard, a as VCardTitle, b as VCardText, c as VCardActions } from './VCard-BPJdWfDh.mjs';
import * as UTIF from 'utif';
import { _ as _sfc_main$d } from './FichaCard-z5UPXy3d.mjs';
import { _ as _imports_1$2 } from './visualizar-BoZ30DMV.mjs';
import { V as VTabs, a as VTab, d as VTabsWindow, e as VTabsWindowItem } from './VTabs-O-cNYj0r.mjs';
...
const _sfc_main$a = {
  ...
  async setup(__props, { emit: __emit }) {
    ...
    async function handleScannerClick(pessoa_docs_token) {
      try {
        console.log("A\xE7\xE3o do scanner iniciada\n");
                    ...
                    _push3(ssrRenderComponent(VRow, { style: { "display": "flex", "margin-top": "-8px", "gap": "10px" } }, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          if (item.excluido) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2$1)} alt="deletar" title="Reativar"${_scopeId3}>`);
                          } else {
                          ...
                          if (_ctx.status_arquivo === false) {
                            ...
                            _push4(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2)} alt="Criar"${_scopeId3}>`);
                          }
                          _push4(`</div>`);
                        } else {
                          return [
                    ...
                    _push3(ssrRenderComponent(VRow, { style: { "display": "flex", "margin-top": "-8px", "gap": "10px" } }, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          if (item.excluido) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_2$1)} alt="Visualizar" title="Reativar"${_scopeId3}>`);
                          } else {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-02650459"]]);
const _sfc_main$6 = {
  __name: "TiffViewer",
  __ssrInlineRender: true,
  props: {
...
export { _imports_2 as _, _imports_0$3 as a, _imports_1 as b, _sfc_main as c, _sfc_main$6 as d, _sfc_main$b as e, _sfc_main$a as f, _sfc_main$9 as g, _sfc_main$8 as h, _sfc_main$2 as i, __nuxt_component_6 as j, _sfc_main$c as k };
//# sourceMappingURL=RegistroPessoas-DJ_s4zyk.mjs.map
