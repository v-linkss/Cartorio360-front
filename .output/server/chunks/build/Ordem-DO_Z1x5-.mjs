                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VDataTable, {
                          ...
                          "item.actions": withCtx(({ item }, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div style="${ssrRenderStyle({ "display": "flex", "justify-content": "flex-end" })}"${ssrRenderAttr("title", item.btn_cancelar ? "Remover" : "")}${_scopeId4}><img${ssrRenderAttr("src", _imports_1)} style="${ssrRenderStyle([{ "width": "30px", "height": "30px" }, {
                                cursor: item.btn_cancelar ? "pointer" : "default",
                                opacity: item.btn_cancelar ? 1 : 0.5
                              }])}" alt="Remover"${_scopeId4}></div>`);
                            } else {
                              return [
                                createVNode("div", {
                                  style: { "display": "flex", "justify-content": "flex-end" },
                                  onClick: ($event) => item.btn_cancelar ? removeFormValueFromTable(item) : null,
...
//# sourceMappingURL=Ordem-DO_Z1x5-.mjs.map
