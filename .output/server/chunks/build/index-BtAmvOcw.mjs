...
import { _ as _export_sfc, u as useRouter$1, e as VTextField, as as VDataTable, b as useRuntimeConfig } from './server.mjs';
            ...
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/pessoas/cadastro" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Cadastro" data-v-9f4b0129${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "btn-pointer",
              ...
              _push2(ssrRenderComponent(VRow, { style: { "gap": "10rem" } }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div style="${ssrRenderStyle({ "width": "200px" })}" data-v-9f4b0129${_scopeId2}>`);
                    ...
                    _push3(`</div><div style="${ssrRenderStyle({ "width": "300px" })}" data-v-9f4b0129${_scopeId2}>`);
                    _push3(ssrRenderComponent(VTextField, {
                      class: "mt-7 mb-4",
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(VRow, { style: { "display": "flex", "gap": "10px", "justify-content": "flex-end" } }, {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="btn-pointer" title="Visualizar" data-v-9f4b0129${_scopeId3}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar" data-v-9f4b0129${_scopeId3}></div><div class="btn-pointer" title="Atualizar" data-v-9f4b0129${_scopeId3}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_2)} alt="Atualizar" data-v-9f4b0129${_scopeId3}></div><div class="btn-pointer" title="Deletar" data-v-9f4b0129${_scopeId3}>`);
                          if (item.excluido) {
                            _push4(`<img style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}"${ssrRenderAttr("src", _imports_3)} alt="Visualizar" title="Reativar" data-v-9f4b0129${_scopeId3}>`);
                          } else {
                            _push4(`<img${ssrRenderAttr("src", _imports_4)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px" })}" title="Excluir" data-v-9f4b0129${_scopeId3}>`);
                          }
                          _push4(`</div>`);
                        } else {
                          return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9f4b0129"]]);

export { index as default };
//# sourceMappingURL=index-BtAmvOcw.mjs.map
