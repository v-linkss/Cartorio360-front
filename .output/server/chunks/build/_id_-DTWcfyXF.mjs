...
import { _ as _imports_2$2, a as _imports_3 } from './excluido-CHOPYrBt.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const getOsPayload = `${config.public.auth}/service/gerencia/getOrdensServicoById`;
...
//# sourceMappingURL=_id_-DTWcfyXF.mjs.map
