...
import { u as useRouter$1, c as useRoute$1, f as useNuxtApp, d as useCookie, V as VTextField, e as VBtn, as as VDataTable, a2 as VImg, at as VSheet, b as useRuntimeConfig } from './server.mjs';
...
import { _ as _sfc_main$a } from './RegistroPessoas-B4KqFkQ-.mjs';
import { a as VCard, V as VDialog, b as VCardActions, c as VCardText } from './VCard-uMKFEuGZ.mjs';
...
import { V as VTabs, a as VTab, b as VTabsWindow, c as VTabsWindowItem } from './VTabs-aU3w-92e.mjs';
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div><img class="ml-15" style="${ssrRenderStyle({ "height": "40px", "width": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_0$1)}>`);
      if (unref(lavraData)) {
        _push(ssrRenderComponent(VCard, { class: "ml-8 mt-5" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VSheet, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(` Livro: ${ssrInterpolate(unref(lavraData)[0].livro_numero)}`);
                              } else {
                                return [
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VSheet, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(` Folhas : ${ssrInterpolate(unref(lavraData)[0].pagina_inicial)} \xC1 ${ssrInterpolate(unref(lavraData)[0].pagina_final)}`);
                              } else {
                                return [
...
//# sourceMappingURL=procuracao-CfuFMSK3.mjs.map
