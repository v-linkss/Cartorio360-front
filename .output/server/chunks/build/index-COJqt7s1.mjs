...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-16f6d2d4><div class="container-form" data-v-16f6d2d4>`);
      ...
      _push(`<div class="text" data-v-16f6d2d4>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-16f6d2d4> Esqueceu a senha?</a></div><div class="background-image" data-v-16f6d2d4></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-16f6d2d4"]]);

export { index as default };
//# sourceMappingURL=index-COJqt7s1.mjs.map
