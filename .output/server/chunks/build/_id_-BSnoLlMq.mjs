  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-5781fcaa${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                class: "btn-pointer",
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5781fcaa"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-BSnoLlMq.mjs.map
