...
import { e as useCookie, h as VIcon, c as useRuntimeConfig } from './server.mjs';
...
const _imports_3 = "" + buildAssetsURL("selo.D9mIBRmY.png");
const _sfc_main = {
  __name: "Selos",
  ...
  async setup(__props, { emit: __emit }) {
    ...
    const reimprimeSelosAtos = async () => {
      if (await v$.value.$validate()) {
        selectedSelos.value.map((selo) => ({ selo_token: selo }));
        const body = {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCardActions, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div${_scopeId3}><img${ssrRenderAttr("src", _imports_3)} style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId3}></div>`);
                      } else {
                        return [
...
export { _imports_3 as _, _sfc_main as a };
//# sourceMappingURL=Selos-C_pTa6oT.mjs.map
