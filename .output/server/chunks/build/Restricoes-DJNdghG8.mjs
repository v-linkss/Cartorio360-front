...
import { p as propsFactory, x as makeComponentProps, z as makeTagProps, N as makeThemeProps, l as genericComponent, P as provideTheme, a4 as useRtl, aa as useLocale, aw as useGroup, V as VBtn, s as useRender, ax as makeGroupItemProps, ay as makeLazyProps, az as useGroupItem, aA as useSsrBoot, aB as useLazy, aC as MaybeTransition, L as makeRoundedProps, G as makeElevationProps, R as Ripple, W as useElevation, ac as useTextColor, aD as convertToUnit, aH as VScaleTransition, $ as useRounded, aJ as useBackgroundColor, aK as makeFocusProps, aL as makeVInputProps, o as useProxiedModel, aM as useFocus, aN as VInput, aO as VLabel, a7 as omit, aP as makeVBtnProps, t as forwardRefs, aS as makeVSlideGroupProps, B as makeDensityProps, T as useDensity, q as useScopeId, y as provideDefaults, aU as VSlideGroup, aE as getDecimals, aF as createRange, aQ as animate, aR as standardEasing, aT as isObject, e as useNuxtApp, as as useRoute$1, c as useCookie, d as VTextField, at as VDataTable, ar as VSpacer, _ as _export_sfc, av as keys, aG as clamp, b as useRuntimeConfig, a1 as VImg, aI as keyValues, aV as VSelect } from './server.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-DyZc7qn_.mjs';
import { a as useLazyAsyncData, u as useFetch } from './fetch-BMwmmUQC.mjs';
...
import { _ as _imports_0$3, a as _imports_2, b as _imports_3, c as _imports_4 } from './mudarStatus-BMovbU8H.mjs';
...
import { V as VDialog, a as VCard, b as VCardTitle, c as VCardText, d as VCardActions } from './VCard-VRIIZ7Qu.mjs';
import { _ as _imports_1 } from './salvar-BNBeYWMa.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VCol, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="finger-container" data-v-75852492${_scopeId}><!--[-->`);
            ssrRenderList(unref(leftFingers), (finger, index) => {
              _push2(`<div class="finger" style="${ssrRenderStyle(getFingerStyle(finger, "left"))}" data-v-75852492${_scopeId}></div>`);
            });
            _push2(`<!--]--><!--[-->`);
            ssrRenderList(unref(rightFingers), (finger, index) => {
              _push2(`<div class="finger" style="${ssrRenderStyle(getFingerStyle(finger, "right"))}" data-v-75852492${_scopeId}></div>`);
            });
            _push2(`<!--]--></div>`);
            _push2(ssrRenderComponent(VDialog, {
              modelValue: unref(isModalOpen),
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              if (unref(currentFingerBiometria)) {
                                _push5(`<div data-v-75852492${_scopeId4}><p data-v-75852492${_scopeId4}>Biometria existente para ${ssrInterpolate(unref(selectedFinger))}.</p>`);
                                _push5(ssrRenderComponent(VImg, {
                                  src: unref(currentFingerBiometria),
                                  alt: "Biometria"
                                }, null, _parent5, _scopeId4));
                                _push5(`<p data-v-75852492${_scopeId4}>Deseja substituir?</p></div>`);
                              } else {
                                _push5(`<div data-v-75852492${_scopeId4}><p data-v-75852492${_scopeId4}> Nenhuma biometria encontrada para ${ssrInterpolate(unref(selectedFinger))}. Capturando nova biometria... </p></div>`);
                              }
                              if (unref(biometricDevice)) {
                                _push5(`<div data-v-75852492${_scopeId4}><p data-v-75852492${_scopeId4}>Dispositivo biom\xE9trico detectado: ${ssrInterpolate(unref(biometricDevice))}</p></div>`);
                              } else {
                                _push5(`<!---->`);
                              }
                            } else {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-75852492"]]);
...
//# sourceMappingURL=Restricoes-DJNdghG8.mjs.map
