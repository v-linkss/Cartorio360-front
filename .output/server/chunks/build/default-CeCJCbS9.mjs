          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div data-v-ebe73ded${_scopeId2}><img class="ml-5 mt-2"${ssrRenderAttr("width", 300)}${ssrRenderAttr("height", 50)}${ssrRenderAttr("src", _imports_0)} data-v-ebe73ded${_scopeId2}><h3 style="${ssrRenderStyle({ "color": "white", "margin-left": "30px" })}" data-v-ebe73ded${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h3></div>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ebe73ded"]]);

export { _default as default };
//# sourceMappingURL=default-CeCJCbS9.mjs.map
