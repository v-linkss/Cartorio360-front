...
import { _ as _export_sfc, aF as useRoute$1, aW as VSheet, aX as VResponsive, b as useRuntimeConfig } from './server.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VSheet, { class: "pa-2 ma-2" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(` Local de Trabalho: ${ssrInterpolate(unref(PessoaView).data_nascimento)}`);
                              } else {
                                return [
                                  createTextVNode(" Local de Trabalho: " + toDisplayString(unref(PessoaView).data_nascimento), 1)
                                ];
                              }
                            }),
                            _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-40181427${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                class: "btn-pointer",
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-40181427"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-Ctw1L5y2.mjs.map
