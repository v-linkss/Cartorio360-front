...
import _sfc_main$1 from './semelhanca-Di8b2RnG.mjs';
import _sfc_main$2 from './autencidade-Cgq205zM.mjs';
import autenticacao from './autenticacao-rB-cZQ1r.mjs';
import _sfc_main$3 from './geral-Dor1jAep.mjs';
import _sfc_main$4 from './geral-VM-DusSX.mjs';
...
import 'vue-the-mask';
import './RegistroPessoas-CCv0kCnl.mjs';
import '@vuelidate/core';
import '@vuelidate/validators';
import './fetchWithToken-CMmbn_BR.mjs';
...
import './VTabs-CJui92Gz.mjs';
import './ErrorModalCard-6a367pr6.mjs';
import './visualizar-vermelho-Ly_aKn8Z.mjs';
import './Anexos-Aq1_68si.mjs';
import './abre-arquivo-verde-CXSl7q4m.mjs';
import './Confirmacao-Dzvzwet0.mjs';
import './Outros-BjpPKKNu.mjs';
import './MoneyInput-ot-UsY0X.mjs';
import 'v-money3';
import './Imoveis-BGIcUR1q.mjs';
import './VTextarea-CAGJgzo5.mjs';
import './Atualizar-BkDctam9.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`<h1 data-v-b05d07e8${_scopeId2}>Ordem de Servi\xE7o n\xBA</h1><h1 style="${ssrRenderStyle({ "color": "red", "margin-left": "30px" })}" data-v-b05d07e8${_scopeId2}>${ssrInterpolate(unref(numeroOs) || ((_a2 = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? undefined : _a2.numero) || null)}</h1>`);
                } else {
                  return [
...
const criarAto = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b05d07e8"]]);

export { criarAto as default };
//# sourceMappingURL=criar-ato-DjKNGs02.mjs.map
