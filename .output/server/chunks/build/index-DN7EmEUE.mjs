...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "chat-window" }, _attrs))} data-v-47044469><header class="chat-header" data-v-47044469><h3 class="chat-title" data-v-47044469>${ssrInterpolate(__props.chat.name.split("_").slice(1).join("_"))}</h3><div data-v-47044469><button class="chat-button end" data-v-47044469>Encerrar</button><button class="chat-close" data-v-47044469>\u2716</button></div></header>`);
...
const ChatWindow = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-47044469"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-DN7EmEUE.mjs.map
