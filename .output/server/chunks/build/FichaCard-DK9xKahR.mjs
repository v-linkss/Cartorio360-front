                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(VRow, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div${_scopeId4}><img class="ml-5" style="${ssrRenderStyle({ "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_0$1)} alt="Sair"${_scopeId4}></div><div${_scopeId4}><img style="${ssrRenderStyle({ "cursor": "pointer" })}" class="ml-5"${ssrRenderAttr("src", _imports_1)}${_scopeId4}></div>`);
                              } else {
                                return [
...
//# sourceMappingURL=FichaCard-DK9xKahR.mjs.map
