...
import { V as VTabs, a as VTab, b as VTabsWindow, c as VTabsWindowItem, e as _sfc_main$b, f as _sfc_main$a, g as _sfc_main$9, h as _sfc_main$8, i as _sfc_main$2, j as __nuxt_component_6 } from './RegistroPessoas-BSTC7kJ7.mjs';
...
import { _ as _export_sfc, u as useRouter$1, f as useNuxtApp, c as useRoute$1, d as useCookie, aM as VProgressCircular, V as VTextField, e as VBtn, b as useRuntimeConfig } from './server.mjs';
...
import { V as VSelect } from './filter-DxEBKIwJ.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    `${config.public.managemant}/listarSexo`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VCard, mergeProps({ width: "1300" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 style="${ssrRenderStyle({ "background-color": "#f5f2f2", "color": "#525050", "padding": "10px 0px 0px 20px" })}" data-v-40d7763a${_scopeId}>${ssrInterpolate(unref(id) ? "Atualiza\xE7\xE3o de Pessoas" : "Cadastramento de Pessoas")}</h1><div style="${ssrRenderStyle({ "background-color": "#f5f2f2", "padding": "20px 0px 20px 20px" })}" data-v-40d7763a${_scopeId}>`);
            ...
            _push2(`</div>`);
            if (unref(loading)) {
              _push2(`<div class="d-flex justify-center" data-v-40d7763a${_scopeId}>`);
              ...
              _push2(`<div data-v-40d7763a${_scopeId}>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-40d7763a"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-jAKjhMA3.mjs.map
