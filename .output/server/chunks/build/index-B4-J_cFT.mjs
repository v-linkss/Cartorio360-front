...
import { _ as _export_sfc, u as useRouter$1, b as useNuxtApp, f as VTextField, V as VBtn, ba as VSpacer, c as useRuntimeConfig, e as useCookie } from './server.mjs';
  ...
  setup(__props) {
    ...
    const enviarCodigo = async () => {
      ...
      if (status.value === "success") {
        ...
        $toast.error(
          ((_c = (_b = (_a = error.value) == null ? undefined : _a.data) == null ? undefined : _b.menssage) == null ? undefined : _c.details) || ((_e = (_d = error.value) == null ? undefined : _d.data) == null ? undefined : _e.status_mensagem)
        );
      }
    };
                  ...
                  _push3(ssrRenderComponent(VContainer, { style: { "max-width": "650px" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="text" data-v-063969f7${_scopeId3}>Login</div>`);
                        ...
                        _push4(`<div data-v-063969f7${_scopeId3}><a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "white", "margin-left": "10px", "cursor": "pointer" })}" data-v-063969f7${_scopeId3}> Esqueceu a senha? </a></div>`);
                      } else {
                        return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-063969f7"]]);

export { index as default };
//# sourceMappingURL=index-B4-J_cFT.mjs.map
