...
import { _ as _export_sfc, u as useRouter$1, f as useNuxtApp, V as VTextField, e as VBtn, aN as VSpacer, b as useRuntimeConfig, d as useCookie } from './server.mjs';
...
import { a as VDialog, V as VCard } from './VDialog-BnIkuznU.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-69521f2a><div class="container-form" data-v-69521f2a>`);
      ...
      _push(`<div class="text" data-v-69521f2a>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-69521f2a> Esqueceu a senha?</a></div><div class="background-image" data-v-69521f2a></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-69521f2a"]]);

export { index as default };
//# sourceMappingURL=index-CGVgibdP.mjs.map
