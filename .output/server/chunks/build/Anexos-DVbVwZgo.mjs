...
import { b as useNuxtApp, u as useRouter$1, f as useRoute$1, V as VTextField, g as VBtn, e as useCookie, b0 as VProgressCircular, b1 as VSheet, c as useRuntimeConfig } from './server.mjs';
...
import { _ as _imports_2$2, a as _imports_0$3, b as _imports_1$2, c as _sfc_main$6 } from './RegistroPessoas-BBxmsBAb.mjs';
import { _ as _imports_5, T as Toolbar, W as WordExport, S as Search, D as DocumentEditorContainerComponent, a as _imports_0$1, b as _sfc_main$2$1, c as _sfc_main$1$1, d as _sfc_main$8 } from './Observacao-DUc6kVdC.mjs';
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(allEscreventes, {
      method: "POST",
      body: { cartorio_token }
    }, "$iv1N3XD6We")), __temp = await __temp, __restore(), __temp);
      ...
      _push(ssrRenderComponent(VContainer, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              _push2(ssrRenderComponent(VRow, { class: "mt-5" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      !isVisualizar.value ? (openBlock(), createBlock(VBtn, {
                        key: 0,
                        class: "mb-4 ml-8",
                        onClick: openModalCreateObservacao,
                        size: "large",
            ...
            if (isModalObservacaoOpen.value) {
              _push2(ssrRenderComponent(_component_ModalObservacao, {
                show: isModalObservacaoOpen.value,
                observacao: modalObservacaoText.value,
                visualizar: isVisualizarModal.value,
            ...
            return [
              ...
              isModalObservacaoOpen.value ? (openBlock(), createBlock(_component_ModalObservacao, {
                key: 1,
                show: isModalObservacaoOpen.value,
                observacao: modalObservacaoText.value,
                visualizar: isVisualizarModal.value,
...
//# sourceMappingURL=Anexos-DVbVwZgo.mjs.map
