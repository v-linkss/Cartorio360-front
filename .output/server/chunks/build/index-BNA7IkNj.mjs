import { ref, mergeProps, withCtx, unref, isRef, createTextVNode, createVNode, useSSRContext, computed, resolveComponent, toDisplayString, openBlock, createBlock } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrRenderClass, ssrRenderAttr } from 'vue/server-renderer';
import { _ as _sfc_main$3 } from './Ordem-CkoHwbmV.mjs';
import { _ as _sfc_main$4 } from './Confirmacao-BXaYxSTg.mjs';
...
import { V as VTabs, a as VTab, b as VWindow, c as VWindowItem } from './VTabs-DRgtA1OR.mjs';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    async function getSituacaoOs() {
      try {
        const { data: data2, error } = await useFetch(situacaoOS, {
          method: "GET"
        }, "$nTZq0SR2Wg");
        if (data2.value && Array.isArray(data2.value)) {
          situacoes.value = data2.value.map((item) => ({
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1${_scopeId2}> Recebimento de Ordens de Servi\xE7o - <span style="${ssrRenderStyle({ "color": "red" })}"${_scopeId2}>Caixa ${ssrInterpolate(("formatDate" in _ctx ? _ctx.formatDate : unref(formatDate))(unref(data)))}</span> - ${ssrInterpolate(unref(nome_usuario))}</h1>`);
                } else {
                  return [
                    createVNode("h1", null, [
                      createTextVNode(" Recebimento de Ordens de Servi\xE7o - "),
                      createVNode("span", { style: { "color": "red" } }, "Caixa " + toDisplayString(("formatDate" in _ctx ? _ctx.formatDate : unref(formatDate))(unref(data))), 1),
                      createTextVNode(" - " + toDisplayString(unref(nome_usuario)), 1)
                    ])
                  ];
                }
              }),
...
//# sourceMappingURL=index-BNA7IkNj.mjs.map
