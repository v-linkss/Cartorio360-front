...
import { p as propsFactory, m as makeComponentProps, h as makeTagProps, j as genericComponent, o as useRender, x as makeBorderProps, z as makeElevationProps, D as makeRoundedProps, F as makeThemeProps, av as useBackgroundColor, J as useBorder, N as useElevation, S as useRounded, H as provideTheme, Y as useRtl, l as provideDefaults, U as VImg, w as VDefaultsProvider, as as convertToUnit, aY as VExpandTransition, aZ as makeLayoutItemProps, a4 as useProxiedModel, a_ as useToggleScope, aM as useSsrBoot, a$ as useLayoutItem, y as makeDimensionProps, M as useDimension, b0 as useLayout, _ as _export_sfc, ar as clamp, u as useRouter$1, b1 as VApp, al as useCookie, am as VSpacer, ab as VMenu, an as VBtn, ac as VList, ad as VListItem, b2 as VListItemTitle } from './server.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h5 style="${ssrRenderStyle({ "color": "#429946", "margin-left": "30px" })}" data-v-bae86b4e${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h5>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bae86b4e"]]);

export { _default as default };
//# sourceMappingURL=default-D1W7PztJ.mjs.map
