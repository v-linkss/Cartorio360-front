...
import { q as propsFactory, m as makeComponentProps, s as makeTagProps, l as genericComponent, o as useRender, y as makeBorderProps, A as makeElevationProps, E as makeRoundedProps, G as makeThemeProps, ah as useBackgroundColor, K as useBorder, O as useElevation, T as useRounded, J as provideTheme, a3 as useRtl, p as provideDefaults, x as VDefaultsProvider, aj as convertToUnit, aI as VExpandTransition, bd as makeLayoutItemProps, $ as useProxiedModel, aF as useToggleScope, be as useLayoutItem, z as makeDimensionProps, N as useDimension, bf as useLayout, _ as _export_sfc, aD as clamp, u as useRouter$1, d as useCookie, bg as VApp, aL as VSpacer, aa as VMenu, e as VBtn } from './server.mjs';
...
import { u as useSsrBoot, V as VList, b as VListItem, d as VListItemTitle } from './VList-CYYVz_6B.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VAppBar, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h5 style="${ssrRenderStyle({ "color": "#525050", "margin-left": "30px" })}" data-v-08784f95${_scopeId2}>${ssrInterpolate(("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-data").value.cartorio_nome)}</h5>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-08784f95"]]);

export { _default as default };
//# sourceMappingURL=default-mOLmxyHV.mjs.map
