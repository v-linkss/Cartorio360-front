                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(VRow, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<img class="btn-pointer"${ssrRenderAttr("src", _imports_0)} alt="Sair" data-v-9ba35c26${_scopeId3}><img class="btn-pointer"${ssrRenderAttr("src", _imports_1$1)} data-v-9ba35c26${_scopeId3}>`);
                        } else {
                          return [
                            createVNode("img", {
                              class: "btn-pointer",
...
//# sourceMappingURL=ReconhecimentoFirma-CrMj9R9_.mjs.map
