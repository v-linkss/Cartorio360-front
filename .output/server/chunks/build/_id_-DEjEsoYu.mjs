import { _ as _sfc_main$5, a as _sfc_main$4, b as _sfc_main$3, c as _sfc_main$2, d as _sfc_main$1, e as _sfc_main$6 } from './Anexos-DzBymewJ.mjs';
...
import { aS as useRoute$1, e as useCookie, c as useRuntimeConfig } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><img style="${ssrRenderStyle({
        cursor: _ctx.item.btn_editar ? "pointer" : "default",
        width: "30px",
        height: "30px"
      })}"${ssrRenderAttr("src", _imports_1)} alt="Editar"></div></div>`);
...
//# sourceMappingURL=_id_-DEjEsoYu.mjs.map
