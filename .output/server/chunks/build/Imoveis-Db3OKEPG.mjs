...
import { u as useRouter$1, aL as useRoute$1, b as useNuxtApp, e as useCookie, aM as VSpacer, F as VBtn, V as VTextField, c as useRuntimeConfig } from './server.mjs';
...
import { _ as _sfc_main$2 } from './Cadastro-B9aFvhQs.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    `${config.public.auth}/service/gerencia/updatePessoa`;
    useRouter$1();
    const search = ref("");
    const searchDoc = ref("");
    const isModalCadastroImoveisOpen = ref(false);
    const headers = [
      { title: "Matr\xEDcula", value: "doc_identificacao" },
      { title: "Descri\xE7\xE3o", value: "nome" },
      { value: "actions" }
    ];
    const { data: pessoasItems, status } = ([__temp, __restore] = withAsyncContext(() => fetchWithToken(pessoasLista)), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ModalImoveisCadastro = _sfc_main$2;
...
//# sourceMappingURL=Imoveis-Db3OKEPG.mjs.map
