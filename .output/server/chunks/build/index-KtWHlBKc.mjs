import { _ as _sfc_main$1 } from './TiposAtos-B6FltSJe.mjs';
import { _ as _imports_3, a as _sfc_main$2 } from './Selos-BhTZpGRw.mjs';
import { _ as _sfc_main$3 } from './Ordem-xAzEw_j2.mjs';
import { _ as __nuxt_component_1 } from './Confirmacao-BDXbX8Rt.mjs';
        ...
        "item.actions": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (item.excluido) {
              ...
              _push2(`<img${ssrRenderAttr("src", _imports_3$1)} alt="Excluir" class="trash-icon" style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}" title="Excluir" data-v-d68ef1b3${_scopeId}>`);
            }
            _push2(`</div></div>`);
          } else {
            return [
...
//# sourceMappingURL=index-KtWHlBKc.mjs.map
