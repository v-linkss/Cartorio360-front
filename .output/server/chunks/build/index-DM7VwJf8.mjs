                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VAutocomplete, {
                                      ...
                                      "item-value": "token",
                                      required: "",
                                      "error-messages": unref(v$).forma.$errors.map((e) => e.$message),
                                      onBlur: unref(v$).forma.$touch
                                    }, null, _parent6, _scopeId5));
                                    _push6(ssrRenderComponent(VTextField, {
                                      label: "Valor",
                                    ...
                                    return [
                                      createVNode(VAutocomplete, {
                                        ...
                                        "error-messages": unref(v$).forma.$errors.map((e) => e.$message),
                                        onBlur: unref(v$).forma.$touch
                                      }, null, 8, ["modelValue", "onUpdate:modelValue", "items", "error-messages", "onBlur"]),
                                      createVNode(VTextField, {
                                        label: "Valor",
                                        modelValue: unref(state).valor,
                                        "onUpdate:modelValue": ($event) => unref(state).valor = $event,
...
//# sourceMappingURL=index-DM7VwJf8.mjs.map
