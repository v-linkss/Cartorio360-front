...
import { _ as _sfc_main$1 } from './SaveButton-B3jhfywM.mjs';
      ...
      if (status.value === "success") {
        ...
        if (data2.value.tipo_etiqueta === "html") {
          ...
          if (zplStatus.value !== "success") {
            errorModalVisible.value = true;
            const apiErrorMessage = (_b = (_a = error2.value) == null ? undefined : _a.data) == null ? undefined : _b.message;
            if (apiErrorMessage) {
...
//# sourceMappingURL=autenticacao-C3RM6CCz.mjs.map
