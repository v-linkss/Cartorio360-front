import { _ as _sfc_main$5, a as _sfc_main$4, b as _sfc_main$3, c as _sfc_main$2$1, d as _sfc_main$1$2, e as _sfc_main$6 } from './Anexos-BQ_2G_mp.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$2 } from './Imoveis-Pdrg9STE.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-TpvcaGEw.mjs';
import { ref, watch, mergeProps, withCtx, unref, isRef, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext, reactive, withAsyncContext, computed } from 'vue';
            ...
            _push2(ssrRenderComponent(VTabs, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(showTabs)) {
                    _push3(ssrRenderComponent(VTab, { value: "separacao_ivorcio" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(` Separa\xE7\xE3o e Div\xF3rcio`);
                        } else {
                          return [
            ...
            _push2(ssrRenderComponent(VTabsWindow, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(usaImoveis)) {
                    _push3(ssrRenderComponent(VTabsWindowItem, { value: "separacao_ivorcio" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_ProcuracaoSeparacaoDivorcio, {
                            ato_token: unref(ato_token_prop),
...
//# sourceMappingURL=geral-D0kAJsPD.mjs.map
