...
import { useSSRContext, inject, computed, createVNode, withDirectives, resolveDirective, vShow, ref, mergeProps, Fragment, reactive, withAsyncContext, unref, withCtx, createTextVNode, openBlock, createBlock, isRef, watch, toDisplayString, toRef, shallowRef, provide, createCommentVNode, renderList } from 'vue';
...
import { p as propsFactory, a7 as makeRoundedProps, a6 as makeElevationProps, m as makeComponentProps, h as genericComponent, as as Ripple, j as useRtl, aC as useElevation, q as useTextColor, k as useRender, G as convertToUnit, b2 as VScaleTransition, aD as useRounded, J as useBackgroundColor, b3 as makeFocusProps, b4 as makeVInputProps, B as useProxiedModel, b5 as useFocus, b6 as VInput, au as VLabel, u as useRouter$1, b as useNuxtApp, e as useCookie, a$ as VProgressCircular, V as VTextField, f as VBtn, aZ as useRoute$1, a_ as VSpacer, b1 as getDecimals, ac as createRange, _ as _export_sfc, c as useRuntimeConfig, af as clamp, Y as VIcon, ad as keyValues } from './server.mjs';
import { u as useLazyAsyncData, V as VRow } from './VRow-DVf727cH.mjs';
import { $ as $fetchWithToken, f as fetchWithToken } from './fetchWithToken-D8Xr_sCB.mjs';
...
import { V as VCard, a as VCardTitle, b as VCardText, c as VCardActions } from './VCard-sRL_sqEi.mjs';
                    ...
                    _push3(ssrRenderComponent(VCol, { md: "2" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          }, ssrGetDirectiveProps(_ctx, _directive_modal, unref(state).fone_celular), ssrGetDirectiveProps(_ctx, _directive_mask, "(##) #####-####")), null, _parent4, _scopeId3));
                        } else {
                          return [
                            withDirectives(createVNode(VTextField, {
                              label: "Celular",
                              ...
                              [_directive_modal, unref(state).fone_celular],
                              [_directive_mask, "(##) #####-####"]
                            ])
                          ];
                        }
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-02650459"]]);
const _sfc_main$7 = {
  __name: "TiffViewer",
  __ssrInlineRender: true,
  props: {
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_TiffViewer = _sfc_main$7;
            ...
            _push2(ssrRenderComponent(VCard, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="d-flex justify-center align-center" data-v-661d97fe${_scopeId2}>`);
                  if (unref(hasTiff)) {
                    _push3(`<div class="ml-5 mt-15" data-v-661d97fe${_scopeId2}>`);
                    ...
                    })}" data-v-661d97fe${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (!unref(fotoRender) && !unref(fichaRender)) {
                    _push3(`<div data-v-661d97fe${_scopeId2}><h3 class="mb-5" data-v-661d97fe${_scopeId2}> Este usuario n\xE3o possui ficha de firma cadastrada. </h3></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-661d97fe"]]);
...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    if (props.linkFicha) {
      const { data: link } = ([__temp, __restore] = withAsyncContext(() => useFetch(baixarDocumento, {
        method: "POST",
        body: {
          bucket: useCookie("user-data").value.cartorio_token,
          path: props.linkFicha
        }
      }, "$BxSla0y3eT")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BiometriaScanner = _sfc_main$5;
      ...
      _push(ssrRenderComponent(VCol, { cols: "auto" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div>`);
            if (props.linkFicha) {
              _push2(`<div${_scopeId}><img style="${ssrRenderStyle({ "width": "80px", "height": "80px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1$1)} alt="Ver ficha"${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BiometriaReconhecimentoFacial = _sfc_main$6;
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Dados = _sfc_main$d;
      const _component_DadosJuridica = _sfc_main$c;
      const _component_Documentos = _sfc_main$b;
      const _component_PessoasCadastrosRepresentantes = _sfc_main$a;
      const _component_Endereco = _sfc_main$9;
...
export { _sfc_main as _, __nuxt_component_1 as a, _sfc_main$7 as b, _sfc_main$c as c, _sfc_main$b as d, _sfc_main$a as e, _sfc_main$9 as f, _sfc_main$2 as g, __nuxt_component_6 as h, _sfc_main$d as i };
//# sourceMappingURL=RegistroPessoas-bLULNXQh.mjs.map
