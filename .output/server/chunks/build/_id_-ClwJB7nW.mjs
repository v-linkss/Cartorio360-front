...
import { _ as _export_sfc, aZ as useRoute$1, b0 as VSheet, f as VBtn, c as useRuntimeConfig } from './server.mjs';
...
import { V as VResponsive } from './VResponsive-Cv_UVb0M.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VSheet, { class: "pa-2 ma-2" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(` Data de Nascimento: ${ssrInterpolate(unref(PessoaView).data_nascimento ? ("formatDate" in _ctx ? _ctx.formatDate : unref(formatDate))(unref(PessoaView).data_nascimento) : null)}`);
                              } else {
                                return [
                                  createTextVNode(" Data de Nascimento: " + toDisplayString(unref(PessoaView).data_nascimento ? ("formatDate" in _ctx ? _ctx.formatDate : unref(formatDate))(unref(PessoaView).data_nascimento) : null), 1)
                                ];
                              }
                            }),
                            _: 1
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-37a5d1fe"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-ClwJB7nW.mjs.map
