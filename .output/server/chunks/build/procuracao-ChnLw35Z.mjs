...
const _sfc_main$3 = {
  ...
  async setup(__props) {
    ...
    }, "$ZKnVBNYxp9")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VCard, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "height": "600px", "overflow-y": "auto" })}"${_scopeId}></div>`);
          } else {
            return [
              createVNode("div", {
                ref_key: "livro",
                ...
                if (_push3) {
                  ...
                  if (unref(showTabs)) {
                    _push3(ssrRenderComponent(VTabsWindowItem, { value: "anexo" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_ProcuracaoAnexos, { ato_token: unref(ato_token_prop) }, null, _parent4, _scopeId3));
                        } else {
                          return [
                            createVNode(_component_ProcuracaoAnexos, { ato_token: unref(ato_token_prop) }, null, 8, ["ato_token"])
                          ];
                        }
                      }),
                      _: 1
...
//# sourceMappingURL=procuracao-ChnLw35Z.mjs.map
