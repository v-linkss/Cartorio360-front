...
import _sfc_main$1 from './semelhanca-sw_lNzE7.mjs';
import _sfc_main$2 from './autencidade-DGPE9qOZ.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VRow, { class: "mb-5" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<h1 data-v-a95875e1${_scopeId2}>Ordem de Servi\xE7o n\xBA</h1><h1 style="${ssrRenderStyle({ "color": "red", "margin-left": "30px" })}" data-v-a95875e1${_scopeId2}>${ssrInterpolate(unref(numeroOs) || ((_a = ("useCookie" in _ctx ? _ctx.useCookie : unref(useCookie))("user-service").value) == null ? void 0 : _a.numero) || null)}</h1>`);
                } else {
                  return [
...
const criarAto = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a95875e1"]]);

export { criarAto as default };
//# sourceMappingURL=criar-ato-OHs8h26f.mjs.map
