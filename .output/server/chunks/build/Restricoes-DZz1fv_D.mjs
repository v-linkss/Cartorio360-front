  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VCol, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="finger-container" data-v-2a365ad9${_scopeId}><!--[-->`);
            ssrRenderList(unref(leftFingers), (finger, index) => {
              _push2(`<div class="finger" style="${ssrRenderStyle(getFingerStyle(finger, "left"))}" data-v-2a365ad9${_scopeId}></div>`);
            });
            _push2(`<!--]--><!--[-->`);
            ssrRenderList(unref(rightFingers), (finger, index) => {
              _push2(`<div class="finger" style="${ssrRenderStyle(getFingerStyle(finger, "right"))}" data-v-2a365ad9${_scopeId}></div>`);
            });
            _push2(`<!--]--></div>`);
            _push2(ssrRenderComponent(VDialog, {
              modelValue: unref(isModalOpen),
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              if (unref(currentFingerBiometria)) {
                                _push5(`<div data-v-2a365ad9${_scopeId4}><p data-v-2a365ad9${_scopeId4}>Biometria existente para ${ssrInterpolate(unref(selectedFinger))}.</p>`);
                                _push5(ssrRenderComponent(VImg, {
                                  src: unref(currentFingerBiometria),
                                  alt: "Biometria"
                                }, null, _parent5, _scopeId4));
                                _push5(`<p data-v-2a365ad9${_scopeId4}>Deseja substituir?</p></div>`);
                              } else {
                                _push5(`<div data-v-2a365ad9${_scopeId4}><p data-v-2a365ad9${_scopeId4}> Nenhuma biometria encontrada para ${ssrInterpolate(unref(selectedFinger))}. Capturando nova biometria... </p></div>`);
                              }
                              if (unref(biometricDevice)) {
                                _push5(`<div data-v-2a365ad9${_scopeId4}><p data-v-2a365ad9${_scopeId4}>Dispositivo biom\xE9trico detectado: ${ssrInterpolate(unref(biometricDevice))}</p></div>`);
                              } else {
                                _push5(`<!---->`);
                              }
                            } else {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-2a365ad9"]]);
