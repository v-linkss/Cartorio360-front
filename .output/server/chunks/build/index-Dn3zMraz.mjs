...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    }, "$3wC3w7E7ub")), __temp = await __temp, __restore(), __temp);
      ...
      if (unref(status) === "success") {
        _push(ssrRenderComponent(VContainer, mergeProps({ class: "mt-5" }, _attrs), {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/situacaoMatricula/cadastro" }, {
              ...
              return [
                createVNode(_component_NuxtLink, { to: "/situacaoMatricula/cadastro" }, {
                  default: withCtx(() => [
                    createVNode("img", {
                      style: { "cursor": "pointer" },
                      src: _imports_0,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/situacaoMatricula/lista/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined;
};

export { _sfc_main as default };
//# sourceMappingURL=index-Dn3zMraz.mjs.map
