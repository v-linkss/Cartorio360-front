...
import { _ as _imports_3, a as _sfc_main$1 } from './Selos-C-3uEi7u.mjs';
...
import { ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrGetDirectiveProps, ssrRenderAttr, ssrRenderClass } from 'vue/server-renderer';
...
import { b as useNuxtApp, g as useRoute$1, u as useRouter$1, e as useCookie, f as VTextField, V as VBtn, c as useRuntimeConfig } from './server.mjs';
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VRow, { style: { "display": "flex", "gap": "2px", "margin-top": "-5px" } }, {
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div title="Visualizar"${_scopeId4}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Visualizar"${_scopeId4}></div><div${ssrRenderAttr("title", item.btn_selos ? "Reimprimir Selo" : "N\xE3o permitido")}${_scopeId4}><img style="${ssrRenderStyle({
                                opacity: item.btn_selos ? "1" : "0.5",
                                cursor: item.btn_selos ? "pointer" : "not-allowed",
                                width: "30px",
                                height: "30px"
                              })}"${ssrRenderAttr("src", _imports_3)} alt="Reimprimir"${_scopeId4}></div><div class="${ssrRenderClass({ disabled: !item.btn_editar })}"${ssrRenderAttr("title", item.btn_editar ? "Editar" : "Desabilitado")}${_scopeId4}><img style="${ssrRenderStyle({
                                opacity: item.btn_editar ? "1" : "0.5",
                                cursor: item.btn_editar ? "pointer" : "not-allowed",
                                width: "30px",
                                height: "30px"
                              })}"${ssrRenderAttr("src", _imports_1$1)} alt="Editar"${_scopeId4}></div><div title="Excluir" style="${ssrRenderStyle({ cursor: item.btn_cancelar ? "pointer" : "not-allowed" })}"${_scopeId4}><img style="${ssrRenderStyle({
                                width: "30px",
                                height: "30px",
                                cursor: item.btn_cancelar ? "pointer" : "not-allowed",
                                opacity: item.btn_cancelar ? "1" : "0.5"
                              })}"${ssrRenderAttr("src", _imports_5)} alt="Cancelar"${ssrRenderAttr("title", item.btn_cancelar ? "Cancelar" : "N\xE3o permitido")}${_scopeId4}></div>`);
                            } else {
                              return [
                                createVNode("div", {
                                ...
                                createVNode("div", {
                                  ...
                                  title: item.btn_selos ? "Reimprimir Selo" : "N\xE3o permitido"
                                }, [
                                  createVNode("img", {
                                    style: {
                                      opacity: item.btn_selos ? "1" : "0.5",
...
//# sourceMappingURL=_id_-dA0-uHYX.mjs.map
