...
import { _ as _export_sfc, u as useRouter$1, b as useNuxtApp, V as VTextField, F as VBtn, aM as VSpacer, c as useRuntimeConfig, e as useCookie } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-main" }, _attrs))} data-v-1d581617><div class="container-form" data-v-1d581617>`);
      ...
      _push(`<div class="text" data-v-1d581617>Log in</div>`);
      ...
      _push(`<a class="text-decoration-none" rel="noopener noreferrer" style="${ssrRenderStyle({ "color": "#429946" })}" data-v-1d581617> Esqueceu a senha?</a></div><div class="background-image" data-v-1d581617></div></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1d581617"]]);

export { index as default };
//# sourceMappingURL=index-B-5UTa5J.mjs.map
