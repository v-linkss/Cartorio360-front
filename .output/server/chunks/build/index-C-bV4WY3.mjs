...
import { _ as _imports_1$1 } from './btn_cancela_lavratura-BlgN-Hdq.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCol, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-d50eb60d${_scopeId3}><img style="${ssrRenderStyle({ "width": "40px", "height": "40px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1)} alt="Pesquisar" data-v-d50eb60d${_scopeId3}></div>`);
                      } else {
                        return [
      ...
      _push(ssrRenderComponent(VDataTable, {
        ...
        "item.actions": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "gap": "4px", "justify-content": "center" })}" data-v-d50eb60d${_scopeId}><div${ssrIncludeBooleanAttr(!item.btn_cancelar) ? " disabled" : ""} title="Excluir" data-v-d50eb60d${_scopeId}><img style="${ssrRenderStyle({ "width": "30px", "height": "30px", "cursor": "pointer" })}"${ssrRenderAttr("src", _imports_1$1)} alt="Cancelar" title="Cancelar" data-v-d50eb60d${_scopeId}></div></div>`);
          } else {
            return [
...
//# sourceMappingURL=index-C-bV4WY3.mjs.map
