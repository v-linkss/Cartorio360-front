<template>
  <v-container>
    <v-row class="mt-1">
      <v-col>
        <v-text-field v-model="state.data_inicial" label="Data Inicial" placeholder="dd/mm/yyyy"
          v-mask="'##/##/####'"></v-text-field>
      </v-col>
      <v-col>
        <v-text-field v-model="state.data_final" label="Data Final" placeholder="dd/mm/yyyy"
          v-mask="'##/##/####'"></v-text-field>
      </v-col>
      <v-col>
        <v-text-field label="N* Livro" type="number" v-model="state.livro"></v-text-field>
      </v-col>
      <v-col>
        <v-text-field label="Pagina Inicial" type="number" v-model="state.paginaInicial"></v-text-field>
      </v-col>
      <v-col>
        <img @click="gerarRelatorioDiarioCaixa" style="width: 40px; height: 40px; cursor: pointer"
          src="../../assets/imprimir.png" alt="imprimir" title="imprimir" />
        <img @click="gerarRelatorioDiarioCaixaCSV" style="width: 40px; height: 40px; cursor: pointer; margin-left: 20px"
          src="../../assets/btn-csv.png" alt="exportar" title="exportar" />
      </v-col>
      <v-col> </v-col>
    </v-row>
  </v-container>
